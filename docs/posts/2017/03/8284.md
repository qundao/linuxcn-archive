...
date_updated: 2017-03-09 09:57:00
slug: article-8284-1.html
url: https://linux.cn/article-8284-1.html
url_from: http://www.tecmint.com/upgrade-kernel-in-ubuntu/
image: album/201703/09/095734qb3y4q02zsraz1m6.jpg
tags:
  - 内核
  - 升级
categories:
...
|   index | 日期                | 日期                                       | 评论                                                                                                                                                                                                                                                                                                                                                                                                |
|--------:|:--------------------|:-------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2017-03-09 10:56:27 | 来自四川成都的 Chrome 56.0-GNU/Linux 用户  | `谢谢作者，使用mint也能享受arch类的待遇了，呵呵`                                                                                                                                                                                                                                                                                                                                                    |
|       1 | 2017-03-09 16:51:08 | 来自香港的 Chrome 56.0-Windows 10 用户     | `mint有自带的内核更新程序，而且不建议mint用ubuntu的内核`                                                                                                                                                                                                                                                                                                                                            |
|       2 | 2017-03-09 17:30:24 | 不着调的小男生 [Chrome 55.0-Windows 7]     | `虽然我用Arch作为主系统V，但是看到本文的错误我还是要热心指出的。Ubuntu是debian的衍生版，mint是Ubuntu的衍生。文章开头第二段我觉得有歧义。<br /> <br /> 看到评论说Arch的待遇，也不完全是。Arch虽然很激进，但是不对于内核这一块，我编译的OrangePiZero的内核合适实时内核4.10 而Arch用的却是4.9.8的内核，准确说Ubuntu建议跟新到长期支持内核，不要用测试版的，可以体验一下实时内核。本来Ubuntu就不稳定。` |
|       3 | 2017-03-09 17:54:45 | linux [Chrome 56.0-Mac 10.11]              | `对对，Debian 是 Ubuntu 之母。这一点错了。`                                                                                                                                                                                                                                                                                                                                                         |
|       4 | 2017-03-10 09:05:55 | 来自四川成都的 Chrome 56.0-GNU/Linux 用户  | `准备好了在 Ubuntu 16.04 或其上下游衍生版本（如 Debian 和 Linux Mint）中更新你的内核了么？仔细看哦，是“或其上下游版本呢，呵呵`                                                                                                                                                                                                                                                                      |
|       5 | 2017-03-11 18:49:02 | linux [Chrome 56.0-Mac 10.11]              | `没办法，原文用的是“衍生版本”（derivatives），经贴主提醒，发现这个不严谨的地方，就修改成“上下游衍生版本”了&nbsp;&nbsp;:-d`                                                                                                                                                                                                                                                                          |
|       6 | 2017-03-13 18:22:36 | 来自江苏南京的 Chrome 47.0-Windows 10 用户 | `吐槽一下，按照上述介绍，我成功地更新了我笔记本电脑上的 Ubuntu 内核。重启后无线网卡不能用了。`                                                                                                                                                                                                                                                                                                      |
|       7 | 2017-04-05 20:14:55 | yomun [Chrome 57.0-GNU/Linux]              | `要注意官网所提供的网卡驱动,<br /> 他们都有说明内核可用的版本<br /> <br /> 如果内核超过支持的版本, <br /> 那就要上网查一查是否有人在开发可用的驱动..`                                                                                                                                                                                                                                               |
