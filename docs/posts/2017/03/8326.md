...
date_updated: 2017-03-22 08:24:00
slug: article-8326-1.html
url: https://linux.cn/article-8326-1.html
url_from: https://opensource.com/business/13/11/selinux-policy-guide
image: album/201703/22/062657tmm2pfmt6686punq.png
tags:
  - selinux
  - 安全
categories:
...
|   index | 日期                | 日期                                       | 评论                                                                                                                                                                                                                                                                       |
|--------:|:--------------------|:-------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2017-03-24 21:16:11 | 执着的夏风 [Chromium 56.0-Ubuntu]          | `哈哈&nbsp;&nbsp;万一有一只老鼠偷吃怎么办?`                                                                                                                                                                                                                                |
|       1 | 2017-03-28 17:51:41 | 来自广东深圳的 Chrome 56.0-Windows 7 用户  | `good!`                                                                                                                                                                                                                                                                    |
|       2 | 2017-03-28 21:55:00 | 来自广东广州的 Firefox 45.0-Windows 7 用户 | `这是一个我必关的东西`                                                                                                                                                                                                                                                     |
|       3 | 2017-03-29 16:46:47 | linux [Chrome 56.0-Mac 10.11]              | `这个一个我会关，但是我觉得关了很丢人的东西。`                                                                                                                                                                                                                             |
|       4 | 2017-08-20 23:42:28 | 萧萧哀回 [Chrome 59.0-Windows 10]          | `“我们把控制访问进程的标签的规则写入一个类似文件的客体标签中。”感觉这句话翻译的有问题，原文是We write rules to control the access of a process label to an a object label like a file. 我的理解是：我们制定规则来控制一个进程标签对一个客体标签的访问，比如一个文件客体。` |
