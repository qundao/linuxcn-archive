...
date_updated: 2017-04-01 08:52:02
slug: article-8363-1.html
url: https://linux.cn/article-8363-1.html
url_from: http://www.techphylum.com/2016/07/manjaro-linux-explained.html
image: album/201704/01/084957mgbgal0vvyllznba.jpg
tags:
  - arch
  - manjaro
categories:
...
|   index | 日期                | 日期                                                          | 评论                                                                                                                                                                                                                                                                                      |
|--------:|:--------------------|:--------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2017-04-01 09:25:49 | 来自四川成都的 Chrome 57.0-GNU/Linux 用户                     | `这个发行版确实不错，喜欢`                                                                                                                                                                                                                                                                |
|       1 | 2017-04-01 12:51:36 | 不着调的小男生 [Chrome 55.0-Windows 7]                        | `Manjaro是一个新兴的优秀发行版，的确。<br /> 我的工作系统是Arch Gnome，Manjaro基于Arch，这使我很关注，它的其他都还有，就是登录界面容易崩溃，需要替换登录界面管理器，这样就没有了美的感受，毕竟很多人为了美观，内核更新慢了点，但是不影响使用，可以选择内核版本，这点很有意思，值得尝试。` |
|       2 | 2017-04-01 13:56:34 | 来自四川成都的 Chrome 49.0-Windows 10 用户                    | `Manjaro界面漂亮，基于archlinux，赞一个`                                                                                                                                                                                                                                                  |
|       3 | 2017-04-01 19:07:05 | 来自山东济南山东大学齐鲁软件学院的 Chrome 57.0-GNU/Linux 用户 | `已经用了几个月了，很稳定，而且xfce桌面占的资源很少。`                                                                                                                                                                                                                                    |
|       4 | 2017-04-01 21:20:28 | 来自36.149.209.15的 Chrome 57.0-Mac 10.12 用户                | `继续下载测试，冷门的桌面系统总有一种怕怕的感觉。`                                                                                                                                                                                                                                        |
|       5 | 2017-04-02 17:09:01 | POCMON [QQ Browser 9.5-Windows 10]                            | `很不错的一个发行版，可能是ub-arch之后，又一极好的发行版~`                                                                                                                                                                                                                                |
|       6 | 2017-04-02 19:24:58 | 来自112.26.230.35的 Chrome Mobile 40.0-Android 4.4 用户       | `这么巧，我用的就是manjaro哈哈哈<br /> kde connect好强大`                                                                                                                                                                                                                                 |
|       7 | 2017-04-02 22:14:18 | yomun [Chrome 57.0-GNU/Linux]                                 | `记得是因为 Python, 我放弃使用这个发行版..`                                                                                                                                                                                                                                               |
|       8 | 2017-04-04 11:45:09 | 来自河北的 Firefox 52.0-Ubuntu 用户                           | `兄弟们,我在ubuntu 16.10下 看flash 就会有花屏道道,但是在manjaro系统下看flash就没有 请问如何解决ubuntu下的花屏`                                                                                                                                                                            |
|       9 | 2017-04-04 14:46:19 | yomun [Chrome 57.0-GNU/Linux]                                 | `显卡驱动安装或更新了没？`                                                                                                                                                                                                                                                                |
|      10 | 2017-04-04 15:19:16 | 来自上海的 Firefox 52.0-GNU/Linux 用户                        | `现在Manjaro有三个官方版Xfce、KDE、Gnome，我只用过KDE、Gnome都很不错的，不过不知道为什么使用KDE使用的鼠标滚轮会跳屏，所以我现在使用的Gnome了`                                                                                                                                             |
|      11 | 2017-04-05 17:08:25 | fxbszj [Opera 43.0-Windows 7]                                 | `不怎么喜欢xfce4， 其他来说manjaro真的很不错，我一般会选cinnamon`                                                                                                                                                                                                                         |
|      12 | 2017-04-06 09:17:07 | 来自北京的 Firefox 52.0-GNU/Linux 用户                        | `在桌面使用鼠标滚轮会切换桌面，并不是跳屏。可以在快捷键里面禁用的，我现在用的就是manjaro，很不错。强烈推荐。`                                                                                                                                                                             |
|      13 | 2017-04-06 09:19:40 | 来自北京的 Firefox 52.0-GNU/Linux 用户                        | `这个应该是屏幕撕裂（tearing）问题，去贴吧搜一下 ，有一个帖子说了这个解决方法，archlinux吧。`                                                                                                                                                                                             |
|      14 | 2017-05-11 23:22:24 | 来自广东广州的 Chrome Mobile iOS 58.0-iOS 10.3 用户           | `没有unity`                                                                                                                                                                                                                                                                               |
