...
date_updated: 2017-04-08 20:12:00
slug: article-8387-1.html
url: https://linux.cn/article-8387-1.html
url_from: 
  https://www.howtoforge.com/tutorial/linux-command-line-tips-tricks-part-3-cdpath/
image: album/201704/08/201121taqbqb0o42xiboix.jpg
tags:
  - 命令行
  - 导航
categories:
...
在这个系列的[第一部分](https://linux.cn/article-8335-1.html)，我们详细地讨论了 `cd -` 命令，在[第二部分](https://linux.cn/article-8371-1.html)，我们深入探究了 `pushd` 和 `popd` 两个命令，以及它们使用的场景。
