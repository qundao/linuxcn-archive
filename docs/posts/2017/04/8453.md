...
date_updated: 2017-04-27 18:26:10
slug: article-8453-1.html
url: https://linux.cn/article-8453-1.html
url_from: http://www.tecmint.com/add-new-disk-to-an-existing-linux/
image: album/201704/27/182550azvoldxnx59tzm3x.jpg
tags:
  - fdisk
  - 磁盘
categories:
...
**推荐阅读：** [如何将超过 2TB 的新硬盘添加到现有 Linux](https://linux.cn/article-8398-1.html)。

重要：请注意这篇文章的目的只是告诉你如何创建新的分区，而不包括分区扩展或者其它选项。

我使用 [fdisk 工具](https://linux.cn/tag-fdisk.html) 完成这些配置。
