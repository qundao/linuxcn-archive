...
date_updated: 2017-01-22 14:35:00
slug: article-8137-1.html
url: https://linux.cn/article-8137-1.html
url_from: http://www.tecmint.com/assign-linux-command-output-to-variable/
image: album/201701/22/143544v78c308287tjuu5j.jpg
tags:
  - shell
  - 变量
  - 命令
...
|   index | 日期                | 日期                                            | 评论                                                                                                                                              |
|--------:|:--------------------|:------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2017-01-23 17:10:45 | 来自北京北京大学的 Firefox 50.0-Windows 10 用户 | `变量名='命令'<br /> 变量名='命令 [命令选项 ...] 参数1 参数2 ...'<br /> 这两行不是单引号，而是反引号`(数字1左边那个)。后面的例子中反引号都对了。` |
|       1 | 2017-01-23 22:21:02 | linux [Chrome 55.0-Mac 10.11]                   | `汗，没细看出来。。`                                                                                                                              |
