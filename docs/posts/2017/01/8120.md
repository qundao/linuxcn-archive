...
date_updated: 2017-01-15 17:25:07
slug: article-8120-1.html
url: https://linux.cn/article-8120-1.html
url_from: http://www.tecmint.com/trace-shell-script-execution-in-linux/
image: album/201701/15/172501x3lrwwqio266pq29.jpg
tags:
  - 脚本
  - 调试
categories:
...
在 [shell 脚本调试系列](https://linux.cn/article-8028-1.html) 中，本文将解释第三种 shell 脚本调试模式，即 shell 跟踪，并查看一些示例来演示它如何工作以及如何使用它。
...
1. [如何在 Linux 中启用 Shell 脚本的调试模式](https://linux.cn/article-8028-1.html)
...
那么，现在我们已经完成了 [shell 脚本调试系列](https://linux.cn/article-8028-1.html)，可以在下面的反馈栏里给我们关于本篇或者本系列提出问题或反馈。
...
|   index | 日期                | 日期                                | 评论                                                                               |
|--------:|:--------------------|:------------------------------------|:-----------------------------------------------------------------------------------|
|       0 | 2017-01-15 20:23:32 | kashu [Chromium 66.0-Xubuntu 14.04] | `我用这个就行了<br /> kashu:/tmp/linux$ echo $PS4<br /> +{$LINENO:${FUNCNAME[0]}}` |
