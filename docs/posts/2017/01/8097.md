...
date_updated: 2017-01-05 23:05:00
slug: article-8097-1.html
url: https://linux.cn/article-8097-1.html
url_from: http://www.tecmint.com/manage-samba4-ad-from-windows-via-rsat/
image: album/201701/05/225257qbvfnlqngq2wlvqo.jpg
tags:
  - samba
  - 活动目录
categories:
...
1、 [在 Ubuntu 系统上使用 Samba4 来创建活动目录架构（一）](https://linux.cn/article-8065-1.html)
...
9、从我们的前一篇文章可以看出，[Samba4 活动目录可以使用 samba-tool 工具在命令行下管理](https://linux.cn/article-8070-1.html)，可以直接在服务器上的 VTY 控制台或者通过 SSH 工具远程连接到服务器上进行管理。
...
|   index | 日期                | 日期                             | 评论                                                                                         |
|--------:|:--------------------|:---------------------------------|:---------------------------------------------------------------------------------------------|
|       0 | 2017-01-11 14:49:25 | jingwang [Chrome 55.0-GNU/Linux] | `我还在用samba2.。。。。。。&nbsp;&nbsp;有人给我讲解下 samba4&nbsp;&nbsp;都有些什么新特性吗` |
