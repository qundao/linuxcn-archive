...
date_updated: 2017-08-26 17:55:00
slug: article-8812-1.html
url: https://linux.cn/article-8812-1.html
url_from: 
  https://blog.tartanllama.xyz/c++/2017/04/24/writing-a-linux-debugger-source-signal/
image: album/201708/26/175338u3rarihzal14s8sg.jpg
tags:
  - 调试器
categories:
  - 软件开发
...
正如我在这系列文章开始时备注的，我们会使用 [libelfin](https://github.com/TartanLlama/libelfin/tree/fbreg) 来处理我们的 DWARF 信息。希望你已经在[第一部分](https://linux.cn/article-8626-1.html)设置好了这些，如果没有的话，现在做吧，确保你使用我仓库的 `fbreg` 分支。
