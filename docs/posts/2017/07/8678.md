...
date_updated: 2017-07-08 20:51:00
slug: article-8678-1.html
url: https://linux.cn/article-8678-1.html
url_from: https://www.tecmint.com/integrate-iredmail-roundcube-with-samba4-ad-dc/
image: album/201707/08/205134sabclabnq2injj2l.jpg
tags:
  - roundcube
  - samba
  - 邮件
...
1. [如何在 CentOS 7 上安装 iRedMail，用于Samba4 AD集成](https://linux.cn/article-8567-1.html)
2. [在 CentOS 7 上配置 iRedMail，用于 Samba4 AD 集成](https://linux.cn/article-8673-1.html)

### 第一步：在 Samba4 AD DC 中声明域帐户的电子邮件地址

1、 为了发送和接收 Samba4 AD DC 域账户的邮件，您需要编辑每个用户帐户，如下所示，通过从[安装了 RSAT 工具的 Windows 机器](https://linux.cn/article-8097-1.html)并且已经加入 Samba4 AD 中打开 ADUC 工具显式地在邮箱字段填写正确的地址。
