...
|   index | 日期                | 日期                                      | 评论                                                                                                                                                                                                                                   |
|--------:|:--------------------|:------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2017-07-17 07:58:32 | 来自四川成都的 Chrome 59.0-GNU/Linux 用户 | `虚拟内存文件， 还可以用 dd 创建，但系统不支持稀疏文件做虚拟内存文件。<br /> 最好在 fstab 挂载虚拟内存文件时，加 PRIO 参数， 设置优先级，否则系统可能不会按照预先构想的顺序存储，比如变成先使用体积较小的，而不是较大的虚拟内存文件。` |
