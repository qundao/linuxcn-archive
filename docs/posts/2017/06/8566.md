...
date_updated: 2017-06-03 15:44:00
slug: article-8566-1.html
url: https://linux.cn/article-8566-1.html
url_from: http://www.onebigfluke.com/2017/04/discovering-my-inner-curmudgeon-linux.html
image: album/201706/03/154436lp44p43t3qdq0u7q.jpg
tags:
  - 笔记本
categories:
  - 观点
...
|   index | 日期                | 日期                                             | 评论                                                                                                                                                                                                                                                                                             |
|--------:|:--------------------|:-------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2017-06-04 09:07:54 | 来自广东广州的 MIUI Browser 8.8-Android 4.4 用户 | `ubantu不好用，不够稳定，不如XP，也容易造成死机，虽然我自己的电脑性能也是问题，但作为一种linux系统，ubantu比XP更容易死机，后来装windows7,速度反而更快，更稳定。所以，我相信，如果不和芯片厂商联合研发，linux系统想代替windows，还要稳定好用，是完全不可能的事情，那纯粹是一种经不起考验的传说！` |
|       1 | 2017-06-04 14:12:29 | cuthead [Firefox 53.0-Ubuntu]                    | `Linux是Intel的子公司，所以只支持Intel的产品。我现在使用的sandy bridge，在Ubuntu下3天了，没遇到什么问题。`                                                                                                                                                                                       |
|       2 | 2017-06-04 20:01:07 | yomun [Chrome 58.0-GNU/Linux]                    | `Linux 多好, 但都是受有限资源的限制<br /> 死机的问题, 多源自用户没注意与监控 RAM 内存的使用.<br /> 明明不够用, 还启动太多程序与服务(包括自动启动的), 让 RAM 耗尽导致死机, 这简直就是作死的典范.`                                                                                                 |
|       3 | 2017-06-05 09:11:20 | 来自广东深圳的 Firefox 53.0-Ubuntu 用户          | `这回复里都是些什么玩意啊。。`                                                                                                                                                                                                                                                                   |
|       4 | 2017-06-05 23:53:59 | cuthead [Firefox 53.0-Ubuntu]                    | `KDE其实挺不错的，不过起点太高了。`                                                                                                                                                                                                                                                              |
|       5 | 2017-06-08 10:25:56 | 来自上海的 Chrome 58.0-Mac 10.12 用户            | `Linux是intel的子公司。。。我还以为错过了什么大新闻`                                                                                                                                                                                                                                             |
|       6 | 2017-06-08 14:16:56 | linux [Chrome 58.0-Mac 10.11]                    | `哈哈，这是调侃啦`                                                                                                                                                                                                                                                                               |
|       7 | 2017-06-09 19:08:26 | Ghjoker [Firefox 45.0-GNU/Linux]                 | `HP是个好东西，Ubuntu是个好东西，钱是个好东西。。。`                                                                                                                                                                                                                                             |
|       8 | 2017-06-17 13:02:10 | 来自广东广州的 Firefox 54.0-Fedora 用户          | `二合一、触摸屏什么的还是不要用Linux了。否则很多硬件用起来可能有问题。<br /> 就普通台式机和笔记本还是可以的。`                                                                                                                                                                                   |
