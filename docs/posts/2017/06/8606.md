...
date_updated: 2017-06-14 18:26:00
slug: article-8606-1.html
url: https://linux.cn/article-8606-1.html
url_from: https://opensource.com/article/17/1/cinnamon-desktop-environment
image: album/201706/14/182656xqq6lxvgrp6nql5n.jpg
tags:
  - cinnamon
  - gnome
  - 桌面
...
|   index | 日期                | 日期                                              | 评论                                                                                                                                                                                                      |
|--------:|:--------------------|:--------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2017-06-14 18:46:28 | 来自广东深圳的 Firefox 53.0-Ubuntu 用户           | `kubuntu17.04倒还挺稳定的，只是少数几个软件偶尔会卡住`                                                                                                                                                    |
|       1 | 2017-06-14 20:05:39 | 来自四川成都的 Chromium 58.0-Ubuntu 用户          | `不喜欢的理由，一个就足够了。`                                                                                                                                                                            |
|       2 | 2017-06-14 20:05:51 | 来自四川成都的 Chromium 58.0-Ubuntu 用户          | `为什么现在还有人喜欢这种类似 Windows 95 那种窄窄的任务栏，不觉得小吗？`                                                                                                                                  |
|       3 | 2017-06-14 22:43:01 | 来自北京的 Chrome 58.0-GNU/Linux 用户             | `因为我需要更多的工作空间，而不是一条大大的任务栏～`                                                                                                                                                      |
|       4 | 2017-06-15 07:51:32 | 来自四川成都的 Chrome 58.0-GNU/Linux 用户         | `对于现在很多宽屏显示器来说，可以选择竖放任务栏。`                                                                                                                                                        |
|       5 | 2017-06-15 10:53:09 | 来自四川的 Chrome 59.0-GNU/Linux 用户             | `说得好！我选择KDE`                                                                                                                                                                                       |
|       6 | 2017-06-15 17:07:15 | 来自北京的 Firefox 53.0-GNU/Linux 用户            | `之前用过linux Mint 17, Cinnamon 确实易用，专有驱动安装很方便。操作跟 Windows 很接近。<br /> 但是有个问题就是中文输入法一直没有解决好，最后就放弃了。<br /> 现在版本号到18了，不知道中文输入有没有解决。` |
|       7 | 2017-06-16 08:54:08 | 来自四川成都的 Chrome 59.0-GNU/Linux 用户         | `表示从来没遇到过这个问题，我用的是fcitx～`                                                                                                                                                               |
|       8 | 2017-08-01 14:51:33 | 来自浙江杭州的 Chrome 60.0-Mac 10.12 用户         | `Cinnamon确实是很不错的界面，美观、适用`                                                                                                                                                                  |
|       9 | 2020-11-01 19:40:46 | 来自河南郑州的 Chrome Mobile 73.0-Android 10 用户 | `优麒麟安装这个，锁屏失效怎么回事`                                                                                                                                                                        |
