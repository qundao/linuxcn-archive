...
date_updated: 2017-06-06 09:17:00
slug: article-8576-1.html
url: https://linux.cn/article-8576-1.html
url_from: https://www.tecmint.com/ssh_scan-ssh-configuration-and-policy-scanner-for-linux/
image: album/201706/05/094154g4ah7ilcejlls4ii.jpg
tags:
  - ssh
  - ssh_scan
categories:
...
2. [安全 SSH 服务器的 5 个最佳实践](https://linux.cn/article-7683-1.html)
3. [使用 Chroot 来限制 SSH 用户进入某些目录](https://linux.cn/article-8313-1.html)
4. [如何配置 SSH 连接来简化远程登录](https://linux.cn/article-8306-1.html)
...
|   index | 日期                | 日期                             | 评论                                                                                                                                                                                                                                                   |
|--------:|:--------------------|:---------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2017-06-07 11:29:59 | 来自北京的 Liebao-Windows 7 用户 | `前面讲的在安装有问题<br /> 系统：centos6.4<br /> 1.安装的是rubygems,少写了个s<br /> 2.yum rubygem会提示ruby版本要在2.0以上，<br /> 所以我使用的是源码安装的ruby 和rubygems，默认安装目录是/usr/local/bin&nbsp; &nbsp; 做个软链接到/usr/bin下就可以了` |
|       1 | 2017-06-07 13:59:20 | linux [Chrome 58.0-Mac 10.11]    | `谢谢，已更正 :D`                                                                                                                                                                                                                                      |
