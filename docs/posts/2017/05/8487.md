...
date_updated: 2017-05-07 21:04:05
slug: article-8487-1.html
url: https://linux.cn/article-8487-1.html
url_from: http://www.tecmint.com/give-read-write-access-to-directory-in-linux/
image: album/201705/07/210335tgwti3xdxidtx6zs.jpg
tags:
  - acl
  - 权限
  - 目录
...
在上篇文章中我们向您展示了如何在 Linux 上[创建一个共享目录](https://linux.cn/article-8187-1.html)。这次，我们会为您介绍如何将 Linux 上指定目录的读写权限赋予用户。
...
|   index | 日期                | 日期                                      | 评论                                                                                                                                           |
|--------:|:--------------------|:------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2021-06-18 13:19:58 | 来自江苏连云港的 Firefox 89.0-Fedora 用户 | `博主你好，通过ACL权限方式，真正符合了“给指定用户开放指定读写权限，不改变原目录/文件的所有者”要求，但此目录的读写效率严重下降，该如何解决呢？` |
