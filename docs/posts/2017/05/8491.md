...
date_updated: 2017-05-10 08:25:00
slug: article-8491-1.html
url: https://linux.cn/article-8491-1.html
url_from: http://www.tecmint.com/bd-quickly-go-back-to-a-linux-parent-directory/
image: album/201705/08/153346wwww562rcsl2cocm.jpg
tags:
  - 导航
  - 目录
categories:
...
就是这样了！在本文中，我们展示了使用 bd 程序[在 Linux 中快速切换文件夹](https://linux.cn/article-5983-1.html)的便捷方法。
...
|   index | 日期                | 日期                                       | 评论                                                                           |
|--------:|:--------------------|:-------------------------------------------|:-------------------------------------------------------------------------------|
|       0 | 2017-05-10 09:22:09 | hrj294055233 [Firefox 53.0-Ubuntu]         | `自己玩玩还可以嘛，线上的话可能会卷铺盖回家吧`                                 |
|       1 | 2017-05-10 09:34:34 | 来自四川成都的 Chrome 57.0-GNU/Linux 用户  | `其实一般用 cd - 和 pushd $PWD ，就足够了。`                                   |
|       2 | 2017-05-10 16:36:04 | 泽楠弟弟 [Safari 10.1-Mac 10.12]           | `看起来很方便，不过我很少去到这么深的目录。`                                   |
|       3 | 2017-05-14 15:53:57 | hello_linux [Chrome 51.0-Windows 7]        | `实用性感觉不高。。。。。`                                                     |
|       4 | 2017-05-23 00:08:43 | 来自安徽合肥的 Firefox 53.0-GNU/Linux 用户 | `还是习惯用mc。`                                                               |
|       5 | 2017-05-30 21:00:35 | 来自山西的 Firefox 45.0-GNU/Linux 用户     | `echo 'alias bd=&quot;. bd -si&quot; &gt;&gt; ~/.bashrc<br /> <br /> 少个引号` |
|       6 | 2017-05-31 16:22:22 | linux [Chrome 58.0-Mac 10.11]              | `谢谢！已更正！`                                                               |
