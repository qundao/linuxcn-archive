...
date_updated: 2017-09-11 08:26:00
slug: article-8857-1.html
url: https://linux.cn/article-8857-1.html
url_from: 
  https://www.networkworld.com/article/3222070/linux/maneuvering-around-run-levels-on-linux.html
image: album/201709/10/212729wmyh9hzy35umhp0d.jpg
tags:
  - runlevel
categories:
  - 系统运维
...
|   index | 日期                | 日期                                      | 评论                                                                                                                                                                         |
|--------:|:--------------------|:------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2017-09-11 09:49:36 | 来自四川成都的 Chrome 60.0-GNU/Linux 用户 | `原文好歹提一下 systemd 嘛，结果通篇没有。在 debian 都要上 wayland 的今天，介绍 runlevel，实在有些脱离现实。<br /> <br /> readlink $(which runlevel)<br /> ../bin/systemctl` |
|       1 | 2017-09-11 10:28:01 | 拿铁不加糖 [Chrome 61.0-Windows 10]       | `runlevel有点过时啦!`                                                                                                                                                        |
|       2 | 2017-09-11 10:33:55 | linux [Chrome 60.0-Mac 10.11]             | `我也不知道为什么会有这样一篇过时的文章——不过有些遗留系统还是用的这个。`                                                                                                     |
