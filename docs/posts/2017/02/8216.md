...
date_updated: 2017-02-17 09:00:00
slug: article-8216-1.html
url: https://linux.cn/article-8216-1.html
url_from: http://www.tecmint.com/linux-file-operations-commands/
image: album/201702/17/002023ddfo707fo4ma0dmy.jpg
tags:
  - 过滤
categories:
  - 技术
...
[awk](https://linux.cn/tag-awk.html) 是一个卓越的模式扫描和处理语言，它可被用于在 Linux 下构造有用的过滤器。你可以通过阅读我们的 [awk 系列 1 到 13 部分](https://linux.cn/article-7586-1.html) 来开始使用它。
...
* [如何使用 GNU sed 命令在 Linux 下创建、编辑和处理文件](https://linux.cn/article-7161-1.html)
...
* [Linux 的 ‘sort’命令的14个有用的范例（一）](https://linux.cn/article-5372-1.html)
* [Linux 的 'sort'命令的七个有趣实例（二）](https://linux.cn/article-5373-1.html)
...
|   index | 日期                | 日期                                  | 评论                                                 |
|--------:|:--------------------|:--------------------------------------|:-----------------------------------------------------|
|       0 | 2017-02-17 11:41:39 | 何亮 [Chrome 56.0-Windows 7]          | `顶一下，挺全的。`                                   |
|       1 | 2017-02-17 22:31:35 | ZHENGHUI [Baidu Spark 8.4-Windows 10] | `第一天进入社区学习，仔细的看完了12条命令，顶一下！` |
