...
date_updated: 2017-02-04 15:07:26
slug: article-8172-1.html
url: https://linux.cn/article-8172-1.html
url_from: http://www.tecmint.com/run-sudo-command-without-password-linux/
image: album/201702/04/150719amz46v86mmxy4080.jpg
tags:
  - sudo
  - 密码
categories:
...
此设置在 `/etc/sudoers` 文件中完成，这是使用 [sudo 命令](https://linux.cn/tag-sudo.html)的默认安全策略；在用户权限指定部分。
...
* [在 Linux 中设置 sudo 的十条 sudoers 实用配置](https://linux.cn/article-8145-1.html)
* [让 sudo 在你输入错误的密码时“嘲讽”你](https://linux.cn/article-8128-1.html)
* [如何在 Linux 中让 sudo 密码会话的超时更长些](https://linux.cn/article-8151-1.html)
...
|   index | 日期                | 日期                                      | 评论                                                                               |
|--------:|:--------------------|:------------------------------------------|:-----------------------------------------------------------------------------------|
|       0 | 2017-02-04 16:47:23 | 来自四川成都的 Chrome 55.0-GNU/Linux 用户 | `建议把这些命令单独放在<br /> <br /> /etc/sudoers.d<br /> <br /> 下`               |
|       1 | 2017-02-04 16:47:48 | 来自四川成都的 Chrome 55.0-GNU/Linux 用户 | `打错了, 是配置`                                                                   |
|       2 | 2017-02-08 11:28:16 | 噪音未来 [Chrome 55.0-Windows 7]          | `求问，sudo -i 之后，输入本机的用户密码切换到的root权限，跟sudo过去的权限有何区别` |
|       3 | 2017-02-09 13:45:01 | 何以在天涯 [Firefox 51.0-GNU/Linux]       | `受教了`                                                                           |
|       4 | 2017-02-09 17:12:12 | OriginCode [Chromium 55.0-Ubuntu]         | `为什么不用su呢？`                                                                 |
|       5 | 2017-02-09 21:39:38 | linux [Chrome 56.0-Mac 10.11]             | `sudo su - <br /> 哈哈`                                                            |
