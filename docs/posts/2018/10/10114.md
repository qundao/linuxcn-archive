...
date_updated: 2018-10-14 11:36:34
slug: article-10114-1.html
url: https://linux.cn/article-10114-1.html
url_from: https://opensource.com/article/18/9/swap-space-linux-systems
image: album/201810/14/113624jcdtch0owfuczuch.jpg
tags:
  - swap
  - 交换
categories:
...
请注意，不同的命令以不同的形式显示或要求输入设备文件。在 `/dev` 目录中访问特定设备有多种方式。在我的文章 [在 Linux 中管理设备](https://linux.cn/article-8099-1.html) 中有更多关于 `/dev` 目录及其内容说明。
