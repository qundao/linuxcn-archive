...
date_updated: 2018-07-13 13:03:58
slug: article-9833-1.html
url: https://linux.cn/article-9833-1.html
url_from: https://opensource.com/article/18/6/getting-started-open-edx
image: album/201807/13/130427e5auhxz8iwiw7a5a.png
tags:
  - 培训
  - 课程
categories:
...
提醒一点：这个平台的 UI 是在不断变动的，最终的目标是在 [React](https://reactjs.org/) 和 [Bootstrap](https://getbootstrap.com/) 上实现标准化。与此同时，你将会发现基本主题有多个实现的样式，这可能会让你感到困惑。
