...
date_updated: 2018-07-29 10:50:36
slug: article-9878-1.html
url: https://linux.cn/article-9878-1.html
url_from: http://minkush.me/cardbook-debian-package/
image: album/201807/29/105040srt6nmf4ufnt1qdz.jpg
tags:
  - debian
  - 打包
categories:
...
|   index | 日期                | 日期                                       | 评论                                                                                            |
|--------:|:--------------------|:-------------------------------------------|:------------------------------------------------------------------------------------------------|
|       0 | 2019-04-29 23:04:08 | 来自广东广州的 Chrome 74.0-Windows 10 用户 | `作者你好，如何用dpkg创建一个空包？`                                                            |
|       1 | 2021-05-24 09:47:49 | 来自江苏南京的 Chrome 85.0-GNU/Linux 用户  | `直接dpkg-buildpackage -us -uc -ui就可以打包了，是否是空包取决于你在debian目录是否有相关的操作` |
|       2 | 2021-05-24 09:47:52 | 来自江苏南京的 Chrome 85.0-GNU/Linux 用户  | `直接dpkg-buildpackage -us -uc -ui就可以打包了，是否是空包取决于你在debian目录是否有相关的操作` |
