...
date_updated: 2018-04-15 09:31:00
slug: article-9546-1.html
url: https://linux.cn/article-9546-1.html
url_from: http://www.linuxjournal.com/content/programming-color-ncurses
image: album/201804/15/093208uzo27lsnbfb1l9sn.png
tags:
  - ncurses
categories:
  - 软件开发
...
在我的使用 ncurses 库进行编程的系列文章的[第一篇](https://linux.cn/article-9348-1.html)和[第二篇](https://linux.cn/article-9383-1.html)中，我已经介绍了一些 curses 函数来在屏幕上作画、从屏幕上查询和从键盘读取字符。为了搞清楚这些函数，我使用 curses 来利用简单字符绘制游戏地图和玩家角色，创建了一个简单的冒险游戏。在这篇紧接着的文章里，我展示了如何为你的 curses 程序添加颜色。
