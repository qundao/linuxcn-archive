...
date_updated: 2018-02-17 12:47:08
slug: article-9356-1.html
url: https://linux.cn/article-9356-1.html
url_from: https://www.howtoforge.com/linux-mkdir-command/
image: album/201802/17/124700v1sssrbsovwoe18y.jpg
tags:
  - mkdir
  - 目录
categories:
...
当你使用命令行的时候，无论什么时候，你都位于一个目录中，它告诉了命令行当前所位于的完整目录。在 Linux 中，你可以使用 [rm](https://linux.cn/article-9321-1.html) 命令删除目录，但是首先，你需要使用 `mkdir` 命令来创建目录。在这篇教程中，我将使用一些易于理解的例子来讲解这个工具的基本用法。
