...
date_updated: 2021-01-18 22:38:00
slug: article-13030-1.html
url: https://linux.cn/article-13030-1.html
url_from: https://www.insidentally.com/2020/10/config-zsh/
image: album/202101/19/230224fq7x7hu3u399r0z3.jpg
tags:
  - zsh
categories:
  - 技术
...
|   index | 日期                | 日期                                                   | 评论                                                                                     |
|--------:|:--------------------|:-------------------------------------------------------|:-----------------------------------------------------------------------------------------|
|       0 | 2021-01-24 21:46:31 | 来自浙江宁波的 Firefox 84.0-Windows 10 用户            | `原来zsh-autosuggestions在apt源里就有，可能这就是做过头吧`                               |
|       1 | 2021-10-11 20:41:49 | 来自江苏苏州的 Chrome 94.0-Windows 10 用户             | `博主配置的挺好看，可以把 ~/.zshrc 分享一下么？`                                         |
|       2 | 2022-05-12 00:31:53 | 来自广西钦州的 Chrome Mobile 100.0-Android 12 用户     | `感谢分享啊，洁癖用户是真的不想用OhMyZsh`                                                |
|       3 | 2022-05-12 14:33:33 | 来自广西桂林广西师范大学的 Chrome 101.0-GNU/Linux 用户 | `建议将Ubuntu用apt安装powerlevel9k变成直接git clone powerlevel10k的项目到/usr/share即可` |
