...
date_updated: 2021-04-19 09:49:00
slug: article-13311-1.html
url: https://linux.cn/article-13311-1.html
url_from: https://fedoramagazine.org/getting-started-with-stratis-encryption/
image: album/202104/19/094919orzaxwl5axiqqfiu.jpg
tags:
  - stratis
  - 加密
categories:
...
> Stratis 在其 官方网站 上被描述为“易于使用的 Linux 本地存储管理”。
...
|   index | 日期                | 日期                                       | 评论       |
|--------:|:--------------------|:-------------------------------------------|:-----------|
|       0 | 2021-04-24 10:11:33 | 来自罗马尼亚的 Firefox 88.0-GNU/Linux 用户 | `nice job` |
