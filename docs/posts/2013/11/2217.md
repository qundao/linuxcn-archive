...
slug: article-2217-1.html
url: https://linux.cn/article-2217-1.html
url_from: http://linoxide.com/linux-command/pmap-command/
image: album/201311/05/150328bah66ueepbqp8j6q.jpg
tags:
  - linux
  - pmap
  - 内存
...
> Pmap 提供了进程的内存映射，pmap命令用于显示一个或多个进程的内存状态。其报告进程的地址空间和内存状态信息。Pmap实际上是一个Sun OS上的命令，linux仅支持其有限的功能。但是它还是对查看完整的进程地址空间很有 ...
