...
date_updated: 2020-04-29 09:40:00
slug: article-12161-1.html
url: https://linux.cn/article-12161-1.html
url_from: https://www.2daygeek.com/comparison-difference-between-dnf-vs-yum/
image: album/202004/29/093910jjxifk8mewuxmgos.jpg
tags:
  - dnf
  - yum
categories:
...
|   index | 日期                | 日期                                            | 评论                                                                                                 |
|--------:|:--------------------|:------------------------------------------------|:-----------------------------------------------------------------------------------------------------|
|       0 | 2020-05-06 21:23:37 | 来自广东深圳的 Chrome 79.0-Windows 7 用户       | `哦`                                                                                                 |
|       1 | 2020-05-27 12:57:40 | 来自安徽合肥的 Firefox 76.0-Windows 10 用户     | `匿名回复么`                                                                                         |
|       2 | 2021-11-22 17:20:12 | 来自北京的 Chrome 92.0-Windows 10 用户          | `上面那个大图片不觉得碍事吗`                                                                         |
|       3 | 2022-01-19 16:25:01 | 来自香港的 Chrome 97.0-Windows 10 用户          | `知道了`                                                                                             |
|       4 | 2022-02-26 18:02:44 | 来自山东的 Chrome 98.0-Windows 10 用户          | `可能人家觉得好看吧`                                                                                 |
|       5 | 2022-03-26 08:13:00 | 来自美国的 Chrome 99.0-Windows 7 用户           | `但是，我 yum install DNF 从来就没有成功过`                                                          |
|       6 | 2022-10-25 17:01:55 | 来自香港的 Chrome 106.0-Windows 10 用户         | `apt install dnf 试试`                                                                               |
|       7 | 2022-11-12 18:50:40 | 来自111.60.22.178的 Firefox 91.0-GNU/Linux 用户 | `pacman大法好. doge.`                                                                                |
|       8 | 2022-12-08 20:36:49 | 来自江西新余的 Firefox 107.0-GNU/Linux 用户     | `yum 已经变成 dnf 的别名了.<br /> 使用 ls -l $(which yum) 命令可以看到 yum 是是个指向 dnf-3 的链接.` |
