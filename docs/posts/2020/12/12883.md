...
date_updated: 2020-12-03 22:39:00
slug: article-12883-1.html
url: https://linux.cn/article-12883-1.html
url_from: https://hookrace.net/blog/linux-desktop-setup/
image: album/202012/03/223817smrej5qwsbqjb3vs.jpg
tags:
  - linux
categories:
  - 技术
...
|   index | 日期                | 日期                                        | 评论                                                                                                                                                                                |
|--------:|:--------------------|:--------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2020-12-04 08:54:32 | 来自河南郑州的 Firefox 83.0-Ubuntu 用户     | `一大堆命令，很难想象这就是桌面生存指南，很难生存的`                                                                                                                                |
|       1 | 2020-12-04 09:51:25 | 来自湖北武汉的 Chrome 87.0-Windows 10 用户  | `同感，这对命令行最适合自娱自乐，自己怎么玩都行，但是现在私有格式那么多，老板发给你个word就gg了<br /> <br /> 说白了学那些最适合大众的东西成本最低`                                  |
|       2 | 2020-12-04 14:48:44 | 来自湖北武汉的 Firefox 56.0-Windows 10 用户 | `我用从fedora8开始，从来都是用桌面的，很好用啊`                                                                                                                                     |
|       3 | 2020-12-04 19:22:54 | 来自江苏宿迁的 Firefox 68.0-GNU/Linux 用户  | `我用linux大概也有十年了，各种版本都尝试过了，最终选择折中的版本-debian，最小化安装，i3wm桌面管理。<br /> 兼容的软件最多。稳定性非常好`                                             |
|       4 | 2020-12-05 10:12:20 | 来自广东珠海的 Firefox 83.0-Windows 10 用户 | `都到这种程度了,你觉得是老板给word就跪的人物吗？这配置,这台机一开就只干一件事——写代码.其他事务给其他机器做,只要开这台机就完全沉浸到代码世界里了.`                                   |
|       5 | 2020-12-05 10:34:00 | 来自广东珠海的 Firefox 83.0-Windows 10 用户 | `word太好解决了,转PDF,转HTML,转XML,转MARKDOWN,转ODT,要高级排版LATEX转XML或PDF之类的再转成word,想要什么格式随你挑,实在挑剔？让小弟搞排版,排 版这破事让技术人员做也亏你老板想的出来.` |
