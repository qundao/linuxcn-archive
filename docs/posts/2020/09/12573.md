...
date_updated: 2020-09-02 00:11:00
slug: article-12573-1.html
url: https://linux.cn/article-12573-1.html
url_from: https://opensource.com/article/20/8/printf
image: album/202009/02/001109wp3xdtr27xop25e7.jpg
tags:
  - printf
  - 输出
categories:
...
|   index | 日期                | 日期                                      | 评论                                                                                                     |
|--------:|:--------------------|:------------------------------------------|:---------------------------------------------------------------------------------------------------------|
|       0 | 2020-09-02 13:51:29 | 来自江苏苏州的 Chrome 84.0-Mac 10.15 用户 | `「printf输出」一段内：“如果同样使用 echo 来输出会产生更多的字符：”这一段下面的代码示例错用为 printf 了` |
