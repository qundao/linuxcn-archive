...
date_updated: 2015-09-06 09:30:00
slug: article-6155-1.html
url: https://linux.cn/article-6155-1.html
url_from: http://www.tecmint.com/file-and-directory-management-in-linux/
image: album/201509/06/013356u0ow1qg1go5wc1d0.png
tags:
  - rhcsa
categories:
  - 技术
...
[`touch` 命令](https://linux.cn/article-2740-1.html) 不仅仅能用来创建空文件，还能用来更新已有文件的访问时间和修改时间。
...
|   index | 日期                | 日期                                              | 评论                                                                                                                                                                               |
|--------:|:--------------------|:--------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2015-09-06 13:45:50 | 妙正灰 [Chrome 45.0-Windows 10]                   | `还是这篇比较好`                                                                                                                                                                   |
|       1 | 2015-09-24 17:23:37 | mefirst_love [Internet Explorer 11.0-Windows 8.1] | `把英文版全能翻译到这个地步，不错，辛苦了`                                                                                                                                         |
|       2 | 2015-10-22 10:10:02 | i1zhuxian [Chrome 42.0-Windows 10]                | `例6：归档时同时保存原始权限和所有权<br /> # tar cJf ApacheLogs-$(date +%Y%m%d).tar.xz /var/log/httpd/* --same-permissions --same-owner<br /> 这个好像写错了 应该使用p tar cpf ……` |
|       3 | 2015-10-22 11:19:20 | linux [Chrome 46.0-Mac 10.11]                     | `-p 参数相当于—same-permissions and —same-owner 。这里的代码高亮错误可能让你误会了。`                                                                                              |
|       4 | 2015-10-22 13:04:41 | i1zhuxian [Chrome 42.0-Windows 10]                | `汗 后面的我以为是注释呢……`                                                                                                                                                        |
