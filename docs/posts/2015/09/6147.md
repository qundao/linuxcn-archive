...
date_updated: 2015-09-04 17:39:00
slug: article-6147-1.html
url: https://linux.cn/article-6147-1.html
url_from: http://xmodulo.com/ipv6-bgp-peering-filtering-quagga-bgp-router.html
image: album/201509/04/173911o1e7oo1d9m1coao8.jpg
tags:
  - quagga
  - 路由器
categories:
...
在之前的教程中，我们演示了如何使用Quagga建立一个[完备的BGP路由器](https://linux.cn/article-4232-1.html)和配置[前缀过滤](http://xmodulo.com/filter-bgp-routes-quagga-bgp-router.html)。在本教程中，我们会向你演示如何创建IPv6 BGP对等体并通过BGP通告IPv6前缀。同时我们也将演示如何使用前缀列表和路由映射特性来过滤通告的或者获取到的IPv6前缀。
