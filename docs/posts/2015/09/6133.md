...
date_updated: 2015-09-02 12:40:00
slug: article-6133-1.html
url: https://linux.cn/article-6133-1.html
url_from: 
  http://www.tecmint.com/rhcsa-exam-reviewing-essential-commands-system-documentation/
image: album/201509/02/124011a8v89dd3ex36mqgs.png
tags:
  - rhcsa
  - rhel
categories:
...
* [RHCSA 系列（一）: 回顾基础命令及系统文档](https://linux.cn/article-6133-1.html)
* [RHCSA 系列（二）: 如何进行文件和目录管理](https://linux.cn/article-6155-1.html)
* [RHCSA 系列（三）: 如何管理 RHEL7 的用户和组](https://linux.cn/article-6187-1.html)
* [RHCSA 系列（四）: 编辑文本文件及分析文本](https://linux.cn/article-6229-1.html)
* [RHCSA 系列（五）: RHEL7 中的进程管理：开机，关机](https://linux.cn/article-6249-1.html)
* [RHCSA 系列（六）: 使用 Parted 和 SSM 来配置和加密系统存储](https://linux.cn/article-6257-1.html)
* [RHCSA 系列（七）: 使用 ACL（访问控制列表) 和挂载 Samba/NFS 共享](https://linux.cn/article-6263-1.html)
* [RHCSA 系列（八）: 加固 SSH，设定主机名及启用网络服务](https://linux.cn/article-6266-1.html)
* [RHCSA 系列（九）: 安装、配置及加固一个 Web 和 FTP 服务器](https://linux.cn/article-6286-1.html)
* [RHCSA 系列（十）: Yum 包管理、Cron 自动任务计划和监控系统日志](https://linux.cn/article-6300-1.html)志
* [RHCSA 系列（十一）: 使用 firewalld 和 iptables 来控制网络流量](https://linux.cn/article-6315-1.html)
* [RHCSA 系列（十二）: 使用 Kickstart 完成 RHEL 7 的自动化安装](https://linux.cn/article-6335-1.html)
* [RHCSA 系列（十三）：在 RHEL 7 中使用 SELinux 进行强制访问控制](https://linux.cn/article-6339-1.html)
* [RHCSA 系列（十四）：在 RHEL 7 中设置基于 LDAP 的认证](https://linux.cn/article-6348-1.html)
* [RHCSA 系列（十五）：虚拟化基础和使用 KVM 进行虚拟机管理](https://linux.cn/article-6362-1.html)
...
* [cd 命令](https://linux.cn/article-2479-1.html) (改变目录)
* [ls 命令](https://linux.cn/article-5109-1.html) (列举文件)
* [cp 命令](https://linux.cn/article-2687-1.html) (复制文件)
* [mv 命令](http://www.tecmint.com/rename-multiple-files-in-linux/) (移动或重命名文件)
* [touch 命令](https://linux.cn/article-2740-1.html) (创建一个新的文件或更新已存在文件的时间表)
* rm 命令 (删除文件)
* mkdir 命令 (创建目录)
...
* [echo 命令](https://linux.cn/article-3948-1.html): 展示字符串
* [pwd 命令](https://linux.cn/article-3422-1.html): 输出当前的工作目录
...
|   index | 日期                | 日期                                                 | 评论                                                                    |
|--------:|:--------------------|:-----------------------------------------------------|:------------------------------------------------------------------------|
|       0 | 2015-09-02 17:36:21 | XYJK1002 [Firefox 40.0-Windows 7]                    | `这个系列，目测很不错啊`                                                |
|       1 | 2015-09-02 18:43:33 | SageMa [Firefox 40.0-Windows 7]                      | `继续关注这一系统。`                                                    |
|       2 | 2015-09-04 19:13:18 | 来自山东泰安的 Chrome 31.0-Windows 8 用户            | `十分感谢分享<br /> 7版本如果推出大量免费内容 那么将持续关注。十分感谢` |
|       3 | 2015-09-05 17:41:36 | 来自浙江绍兴的 Chrome 45.0-Windows 10 用户           | `好多命令我都见识过。。。。。`                                          |
|       4 | 2015-09-05 22:26:52 | 来自广东深圳的 IE Mobile 11.0-Windows Phone 8.1 用户 | `十分感谢，一个优秀的运维必须有这扎实的功底。`                          |
|       5 | 2015-09-10 13:37:06 | 不简单 [Chrome 31.0-Windows 7]                       | `很不错！ 一定要把所有的系列完整的看一遍！！！`                         |
|       6 | 2015-09-10 19:15:31 | linux [Chrome 45.0-Mac 10.10]                        | `总共15篇，我们会逐一发出来，让我们共同学习吧！`                        |
|       7 | 2015-09-11 17:41:41 | 不简单 [Chrome 31.0-Windows 7]                       | `嗯嗯，谢谢分享，辛苦了！！！`                                          |
|       8 | 2016-06-07 19:07:35 | yutou83 [Internet Explorer 11.0-Windows 7]           | `感谢分享，很难看到这样一个完整的系列`                                  |
