...
|   index | 日期                | 日期                                            | 评论                                                                                                               |
|--------:|:--------------------|:------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------|
|       0 | 2016-08-24 21:51:38 | 来自湖北武汉的 Chrome 52.0-Windows 10 用户      | `mkdir -p new_folder/{folder_1,folder_2,folder_3,folder_4,folder_5}可以这样:<br /> mkdir new_folder/folder_{1..5}` |
