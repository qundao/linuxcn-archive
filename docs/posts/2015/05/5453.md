...
date_updated: 2015-05-17 08:10:00
slug: article-5453-1.html
url: https://linux.cn/article-5453-1.html
url_from: http://www.linuxtechi.com/linux-grep-command-with-14-different-examples/
image: album/201505/16/231734coi0os7nr0frpas6.png
tags:
  - grep
categories:
  - 技术
...
|   index | 日期                | 日期                             | 评论                                                                                                                           |
|--------:|:--------------------|:---------------------------------|:-------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2015-05-17 08:50:18 | 来自 - 甘肃 的 MSIE/Windows 用户 | `已收藏`                                                                                                                       |
|       1 | 2015-05-17 08:51:42 | Shadow-華                        | `手工赞，已收藏`                                                                                                               |
|       2 | 2015-05-17 12:02:07 | 崖山一劫                         | `linux下，命令就是强大啊`                                                                                                      |
|       3 | 2015-05-18 16:30:24 | Marco_90                         | `如何输出匹配行后的第几行或者匹配行前的第几行？`                                                                               |
|       4 | 2015-05-18 20:44:04 | linux                            | `没看完文章么？后面的几个例子不是说的这个？`                                                                                   |
|       5 | 2015-05-19 08:56:33 | Marco_90                         | `拿例14 b)来举例，我想要的效果是输出匹配 games后的第四行，也就是只输出news:…… 这一行，而不包含匹配games的这一行及随后的三行。` |
|       6 | 2015-05-19 11:34:10 | linux                            | `那就这个命令来说是不行的。。也许通过复杂的组合命令可行。或者，这种事情，通过写个小程序，比如 PERL、Python 的，就很容易。。`   |
|       7 | 2015-05-19 13:34:40 | Marco_90                         | `THX`                                                                                                                          |
