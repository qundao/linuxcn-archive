...
date_updated: 2015-05-30 23:14:34
slug: article-5542-1.html
url: https://linux.cn/article-5542-1.html
url_from: http://xmodulo.com/server-monitoring-system-monit.html
image: album/201505/30/225353hxk79hw9xw996vqz.png
tags:
  - monit
  - 监控
categories:
...
在CentOS/RHEL中，你必须首先启用[EPEL](https://linux.cn/article-2324-1.html)或者[Repoforge](http://xmodulo.com/how-to-set-up-rpmforge-repoforge-repository-on-centos.html)软件仓库.
...
|   index | 日期                | 日期                                      | 评论                                                                                        |
|--------:|:--------------------|:------------------------------------------|:--------------------------------------------------------------------------------------------|
|       0 | 2015-05-31 03:38:44 | 浩浩君                                    | `长见识了，只是想知道上图那狗狗是啥品种呢？`                                                |
|       1 | 2015-06-07 14:38:20 | xunil                                     | `测试了一下，的确很轻量。<br /> 但是好像不能对lvm的分区进行监控。`                          |
|       2 | 2015-12-02 12:57:19 | toplover [Chrome 43.0-Windows 7]          | `相当强悍的小东东，监控linux系统信息。`                                                     |
|       3 | 2016-01-12 20:38:32 | 来自浙江杭州的 Chrome 47.0-Windows 7 用户 | `很好的软件，但是有一个问题请教，邮件发送的时间和真实的时间相隔8个小时，可以在哪里更改吗？` |
|       4 | 2016-01-13 16:50:57 | linux [Chrome 47.0-Mac 10.11]             | `那显然是时区没配对。`                                                                      |
