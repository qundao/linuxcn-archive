...
date_updated: 2015-05-22 07:32:00
slug: article-5485-1.html
url: https://linux.cn/article-5485-1.html
url_from: http://www.tecmint.com/5-linux-command-line-tricks/
image: album/201505/21/223351gqbpks8pu904xpk4.jpg
tags:
  - 命令行
categories:
  - 技术
...
### 1. 我们可以使用[`history`命令](https://linux.cn/article-1143-1.html)来查看曾经运行过的命令。
...
|   index | 日期                | 日期                                       | 评论                                                                                              |
|--------:|:--------------------|:-------------------------------------------|:--------------------------------------------------------------------------------------------------|
|       0 | 2015-05-22 09:46:46 | 来自 - 江苏南京 的 Chrome/Linux 用户       | `输出到tmp目录可能造成结果不正确`                                                                 |
|       1 | 2015-05-22 10:37:17 | LouisWei                                   | `事实上，如果尝试找出整个box里面占磁盘最多的前几个文件会遇到很多读取权限问题，哪怕你是用root执行` |
|       2 | 2015-05-22 11:37:35 | vio                                        | `got it`                                                                                          |
|       3 | 2015-05-22 14:11:34 | kashu                                      | `dd`                                                                                              |
|       4 | 2015-05-22 14:39:31 | linux                                      | `root 不会，只要是磁盘存储的文件，root 无论如何都能访问的。`                                      |
|       5 | 2015-05-22 17:11:51 | leechau                                    | `sort -h 太方便了。`                                                                              |
|       6 | 2015-05-22 18:11:05 | LouisWei                                   | `从整个根目录来查找会查询内存的文件，所以会遇到访问问题`                                          |
|       7 | 2015-05-22 19:38:20 | 来自 - 北京 的 Firefox/Windows 用户        | `嗯，如果挂的是tmpfs就是变成写内存了。`                                                           |
|       8 | 2015-05-22 19:40:01 | 来自 - 北京 的 Firefox/Windows 用户        | `除了/proc /dev /sys这几个内核维护的文件系统应该没问题吧。`                                       |
|       9 | 2015-05-22 22:31:46 | LouisWei                                   | `嗯，除了内存文件嘛`                                                                              |
|      10 | 2015-05-23 21:54:51 | 来自 - 天津南开大学 的 Firefox/Linux 用户  | `谢谢分享！学习了--`                                                                              |
|      11 | 2015-05-26 16:55:48 | 贵在坚持                                   | `du命令很实用。`                                                                                  |
|      12 | 2015-10-06 20:18:54 | 来自广东珠海的 Firefox 30.0-GNU/Linux 用户 | `不错`                                                                                            |
