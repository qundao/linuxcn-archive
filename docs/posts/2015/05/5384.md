...
date_updated: 2015-05-05 08:52:00
slug: article-5384-1.html
url: https://linux.cn/article-5384-1.html
url_from: http://linoxide.com/linux-command/interface-nics-bonding-linux/
image: album/201505/04/215715sevw9ec4brcvkcp9.jpg
tags:
  - nmcli
  - 网卡绑定
categories:
...
|   index | 日期                | 日期                                      | 评论                                                                                                                                       |
|--------:|:--------------------|:------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2015-05-05 17:37:30 | 贵在坚持                                  | `https://access.redhat.com/documentation/en-US/Red_Hat_Enterprise_Linux/7/html/Networking_Guide/index.html<br /> 看来要学习的还有很多啊！` |
|       1 | 2015-05-06 20:21:42 | 绿色圣光                                  | `这个真的很有用！`                                                                                                                         |
|       2 | 2016-07-26 16:41:14 | 来自陕西西安的 Chrome 52.0-GNU/Linux 用户 | `在TEAM模式下，是否需要在交换机端进行端口汇聚操作呢？？哪位出来详细讲讲TEAM的几种网卡绑定模式和BOND几种绑定模式的区别吧`                   |
