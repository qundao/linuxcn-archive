...
date_updated: 2015-05-26 15:36:00
slug: article-5511-1.html
url: https://linux.cn/article-5511-1.html
url_from: http://www.omgubuntu.co.uk/2015/03/install-geary-ubuntu-linux-email-update
image: album/201505/26/153649dywk3qasqudjbkn9.jpg
tags:
  - email
  - geary
categories:
...
|   index | 日期                | 日期                                       | 评论                                                                               |
|--------:|:--------------------|:-------------------------------------------|:-----------------------------------------------------------------------------------|
|       0 | 2015-05-26 18:51:32 | 老沙                                       | `怎么用geary访问网易之类的邮箱？我按照网易帮助文件配置的，就是不行`                |
|       1 | 2015-05-26 19:35:01 | 来自 - 广东深圳 的 Firefox/Windows 用户    | `我用这个破玩意就没添加成功过邮箱，菊花转半天也不知道哪里出问题了，简直是一坨。。` |
|       2 | 2015-05-27 09:35:18 | momo                                       | `不支持网易和QQ邮箱。雅虎可以正常收发邮件。gmail被墙，也无法使用。`                |
|       3 | 2015-05-27 09:49:31 | 老沙                                       | `我的hotmail邮箱可以用。可惜不支持网易，看来需要换软件了`                          |
|       4 | 2015-05-27 19:05:55 | linlover                                   | `evolution路过`                                                                    |
|       5 | 2017-05-27 17:38:37 | 来自四川成都的 Firefox 53.0-GNU/Linux 用户 | `十分好用啊，简洁风格。gmail、outlook、qq我都用它收件`                             |
|       6 | 2017-05-27 17:39:06 | 来自四川成都的 Firefox 53.0-GNU/Linux 用户 | `我天天用它检查qq邮箱来件……`                                                       |
