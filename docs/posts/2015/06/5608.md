...
date_updated: 2015-06-11 14:02:00
slug: article-5608-1.html
url: https://linux.cn/article-5608-1.html
url_from: http://www.tecmint.com/mysterious-uses-of-symbol-or-operator-in-linux-commands/
image: album/201506/11/140239tazxmmzbpxuqtkyq.png
tags:
  - 惊叹号
  - 脚本
categories:
...
|   index | 日期                | 日期      | 评论                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
|--------:|:--------------------|:----------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2015-06-11 17:39:17 | soli      | `那么 !! 和 !-1 是一样的么？<br /> <br /> 好危险的命令！`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
|       1 | 2015-06-12 00:36:29 | Sephiroth | `很有用的技巧，之前只知道 ！+编号 和 ！！ 这种用法，没想到还有这么多有用的纠正错误输入的手段。`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
|       2 | 2015-06-17 22:47:36 | yuanwow   | `7 运行一个影响所有除了![FILE_NAME]的文件命令&nbsp; &nbsp;<br /> 没有测试成功<br /> [root@node1 test]# ll<br /> total 0<br /> -rw-r--r-- 1 root root 0 Jun 17 22:31 1<br /> -rw-r--r-- 1 root root 0 Jun 17 22:30 1.sh<br /> -rw-r--r-- 1 root root 0 Jun 17 22:31 2<br /> -rw-r--r-- 1 root root 0 Jun 17 22:30 2.sh<br /> -rw-r--r-- 1 root root 0 Jun 17 22:31 3<br /> -rw-r--r-- 1 root root 0 Jun 17 22:30 3.sh<br /> -rw-r--r-- 1 root root 0 Jun 17 22:31 4<br /> -rw-r--r-- 1 root root 0 Jun 17 22:30 4.sh<br /> -rw-r--r-- 1 root root 0 Jun 17 22:31 5<br /> [root@node1 test]# rm !(*.sh)<br /> -bash: !: event not found` |
|       3 | 2015-06-18 12:29:23 | linux     | `这个确实的原文没有说清楚。根据我的研究，这个需要打开 bash 里面 extglob 模式，使用 shopt -s extglob 来打开后，才支持 ?(pattern-list) ，*(pattern-list) ，+(pattern-list) ，@(pattern-list) 和 !(pattern-list) 。关于这个，我找找有无详尽的资料来介绍一下，或者也欢迎有研究过的投稿。:&gt;`                                                                                                                                                                                                                                                                                                                                             |
