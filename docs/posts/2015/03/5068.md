...
date_updated: 2015-03-18 07:02:00
slug: article-5068-1.html
url: https://linux.cn/article-5068-1.html
url_from: http://xmodulo.com/configure-fail2ban-apache-http-server.html
image: album/201503/16/220730kgg5ksgsggfgl2jw.png
tags:
  - apache
  - fail2ban
categories:
...
在本教程中，我会演示如何配置fail2ban来保护你的apache服务器。我假设你已经安装了apache和fail2ban。对于安装，请参考[另外一篇教程](https://linux.cn/article-5067-1.html)。

### 什么是 Fail2ban 监狱

`![](/data/attachment/album/201503/16/220730kgg5ksgsggfgl2jw.png)`

让我们更深入地了解 fail2ban 监狱。监狱定义了具体的应用策略，它会为指定的程序触发一个保护措施。fail2ban在 /etc/fail2ban/jail.conf 下为一些流行程序如Apache、Dovecot、Lighttpd、MySQL、Postfix、[SSH](https://linux.cn/article-5067-1.html) 等预定义了一些监狱。每个监狱都通过特定的程序日志过滤器（在/etc/fail2ban/fileter.d 下面）来检测通常的攻击。让我看一个例子监狱：SSH监狱。
...
|   index | 日期                | 日期                                | 评论            |
|--------:|:--------------------|:------------------------------------|:----------------|
|       0 | 2015-03-18 07:33:01 | 微博评论                            | `@我的印象笔记` |
|       1 | 2015-03-18 08:30:49 | lyhabc                              | `挺好的`        |
|       2 | 2015-03-19 08:38:28 | netb2c                              | `+1`            |
|       3 | 2015-08-12 16:21:56 | 守候2581314 [Chrome 44.0-Windows 7] | `棒棒的`        |
