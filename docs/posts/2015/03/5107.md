...
date_updated: 2015-03-24 11:44:00
slug: article-5107-1.html
url: https://linux.cn/article-5107-1.html
url_from: http://xmodulo.com/debug-program-nemiver-debugger.html
image: album/201503/22/214604nkc33p2pv33ps392.jpg
tags:
  - gdb
  - nemiver
  - 调试
...
如果你读过我写的[使用GDB命令行调试器调试C/C++程序](https://linux.cn/article-4302-1.html)，你就会明白一个调试器对一段C/C++程序来说有多么的重要和有用。然而，如果一个像GDB这样的命令行对你而言听起来更像一个问题而不是一个解决方案的话，那么你也许会对Nemiver更感兴趣。[Nemiver](https://wiki.gnome.org/Apps/Nemiver) 是一款基于 GTK+ 的用于C/C++程序的图形化的独立调试器，它以GDB作为其后端。最令人赞赏的是其速度和稳定性，Nemiver是一个非常可靠，具备许多优点的调试工具。
...
|   index | 日期                | 日期       | 评论                                          |
|--------:|:--------------------|:-----------|:----------------------------------------------|
|       0 | 2015-03-24 12:03:01 | 微博评论   | `马`                                          |
|       1 | 2015-03-24 12:33:04 | 微博评论   | `好东西！`                                    |
|       2 | 2015-03-24 12:33:04 | 微博评论   | `牛逼`                                        |
|       3 | 2015-03-24 12:33:04 | 微博评论   | `这不就是gdb套了一个马甲嘛？还是更喜欢gdb！`  |
|       4 | 2015-03-24 13:03:02 | 微博评论   | `mark`                                        |
|       5 | 2015-03-24 16:33:02 | 微博评论   | `mark`                                        |
|       6 | 2015-03-24 21:33:02 | 微博评论   | `mark`                                        |
|       7 | 2015-03-25 08:48:33 | jbiaojerry | `mark，但是我在centos7上无法安装，各种郁闷啊` |
|       8 | 2015-03-25 17:03:01 | 微博评论   | `用IDE调试的的飘过`                           |
