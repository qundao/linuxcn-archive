...
date_updated: 2015-03-21 08:23:00
slug: article-5095-1.html
url: https://linux.cn/article-5095-1.html
url_from: http://linux.about.com/od/dist/fl/Ubuntu-With-XFCE-vs-Xubuntu-Linux.htm
image: album/201503/21/174426lfupn0u37hig4ggn.png
tags:
  - ubuntu
  - xfce
  - xubuntu
...
|   index | 日期                | 日期                                 | 评论                                                                                                                                                                                                                                                                                                                                                              |
|--------:|:--------------------|:-------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2015-03-21 09:29:49 | 来自 - 四川成都 的 Chrome/Linux 用户 | `Xfce 发展不快，像 4.10 版把 tasklist 像 Unity 那样竖直放置，结果应用程序按钮的图标大小，记得不是很清楚，好象是 32x32，而不是 48x48。看着特别别扭，改配置文件没有看到效果，而且网上的改配置文件说得不够清楚。下源码看了一下，代码应该没有读取那部分，得自己修改若干源码文件才行。最新版没有用过，不知到有无改善。`                                                |
|       1 | 2015-03-21 10:03:01 | 微博评论                             | `反正我用gentoo`                                                                                                                                                                                                                                                                                                                                                  |
|       2 | 2015-03-21 11:03:05 | 微博评论                             | `mark`                                                                                                                                                                                                                                                                                                                                                            |
|       3 | 2015-03-21 11:03:05 | 微博评论                             | `给虚拟机安上Ubuntu 14.04.2 LTS，明明语言是英文，时间却是中文。Ubuntu能不能不要为用户做太多决定。。。[巨汗]`                                                                                                                                                                                                                                                      |
|       4 | 2015-03-21 11:33:01 | 微博评论                             | `我用了USB creator和UltraISO把xubuntu 14.04写进u盘，但是台式电脑u盘启动都不行，进不去，求助！！！`                                                                                                                                                                                                                                                                |
|       5 | 2015-03-21 12:03:01 | 微博评论                             | `Ubuntu 太卡.......启动也慢.`                                                                                                                                                                                                                                                                                                                                     |
|       6 | 2015-03-21 12:33:01 | 微博评论                             | `已经逃离Ubuntu，奔向Arch！`                                                                                                                                                                                                                                                                                                                                      |
|       7 | 2015-03-22 09:23:15 | 朩ダo○                               | `xubuntu的中文化进展的很慢，很多自带的应用程序都没有很好的汉化。不过该系统极为轻量，很多细节也做的不错。还有一点就是桌面环境并没有把ibus耦合进去，所以可以很方便容易的安装sougou的拼音输入法，而ubuntu的unity环境由于耦合了ibus，导致即使要安装sougou也没办法卸载ibus。不过需要注意的是，xubuntu由于使用了xfce桌面，有些为ubuntu设计的应用程序会出现兼容性问题。` |
|       8 | 2015-04-14 16:05:30 | 丶Nature                             | `我觉得这个应该不需要汉化，除了常用的输入法，其他的我还是喜欢英文的更适用一点~`                                                                                                                                                                                                                                                                                   |
