...
date_updated: 2015-12-21 11:54:00
slug: article-6770-1.html
url: https://linux.cn/article-6770-1.html
url_from: http://www.unixmen.com/install-postgresql-9-4-and-phppgadmin-on-ubuntu-15-10/
image: album/201512/21/115439lfjotemjk8fiqoq8.png
tags:
  - postgresql
  - 数据库
categories:
...
|   index | 日期                | 日期                                      | 评论                                                                                                                  |
|--------:|:--------------------|:------------------------------------------|:----------------------------------------------------------------------------------------------------------------------|
|       0 | 2015-12-21 13:51:59 | 来自江苏宿迁的 Chrome 47.0-Windows 7 用户 | `建议译者校对重新审核下文章，14.10才是非长期支持版。在“安装 PostgreSQL” 这个部分错误。`                               |
|       1 | 2015-12-21 21:49:16 | linux [Chrome 47.0-Mac 10.11]             | `谢谢指正，确实是校对失误。：D`                                                                                       |
|       2 | 2015-12-22 10:39:42 | 来自北京的 Chrome 47.0-GNU/Linux 用户     | `导入库签名密钥： 这步出错了。 两条命令应该一次完成。 正确应该是： wget --quiet -O - [签名地址] - sudo apt-key add -` |
|       3 | 2015-12-22 15:32:45 | linux [Chrome 47.0-Mac 10.11]             | `对不起，原文就错了，我们也没发现。谢谢！`                                                                            |
|       4 | 2015-12-28 21:33:16 | linsudoer [Firefox 43.0-Windows 8.1]      | `看了之后，没发现它的强大之处在哪里？`                                                                                |
