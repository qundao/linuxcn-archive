...
date_updated: 2015-12-18 17:27:00
slug: article-6756-1.html
url: https://linux.cn/article-6756-1.html
url_from: ''
image: album/201512/18/172713vndez88mnme1e48x.jpg
tags:
  - grub
  - 安全
  - 救援
...
|   index | 日期                | 日期                                        | 评论                                                                                |
|--------:|:--------------------|:--------------------------------------------|:------------------------------------------------------------------------------------|
|       0 | 2015-12-18 17:42:19 | 来自上海的 Firefox 43.0-Ubuntu 用户         | `哦，怪不得这两天grub更新了，原来是补漏洞`                                          |
|       1 | 2015-12-18 20:04:07 | 来自天津的 Vivaldi 1.0-GNU/Linux 用户       | `危害性不大，需要物理接触`                                                          |
|       2 | 2015-12-18 20:04:11 | 来自天津的 Vivaldi 1.0-GNU/Linux 用户       | `危害性不大，需要物理接触`                                                          |
|       3 | 2015-12-18 20:26:38 | experience [Chrome 47.0-GNU/Linux]          | `奇葩漏洞`                                                                          |
|       4 | 2015-12-19 00:15:30 | 绿色圣光 [Iceweasel 38.2-GNU/Linux]         | `哦。`                                                                              |
|       5 | 2015-12-19 04:38:46 | 来自湖北的 Chrome 47.0-Windows 10 用户      | `CentOS 7.0 没有这个问题。`                                                         |
|       6 | 2015-12-19 08:42:33 | linux [Chrome 47.0-Mac 10.11]               | `不会啊，GRUB2 2.02 是当前最新的。除非你打上了补丁，或者没启用验证。`               |
|       7 | 2015-12-19 15:36:29 | yang.yusi [Firefox 43.0-Ubuntu]             | `涨姿势了～～～`                                                                    |
|       8 | 2015-12-19 18:17:43 | 文剑一飞 [Chrome 47.0-Windows 7]            | `这都退了28步了`                                                                    |
|       9 | 2015-12-19 19:14:42 | 来自湖北的 Chrome 47.0-Windows 10 用户      | `你这个验证，是指的啥？ 为用户设置密码吗？`                                         |
|      10 | 2015-12-19 19:16:47 | 来自湖北的 Chrome 47.0-Windows 10 用户      | `(GRUB) 2.02~beta2 这是我机子上面的版本。`                                          |
|      11 | 2015-12-19 22:52:02 | linux [Chrome 47.0-Mac 10.11]               | `看来你没用过 GRUB2 里面验证。本文中有链接说明。`                                   |
|      12 | 2015-12-22 00:22:43 | 来自广东珠海的 Chrome 47.0-GNU/Linux 用户   | `你在GRUB引导有密码保护么？<br /> 然……<br /> 你不会是在linux登录的时候按退格键吧……` |
|      13 | 2015-12-22 01:05:22 | linux [Chrome 47.0-Mac 10.11]               | `前两天发的，最新的 CentOS 7.0 1511 是补了。`                                       |
|      14 | 2015-12-23 08:43:19 | 来自福建厦门的 Firefox 43.0-Windows 7 用户  | `没设置密码。。。。。。。。。。。。。。`                                            |
|      15 | 2015-12-24 21:21:40 | 来自江苏南京的 Firefox 43.0-Windows 10 用户 | `真想试一下`                                                                        |
|      16 | 2016-01-18 13:10:37 | 来自北京的 Chrome 48.0-GNU/Linux 用户       | `物理接触，进入系统的方法太多了。。。`                                              |
