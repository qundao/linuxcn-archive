...
date_updated: 2015-04-26 14:24:00
slug: article-5335-1.html
url: https://linux.cn/article-5335-1.html
url_from: http://linoxide.com/linux-how-to/install-configure-vnc-server-centos-7-0/
image: album/201504/26/112812oz6l6tnr6trnmluc.png
tags:
  - vnc
categories:
  - 系统运维
...
|   index | 日期                | 日期                                                | 评论                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
|--------:|:--------------------|:----------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2015-04-26 21:10:32 | lyhabc                                              | `实用`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
|       1 | 2015-04-28 19:50:22 | storenyang                                          | `centos的桌面程序到底怎么选呢？`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
|       2 | 2015-04-28 20:34:31 | linux                                               | `不选也罢`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
|       3 | 2015-06-08 16:42:14 | 桫椤慢慢                                            | `我一直觉得VNC很麻烦，在看了之后，感觉也是很简单的说。`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
|       4 | 2015-11-26 16:44:00 | Randall_J [Chrome 31.0-Windows 7]                   | `写得很好。我配置完成后，在Windows上用tigerVNC连接很爽，<a href="http://pan.baidu.com/s/1o6NBztg" target="_blank">http://pan.baidu.com/s/1o6NBztg</a>`                                                                                                                                                                                                                                                                                                                                                                                                                |
|       5 | 2016-04-01 09:15:05 | 来自广东广州的 Chrome 49.0-Windows 7 用户           | `版主好啊，一路下来配置都没出现问题。为什么连接不上呢？用的是Tightvnc viewer，端口是填的1啊！`                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
|       6 | 2017-07-17 16:35:52 | 来自江西南昌南昌大学的 Firefox 54.0-Windows 10 用户 | `启动时报错<br /> [root@iZwz9eh9ld1ffvzr3af3xgZ ~]# sudo systemctl start vncserver@:1.service<br /> Job for vncserver@:1.service failed because a configured resource limit was exceeded. See &quot;systemctl status vncserver@:1.service&quot; and &quot;journalctl -xe&quot; for details.`                                                                                                                                                                                                                                                                          |
|       7 | 2017-08-23 09:57:15 | 来自北京的 Chrome 50.0-Windows 10 用户              | `试试： rm&nbsp;&nbsp;-rf&nbsp;&nbsp;/tmp/.X110unix/*`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
|       8 | 2019-05-12 01:08:24 | 来自广东深圳的 Chrome 65.0-Windows 10 用户          | `非常感谢，看了好多文章，楼主这篇终于成了！其实当我看到开篇楼主说：<br /> <br /> 注意：以下命令必须以 root 权限运行。要切换到 root ，请在终端下运行“sudo -s”，当然不包括双引号（“”）<br /> <br /> 楼主连引号这个细节都注意到了，赞?<br /> ------------------------------<br /> 我也碰到Job for vncserver@:1.service failed because a configured resource limit was exceeded. 这个问题了，但是我没管它，貌似后继也没啥事，vnc确实能用。<br /> <br /> 还有就是首次登录x-window的时候密码无论如何显示“sorry,that didnt work,please try again&quot; , 碰到这个情况只需要` |
|       9 | 2019-05-12 01:08:27 | 来自广东深圳的 Chrome 65.0-Windows 10 用户          | `非常感谢，看了好多文章，楼主这篇终于成了！其实当我看到开篇楼主说：<br /> <br /> 注意：以下命令必须以 root 权限运行。要切换到 root ，请在终端下运行“sudo -s”，当然不包括双引号（“”）<br /> <br /> 楼主连引号这个细节都注意到了，赞?<br /> ------------------------------<br /> 我也碰到Job for vncserver@:1.service failed because a configured resource limit was exceeded. 这个问题了，但是我没管它，貌似后继也没啥事，vnc确实能用。<br /> <br /> 还有就是首次登录x-window的时候密码无论如何显示“sorry,that didnt work,please try again&quot; , 碰到这个情况只需要` |
