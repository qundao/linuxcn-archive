...
date_updated: 2015-01-19 11:30:00
slug: article-4697-1.html
url: https://linux.cn/article-4697-1.html
url_from: http://itsfoss.com/create-bootable-ubuntu-usb-drive-mac-os/
image: album/201501/18/233219vv5ddnn9n7dbgicz.jpg
tags:
  - mac
  - usb
  - 启动盘
...
|   index | 日期                | 日期                                          | 评论                                                                                                                                                                                                                                               |
|--------:|:--------------------|:----------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2015-01-19 12:03:03 | 微博评论                                      | `Repost`                                                                                                                                                                                                                                           |
|       1 | 2015-01-19 12:03:03 | 微博评论                                      | `#mac# #utuntun# #tools#`                                                                                                                                                                                                                          |
|       2 | 2015-01-19 12:03:03 | 微博评论                                      | `双系统还是干掉osx只留ubuntu，是个问题...`                                                                                                                                                                                                         |
|       3 | 2015-01-19 12:27:50 | 来自 - 广东深圳 的 Chrome/Linux 用户          | `为什么要Ubuntu？mac os可是工作娱乐两不误啊`                                                                                                                                                                                                       |
|       4 | 2015-01-19 12:33:02 | 微博评论                                      | `Mac OS+Ubuntu`                                                                                                                                                                                                                                    |
|       5 | 2015-01-19 12:33:02 | 微博评论                                      | `大哥，你咋今天才发呢，我昨天装的吐血哇，哈哈，不过我不是在Mac 上装Ubuntu`                                                                                                                                                                         |
|       6 | 2015-01-19 13:03:06 | 微博评论                                      | `Mac其实够用够优秀的，为什么要换系统？[嘻嘻]`                                                                                                                                                                                                      |
|       7 | 2015-01-19 13:33:02 | 微博评论                                      | `好东西啊，拯救了银河系//@校长Ubuntu: 转发微博`                                                                                                                                                                                                    |
|       8 | 2015-01-19 13:33:02 | 微博评论                                      | `哈哈，其实这样做成的 USB 启动盘，其它系统也能用的~~//@书窗外的冷雨: 大哥，你咋今天才发呢，我昨天装的吐血哇，哈哈，不过我不是在Mac 上装Ubuntu`                                                                                                     |
|       9 | 2015-01-19 13:33:02 | 微博评论                                      | `也许有用//@Linux中国: 哈哈，其实这样做成的 USB 启动盘，其它系统也能用的~~//@书窗外的冷雨: 大哥，你咋今天才发呢，我昨天装的吐血哇，哈哈，不过我不是在Mac 上装Ubuntu`                                                                               |
|      10 | 2015-01-19 13:42:17 | 来自 - 上海 的 Chrome/Mac 用户                | `vagrant哭晕在厕所！`                                                                                                                                                                                                                              |
|      11 | 2015-01-19 14:03:04 | 微博评论                                      | `mark//@Linux中国: 哈哈，其实这样做成的 USB 启动盘，其它系统也能用的~~//@书窗外的冷雨: 大哥，你咋今天才发呢，我昨天装的吐血哇，哈哈，不过我不是在Mac 上装Ubuntu`                                                                                   |
|      12 | 2015-01-19 14:03:04 | 微博评论                                      | `奇怪了，难道大家都不知道还有一个东西叫做vagrant嘛？//@Linux中国: 哈哈，其实这样做成的 USB 启动盘，其它系统也能用的~~//@书窗外的冷雨: 大哥，你咋今天才发呢，我昨天装的吐血哇，哈哈，不过我不是在Mac 上装Ubuntu`                                    |
|      13 | 2015-01-19 14:03:04 | 微博评论                                      | `嗯，别小看了这类技巧，因为GNU/Linux是融合了SystemV和Free BSD的特性的Unix,而Mac OS X 是基于Darwin从而也属于Free BSD分支，两者的差别很大，最常用的两个钩子函数fcntl和ioctl在两个平台的差别可谓巨大，导致很多设备的驱动和读写都不同，怒顶@Linux中国` |
|      14 | 2015-01-19 14:33:06 | 微博评论                                      | `回复@书窗外的冷雨:谢谢~`                                                                                                                                                                                                                          |
|      15 | 2015-01-19 15:33:03 | 微博评论                                      | `//@Linux中国:哈哈，其实这样做成的 USB 启动盘，其它系统也能用的~~//@书窗外的冷雨: 大哥，你咋今天才发呢，我昨天装的吐血哇，哈哈，不过我不是在Mac 上装Ubuntu`                                                                                        |
|      16 | 2015-01-19 15:45:30 | linux                                         | `和 vagrant 有什么关系？`                                                                                                                                                                                                                          |
|      17 | 2015-01-20 09:03:01 | 微博评论                                      | `@我的印象笔记 以后装时用`                                                                                                                                                                                                                         |
|      18 | 2016-03-27 13:41:20 | 来自河南洛阳的 Baidu Spark 7.6-Windows 7 用户 | `我是用同样的方法安装kali 但是到了启动安装却失败了，说是分出来的第二个分区擦不掉，怎么解决？`                                                                                                                                                      |
