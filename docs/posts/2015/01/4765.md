...
date_updated: 2015-01-28 09:06:00
slug: article-4765-1.html
url: https://linux.cn/article-4765-1.html
url_from: http://xmodulo.com/haproxy-http-load-balancer-linux.html
image: album/201501/27/221127l63m13ftwpf66rxp.jpg
tags:
  - haproxy
  - 负载均衡
categories:
...
你至少要有一台，或者最好是两台 Web 服务器来验证你的负载均衡的功能。我们假设后端的 HTTP Web 服务器已经配置好并[可以运行](https://linux.cn/article-1567-1.html)。
...
|   index | 日期                | 日期     | 评论                     |
|--------:|:--------------------|:---------|:-------------------------|
|       0 | 2015-01-28 09:33:02 | 微博评论 | `@有道云笔记收藏`        |
|       1 | 2015-01-28 11:03:01 | 微博评论 | `有些没用过的配置，留看` |
