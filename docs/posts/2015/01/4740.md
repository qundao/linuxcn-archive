...
date_updated: 2015-01-24 21:57:00
slug: article-4740-1.html
url: https://linux.cn/article-4740-1.html
url_from: http://itsfoss.com/find-network-adapter-ubuntu-linux/
image: album/201501/24/215758hkrsrxjpp2dsiadi.png
tags:
  - lshw
  - lspci
  - 网卡
...
|   index | 日期                | 日期     | 评论                                                                                                                                                                                                                                       |
|--------:|:--------------------|:---------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2015-01-24 22:03:04 | 微博评论 | `Repost`                                                                                                                                                                                                                                   |
|       1 | 2015-01-24 22:33:01 | 微博评论 | `@我的印象笔记`                                                                                                                                                                                                                            |
|       2 | 2015-01-25 00:03:04 | 微博评论 | `联想g490不能用fglrx驱动。。。`                                                                                                                                                                                                            |
|       3 | 2015-01-25 08:33:01 | 微博评论 | `//@linux命令行精选网:转发微博`                                                                                                                                                                                                            |
|       4 | 2015-01-25 08:38:53 | ChangLiu | `&quot; lshw 命令实际上死用来列出硬件的&quot; 这句话中有错别字。<br /> 还有关于这句 “你不应该用特权模式来运行这个命令”，如果用特权模式来运行这个命令，有什么后果吗？还是用 普通模式就可以运行，而不必要使用特权模式？这两个都没有说清楚。` |
|       5 | 2015-01-25 09:33:02 | 微博评论 | `@我的印象笔记`                                                                                                                                                                                                                            |
|       6 | 2015-01-25 12:24:30 | linux    | `谢谢，已经修正~~`                                                                                                                                                                                                                         |
|       7 | 2015-01-25 16:03:01 | 微博评论 | `以前常用现在忘了。。`                                                                                                                                                                                                                     |
