...
|       1 | 2015-08-10 22:03:25 | F.G.P [Liebao-Windows 8.1]                | `我也是遇到这样的问题。实验了几遍。通过查看文档，应该是这样的：<br /> find -type f -printf '%A@ %t %p\n' -sort<br /> 其中 %A@是相对70年的秒数，%t是修改时间。手册地址：http://man.he.net/man1/find` |
