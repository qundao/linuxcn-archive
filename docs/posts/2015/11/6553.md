...
date_updated: 2015-11-09 10:27:00
slug: article-6553-1.html
url: https://linux.cn/article-6553-1.html
url_from: https://www.maketecheasier.com/configure-pxe-server-ubuntu/
image: album/201511/08/233125iu4dcjdgjs4mrgp8.jpg
tags:
  - pxe
  - tftp
  - 安装
...
|   index | 日期                | 日期                                    | 评论                                                                                                                                      |
|--------:|:--------------------|:----------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2015-11-09 13:33:30 | 来自新疆的 Chrome 45.0-Windows 8.1 用户 | `aaa`                                                                                                                                     |
|       1 | 2015-11-09 16:07:55 | 绿色圣光 [Firefox 41.0-Windows 7]       | `一直没用到过这个，原来是这样用的。`                                                                                                      |
|       2 | 2015-11-09 17:09:58 | 来自北京的 Chrome 31.0-Windows 10 用户  | `首先需要被安装的服务器能获取到PXE服务器上DHCP服务分出的地址，然后安装完成后需要每台服务器去配置IP地址....如果是10台以上岂不是很麻烦....` |
|       3 | 2015-11-23 17:25:47 | 丶Nature [Chrome 45.0-Windows 7]        | `额，我觉得总比一台一台安装系统省心很多吧？<br /> 也有大牛，写了脚本去搞~~<br /> 回题：tftp换成nfs很好用~`                                |
