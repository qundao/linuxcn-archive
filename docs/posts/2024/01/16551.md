...
|   index | 日期                | 日期                                         | 评论                                                                                                                                                                                                                                                                                                |
|--------:|:--------------------|:---------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2024-01-12 18:48:06 | 来自吉林延边的 Firefox 121.0-Windows 10 用户 | `Font embedding code was completely rewritten from scratch to enable support of complex scripts such as Arabic, Hebrew, Chinese and Hindi that arrived in the 1.5.x development series. <br /> 支持复杂排版了，对于 GUI 排版界很难得…<br /> …但都是各种 TeX 玩剩的东西，看看支不支持开明式标点吧（` |
