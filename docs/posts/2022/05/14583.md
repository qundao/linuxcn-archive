...
date_updated: 2022-05-12 10:15:00
slug: article-14583-1.html
url: https://linux.cn/article-14583-1.html
url_from: https://itsfoss.com/install-h-264-decoder-ubuntu/
image: album/202205/12/101451szky6vn0vn4ssv2s.jpg
tags:
  - h.264
  - 多媒体解码器
categories:
...
> 系统没有安装所需的多媒体解码器，导致视频播放器播放该视频文件。
...
|   index | 日期                | 日期                                         | 评论                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
|--------:|:--------------------|:---------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2022-05-12 10:59:48 | 来自山东济南的 Firefox 100.0-Android 10 用户 | `棒，一般教程都过时了，更新一下也不错。`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
|       1 | 2022-05-12 21:55:05 | 来自上海的 Safari 15.0-Fedora 用户           | `装硬件解码的VAAPI版本才是正道`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
|       2 | 2022-05-12 23:14:04 | 来自上海的 Chrome 101.0-Windows 10 用户      | `我一直都是sudo apt install mpv解决`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
|       3 | 2022-05-13 16:29:48 | 来自浙江台州的 Firefox 78.0-GNU/Linux 用户   | `apt install -y&nbsp;&nbsp;smplayer&nbsp;&nbsp;mpv libmpv-dev mencoder<br /> apt install -y&nbsp;&nbsp;x264 libx264-dev h264enc x265 libx265-dev libde265-dev libde265-0 <br /> apt install -y&nbsp;&nbsp;gstreamer1.0-alsa&nbsp;&nbsp;gstreamer1.0-pulseaudio<br /> apt install -y&nbsp;&nbsp;gstreamer1.0-libav&nbsp;&nbsp;<br /> apt install -y&nbsp;&nbsp;gstreamer1.0-tools <br /> apt install -y&nbsp;&nbsp;gstreamer1.0-plugins-good&nbsp;&nbsp;<br /> apt install -y&nbsp;&nbsp;gstreamer1.0-plugins-bad&nbsp;&nbsp;<br /> apt install -y&nbsp;&nbsp;gstreamer1.0-plugins-base&nbsp;&nbsp;gstreamer1.0-plugins-ugly` |
