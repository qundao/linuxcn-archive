...
|   index | 日期                | 日期                                       | 评论                                                                                                                                                                                          |
|--------:|:--------------------|:-------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2022-03-24 11:48:18 | 来自四川成都的 Chrome 88.0-Windows 10 用户 | `我之前也有想法在 Shell 中运行 Python。<br /> <br /> 但我的做法是写一个名为 py 的脚本放在 PATH 中，然后只需在 Shell 中输入 py python-code 就行了。python-code 会作为参数传入 py 脚本中执行。` |
