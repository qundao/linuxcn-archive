...
date_updated: 2022-10-22 11:59:00
slug: article-15164-1.html
url: https://linux.cn/article-15164-1.html
url_from: https://itsfoss.com/bash-command-not-found/
image: album/202210/22/115959lu4u4x2xxw463uy4.png
tags:
  - 命令
categories:
  - 技术
...
|   index | 日期                | 日期                                                 | 评论                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
|--------:|:--------------------|:-----------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2022-10-22 18:27:34 | 来自四川南充的 Chrome 108.0-Windows 10 用户          | `没多大的帮助，旦凡用了一两天的 Linux，都知道要不是拼错了，要不是没装对应的软件包。<br /> <br /> 最重要的是得知道 &quot;这个命令它到底在什么软件包里&quot;，以下是各系统搜索软件包文件的命令。<br /> <br /> Arch Linux: pacman -F<br /> Fedora: dnf provides<br /> Debian: apt-file search<br /> openSUSE: zypper what-provides / zypper wp / zypper search -f<br /> Gentoo: equery belongs<br /> <br /> 比如，不知道 nokfw 这个命令是由什么软件包提供，直接执行 pacman -F nokfw 命令，然后就知道是 bluez-utils 包提供的。` |
|       1 | 2022-10-22 21:37:22 | 来自山东的 Firefox 106.0-GNU/Linux 用户              | `确实，但是对于很多 Linux 新手来说还是挺有用的。比如以前啥都不会就尝试 WSL Ubuntu 的我，不知道 gcc -o 后头该写什么扩展名……有了缺省的 a.out，又不知道如何执行，甚至尝试使用 exec 来执行它。<br /> <br /> 不过 newbies，只要敢折腾，终究可以成为 dalao。`                                                                                                                                                                                                                                                                     |
|       2 | 2022-10-23 23:09:06 | 来自湖北武汉的 Chrome Mobile iOS 106.0-iOS 16.0 用户 | `把 The fuck 文章链接贴出来了更好。我就是在linux 中国种草的thefuck ，打错了命令fuck下就好`                                                                                                                                                                                                                                                                                                                                                                                                                                  |
|       3 | 2022-10-24 09:10:53 | 暗灬先知 [Chrome 106.0-GNU/Linux]                    | `有个网站叫做 command-not-found`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
