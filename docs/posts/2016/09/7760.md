...
date_updated: 2016-09-11 10:39:00
slug: article-7760-1.html
url: https://linux.cn/article-7760-1.html
url_from: 
  https://medium.com/@sachagreif/the-state-of-javascript-javascript-flavors-1e02b0bfefb6
image: album/201609/10/234528jk1qdkdarbnigbbq.jpg
tags:
  - javascript
categories:
  - 观点
...
|   index | 日期                | 日期                                        | 评论                                                                           |
|--------:|:--------------------|:--------------------------------------------|:-------------------------------------------------------------------------------|
|       0 | 2016-09-12 00:32:55 | 绿色圣光 [Firefox 45.0-GNU/Linux]           | `啊……<br /> 我已经两年多没写过JavaScript代码了。最近又要拾起来。`              |
|       1 | 2016-09-13 11:37:04 | 来自四川成都的 Chrome 51.0-Windows 10 用户  | `那个调查问卷感觉很不靠谱~`                                                    |
|       2 | 2016-09-13 11:39:58 | 来自四川成都的 Chrome 51.0-Windows 10 用户  | `每个程序员应该都知道javascript吧，但专注与后端的未必知道其他几个~`            |
|       3 | 2016-09-18 10:07:33 | 来自四川成都的 Firefox 48.0-Windows 10 用户 | `我来吐槽一下，es6是标准，javascript是实现。怎么能说es6是一种javascript方言。` |
|       4 | 2016-09-18 14:12:42 | 来自北京的 Firefox 48.0-Windows 7 用户      | `说的对`                                                                       |
|       5 | 2016-09-18 15:41:00 | linux [Chrome 52.0-Mac 10.11]               | `确实感觉用词欠妥。原文用词是“ Flavors”。`                                     |
