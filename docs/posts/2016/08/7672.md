...
date_updated: 2016-08-11 13:54:00
slug: article-7672-1.html
url: https://linux.cn/article-7672-1.html
url_from: https://itsfoss.com/command-line-text-editors-linux/
image: album/201608/11/135524bs61phcgp8fehosq.jpg
tags:
  - emacs
  - vi
  - vim
...
文本编辑软件在任何操作系统上都是必备的软件。我们在 Linux 上不缺乏[非常现代化的编辑软件](https://linux.cn/article-7468-1.html)，但是它们都是基于 GUI（图形界面）的编辑软件。
...
|   index | 日期                | 日期                                   | 评论                                                        |
|--------:|:--------------------|:---------------------------------------|:------------------------------------------------------------|
|       0 | 2016-08-11 14:17:34 | fanbt [Firefox 48.0-Fedora]            | `其实VIM也有跨平台，也有图形化的版本，它叫GVIM`             |
|       1 | 2016-08-11 16:40:44 | chenzhijun [Chrome 49.0-Mac 10.11]     | `恩恩。是的~~不过可能大家一提到Vim就习惯性的想到控制台了。` |
|       2 | 2016-08-12 10:47:49 | 来自北京的 Chrome 52.0-Windows 10 用户 | `这篇文章说了什么？`                                        |
|       3 | 2016-08-15 08:26:59 | 龙瑀璇 [Chrome 52.0-Windows 10]        | `Linux社区居然讨论这个问题，也是可以`                       |
|       4 | 2016-10-27 21:41:45 | linccn [Safari 10.0-Mac 10.12]         | `真的有很多人推荐nano`                                      |
