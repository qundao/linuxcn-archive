...
date_updated: 2016-08-16 09:33:00
slug: article-7685-1.html
url: https://linux.cn/article-7685-1.html
url_from: https://ruslanspivak.com/lsbaws-part2/
image: album/201608/15/225543dvfgvgu5i21s5s3y.jpg
tags:
  - python
  - web
  - 服务器
...
在[第一部分](https://linux.cn/article-7662-1.html)中，我提出了一个问题：“如何在你刚刚搭建起来的 Web 服务器上适配 Django, Flask 或 Pyramid 应用，而不用单独对 Web 服务器做做出改动以适应各种不同的 Web 框架呢？”我们可以从这一篇中找到答案。
...
|   index | 日期                | 日期                                     | 评论                                                       |
|--------:|:--------------------|:-----------------------------------------|:-----------------------------------------------------------|
|       0 | 2016-08-16 11:07:34 | hello_linux [Chrome 46.0-Windows 7]      | `这配图很不错。。。。`                                     |
|       1 | 2016-08-18 02:33:57 | 来自陕西西安的 Safari 9.1-Mac 10.11 用户 | `和这个类似主题的教程看过不少了，这算是其中很直观的一篇。` |
|       2 | 2016-08-26 01:28:51 | GNU [Baidu Spark 7.6-Windows 8]          | `受益匪浅`                                                 |
