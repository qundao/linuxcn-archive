...
date_updated: 2016-08-21 18:20:00
slug: article-7704-1.html
url: https://linux.cn/article-7704-1.html
url_from: http://www.tecmint.com/best-linux-ide-editors-source-code-editors/
image: album/201608/21/182045h07rbfmoak77kz8y.png
tags:
  - c++
  - idc
  - 编辑器
...
|   index | 日期                | 日期                                      | 评论                                                                                                                     |
|--------:|:--------------------|:------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------|
|       0 | 2016-08-21 18:47:27 | 绿色圣光 [Firefox 45.0-GNU/Linux]         | `总少不了 Emacs 和 Vim`                                                                                                  |
|       1 | 2016-08-21 19:45:55 | hello_linux [Chrome 46.0-Windows 7]       | `收藏一下！！！<br /> 就是那么懂你！`                                                                                    |
|       2 | 2016-08-21 20:27:16 | fxbszj [Firefox 48.0-Windows 10]          | `emacs配evil，我最常用。<br /> 但是如果是ide，我还是选Qt Creator`                                                        |
|       3 | 2016-08-21 20:27:49 | WangYueScream [Chrome 48.0-Windows 7]     | `没有 5`                                                                                                                 |
|       4 | 2016-08-21 22:58:28 | linux [Chrome 52.0-Mac 10.11]             | `哈哈哈，原文脑抽了。。`                                                                                                 |
|       5 | 2016-08-21 22:58:52 | linux [Chrome 52.0-Mac 10.11]             | `压箱底的~`                                                                                                              |
|       6 | 2016-08-22 09:30:10 | koolar [Chrome 52.0-Windows 10]           | `C/C++语言有点过时，新人还是专项golang、C#、Python、Swift等现代语言较好。`                                               |
|       7 | 2016-08-22 09:46:58 | 来自广东深圳的 Chrome 51.0-GNU/Linux 用户 | `瞎扯, 嵌入式/PC等只要往底层走,哪个离得开C/C++.你所谓的那些语言大部分都是运行在C写的东西基础上的.`                       |
|       8 | 2016-08-22 10:56:45 | fxbszj [Firefox 48.0-Windows 10]          | `我只能说，现在考虑开发效率的情况下，很多企业有些地方不选择C/C++开发，特别是现在的互联网行业。但是唱衰C/C++还是为时尚早` |
|       9 | 2016-08-22 16:31:06 | 来自贵州毕节的 Chrome 53.0-GNU/Linux 用户 | `17个？`                                                                                                                 |
|      10 | 2016-08-22 19:09:11 | 来自广东广州的 Firefox 48.0-Ubuntu 用户   | `这么多年用下来 还是eclipse+CDT最好用`                                                                                   |
|      11 | 2016-08-23 13:34:17 | 来自北京的 Firefox 47.0-Windows 10 用户   | `两页`                                                                                                                   |
|      12 | 2016-08-23 21:28:01 | 来自江苏徐州的 Chrome 52.0-GNU/Linux 用户 | `clion`                                                                                                                  |
|      13 | 2016-08-26 22:52:05 | 来自广东深圳的 Chromium 51.0-Ubuntu 用户  | `收藏一下！`                                                                                                             |
|      14 | 2016-08-27 09:45:06 | 来自北京的 Chrome 50.0-Windows 7 用户     | `qtcreator 不是收费的，不要瞎说`                                                                                         |
|      15 | 2016-10-24 08:22:40 | linccn [Firefox 49.0-Windows 7]           | `真正好用的只有两个qtcreator和code:blocks,其他都很难用。`                                                                |
|      16 | 2023-10-21 08:18:35 | 来自江西的 Firefox 118.0-GNU/Linux 用户   | `你说的这些都只是某一方面，在实际开发时c/c++用的还是比较多的`                                                            |
