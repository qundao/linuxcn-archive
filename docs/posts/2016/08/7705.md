...
date_updated: 2016-08-22 09:55:32
slug: article-7705-1.html
url: https://linux.cn/article-7705-1.html
url_from: http://www.tecmint.com/automating-linux-system-administration-tasks/
image: album/201608/22/095534qd5ykcxcnc6ggcnr.jpg
tags:
  - fabric
  - ssh
  - 自动化
...
如果是基于 RHEL/CentOS 的发行版本的系统，你可以使用系统自带的 [EPEL 源](https://linux.cn/article-2324-1.html) 来安装 fabric。
...
|   index | 日期                | 日期                                      | 评论                                                                                                         |
|--------:|:--------------------|:------------------------------------------|:-------------------------------------------------------------------------------------------------------------|
|       0 | 2016-08-23 11:01:56 | chenjintao_ii [Firefox 48.0-Windows 7]    | `配合 pexpect，连密码都不用输。<br /> 问题是怎么配合？:D`                                                    |
|       1 | 2016-08-23 14:05:11 | 来自江苏南京的 Chrome 52.0-Windows 7 用户 | `我使用 fab disk_space --user=root，提示输入密码时，输入的密码是正确的，但一直会提示输入密码。系统是 ubuntu` |
