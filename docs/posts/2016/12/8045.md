...
date_updated: 2016-12-19 09:19:23
slug: article-8045-1.html
url: https://linux.cn/article-8045-1.html
url_from: http://www.tecmint.com/check-syntax-in-shell-script/
image: album/201612/19/091411hx24y6u67y7xv258.jpg
tags:
  - 脚本
  - 调试
categories:
...
我们开启了 Shell 脚本调试系列文章，先是解释了不同的调试选项，下面介绍[如何启用 Shell 调试模式](https://linux.cn/article-8028-1.html)。

写完脚本后，建议在运行脚本之前先检查脚本中的语法，而不是查看它们的输出以确认它们是否正常工作。

在本系列的这一部分，我们将了解如何使用语法检查调试模式。记住我们之前在本系列的[第一部分](https://linux.cn/article-8028-1.html)中解释了不同的调试选项，在这里，我们将使用它们来执行脚本调试。
...
要展示这个如何工作，下面是一个示例脚本来[批量将 PNG 图片转换成 JPG 格式](https://linux.cn/article-8014-1.html)。
