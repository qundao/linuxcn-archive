...
date_updated: 2016-12-08 09:53:00
slug: article-8023-1.html
url: https://linux.cn/article-8023-1.html
url_from: http://www.tecmint.com/fedora-25-installation-guide/
image: album/201612/07/210434pbzllsrlllscrlli.jpg
tags:
  - fedora
categories:
  - 技术
...
|   index | 日期                | 日期                                                       | 评论                                                                                                                                                                                                                          |
|--------:|:--------------------|:-----------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2016-12-08 21:27:00 | OneNewLife [Chrome 55.0-Fedora]                            | `终于支持 node 6.9.1 了。`                                                                                                                                                                                                    |
|       1 | 2016-12-08 22:21:22 | jun413947139 [Microsoft Edge 15.14971-Windows 10]          | `很不错的入门文章，文章调理清晰，linuxcn看布局 就很舒服`                                                                                                                                                                      |
|       2 | 2016-12-09 19:48:36 | linux [Chrome 54.0-Mac 10.11]                              | `谢谢——可惜我现在对布局的调整优化已经力不从心了——大哭。`                                                                                                                                                                      |
|       3 | 2016-12-10 09:40:16 | lovetoheart [Chrome 45.0-Windows 10]                       | `在我的笔记本上用不了这个系统，fedora24版倒还正常，一更新后也当掉了，最直接的反应就是启动黑屏`                                                                                                                                |
|       4 | 2016-12-10 22:21:19 | 来自陕西的 Chrome Mobile 55.0-Android 6.0 用户             | `等它提供全组件iso镜像了，我就换回来，现在觉得Debian Gnu/Linux的全镜像发布方式就是好一点点，很多时候没有镜像做本地源眼睛干瞪起没办法，网络没有谣传的那么稳定和高速，最关键是着急用你还得搜索和查找，这也是需要大量时间成本的` |
|       5 | 2016-12-12 15:50:21 | 来自亚太地区的 Chrome 54.0-Windows 7 用户                  | `win7下无法选择标准分区，创建分区一直失败。这个是怎么回事儿？`                                                                                                                                                                |
|       6 | 2016-12-14 19:08:48 | 来自117.152.71.253的 Chrome 55.0-GNU/Linux 用户            | `fedora这种比较更新快的系统提供这些都没用，更新了之后马上依赖不满足（arch更极端），当然也不排除有例外，如有打过大部分包的openSUSE风滚草`                                                                                      |
|       7 | 2017-05-15 00:22:52 | 来自新疆的 MIUI Browser 8.8-GNU/Linux 用户                 | `2G内存试了下，又换成f22了，能用就没再折腾，不过最近第一次开机有点卡了，想着要不要换个版本`                                                                                                                                   |
|       8 | 2017-07-03 16:28:44 | 来自湖北武汉华中科技大学的 Sogou Explorer 2-Windows 7 用户 | `请问一下这样安装会不会覆盖原来的win7系统？`                                                                                                                                                                                  |
