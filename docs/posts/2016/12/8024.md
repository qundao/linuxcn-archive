...
date_updated: 2016-12-09 08:53:00
slug: article-8024-1.html
url: https://linux.cn/article-8024-1.html
url_from: http://www.tecmint.com/empty-delete-file-content-linux/
image: album/201612/08/195853w24pcumpmsb4ccm4.jpg
tags:
  - 文件
  - 清空
categories:
...
|   index | 日期                | 日期                                              | 评论                                                                                                               |
|--------:|:--------------------|:--------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------|
|       0 | 2016-12-09 09:32:32 | 来自广东深圳的 Chrome 54.0-GNU/Linux 用户         | `直接rm不久好了， 搞这么麻烦`                                                                                      |
|       1 | 2016-12-09 09:53:23 | 来自四川成都四川大学的 Chrome 55.0-GNU/Linux 用户 | `要清空文件内容，rm 应该就不行了。`                                                                                |
|       2 | 2016-12-09 19:45:48 | linux [Chrome 54.0-Mac 10.11]                     | `然后你还需要一个&nbsp;&nbsp;touch`                                                                                |
|       3 | 2016-12-09 19:47:57 | linux [Chrome 54.0-Mac 10.11]                     | `然后，文件呢？其实，这里就像是研究茴香豆的茴有几种写法一样，给大家一些有益的提示，每个人都可以有自己喜欢的用法。` |
|       4 | 2016-12-10 08:38:02 | 来自浙江杭州的 Firefox 50.0-Fedora 用户           | `学习了.`                                                                                                          |
|       5 | 2016-12-10 09:42:24 | 来自广东河源的 Chrome 53.0-Windows 10 用户        | `一般都只用“&gt; access.log”这个，，比较简单，易记`                                                                |
|       6 | 2016-12-10 11:55:24 | 来自117.152.68.72的 Chrome 54.0-Windows 10 用户   | `rm file &amp;&amp; touch file`                                                                                    |
|       7 | 2016-12-11 20:55:29 | Wf_talk [Firefox 49.0-GNU/Linux]                  | `没想到会有这么多个方法清空文件`                                                                                   |
|       8 | 2016-12-13 13:16:53 | 来自湖北武汉的 Firefox 50.0-Windows 10 用户       | `说rm和touch的一看就是没有做过实际的运维。`                                                                        |
|       9 | 2016-12-14 11:37:45 | 来自北京的 Chrome 50.0-Windows 10 用户            | `感觉原理好像都是 &gt; filename`                                                                                   |
|      10 | 2016-12-14 12:51:05 | 来自甘肃白银的 Sogou Explorer 2-Windows 7 用户    | `echo &quot;&quot; &gt; access.log比较好用`                                                                        |
|      11 | 2016-12-16 20:47:51 | 测试 [Firefox 52.0-Windows 10]                    | `unzip, strip, touch, grep, finger, mount, fsck, more, yes, fsck, fsck, fsck, top, free, umount, sleep`            |
|      12 | 2016-12-23 10:19:07 | wst021 [Chrome 55.0-Windows 8.1]                  | `非常赞的精品好文`                                                                                                 |
|      13 | 2019-03-07 12:03:01 | 来自北京的 Chrome 72.0-Windows 10 用户            | `考虑IO的&nbsp;&nbsp;蠢货`                                                                                         |
|      14 | 2019-03-07 12:03:06 | 来自北京的 Chrome 72.0-Windows 10 用户            | `考虑IO的&nbsp;&nbsp;蠢货`                                                                                         |
|      15 | 2019-03-07 12:03:11 | 来自北京的 Chrome 72.0-Windows 10 用户            | `考虑IO的&nbsp;&nbsp;蠢货`                                                                                         |
|      16 | 2019-03-07 12:03:12 | 来自北京的 Chrome 72.0-Windows 10 用户            | `考虑IO的&nbsp;&nbsp;蠢货`                                                                                         |
|      17 | 2020-06-30 13:48:59 | 来自49.7.58.115的 Chrome 83.0-Windows 10 用户     | `？？？？`                                                                                                         |
|      18 | 2020-07-30 10:06:38 | 来自广东广州的 Firefox 78.0-Windows 10 用户       | `赶紧跑路了&nbsp;&nbsp;哈哈`                                                                                       |
|      19 | 2020-11-06 18:27:22 | 来自北京的 Safari 13.1-Mac 10.15 用户             | `对于一个大文件，你可以试试两种的差别，不知道就不要乱说`                                                           |
|      20 | 2023-02-23 17:17:30 | 来自香港的 Chrome 109.0-Mac 10.15 用户            | `不错的，学习了`                                                                                                   |
|      21 | 2023-02-23 17:17:33 | 来自香港的 Chrome 109.0-Mac 10.15 用户            | `不错的，学习了`                                                                                                   |
|      22 | 2023-03-02 17:31:14 | 来自101.198.192.11的 Chrome 109.0-Windows 10 用户 | `刘先祺到此一游，写的真好`                                                                                         |
|      23 | 2023-03-02 17:31:17 | 来自101.198.192.11的 Chrome 109.0-Windows 10 用户 | `刘先祺到此一游，写的真好`                                                                                         |
