...
date_updated: 2016-12-28 17:01:00
slug: article-8071-1.html
url: https://linux.cn/article-8071-1.html
url_from: https://www.linux.com/learn/how-build-email-server-ubuntu-linux
image: album/201612/28/170142s5225bb70hfc0f9c.jpg
tags:
  - postfix
  - ubuntu
  - 邮件
...
[下一篇教程](https://linux.cn/article-8077-1.html)我们会讲解 Dovecot 的安装和测试，然后会给我们自己发送一些邮件。
...
|   index | 日期                | 日期                                         | 评论                                                                            |
|--------:|:--------------------|:---------------------------------------------|:--------------------------------------------------------------------------------|
|       0 | 2016-12-28 20:16:25 | 来自广东佛山的 Firefox 42.0-Windows 7 用户   | `非常好！期待下一篇！`                                                          |
|       1 | 2016-12-28 22:38:49 | 来自广东广州的 Chrome 55.0-Windows 7 用户    | `要是早几个月发就好了，两个月前做计算机网络的实验，就是用Linux搭建邮件服务器。` |
|       2 | 2017-01-03 17:32:39 | 来自广东深圳的 QQ Browser 9.5-Windows 7 用户 | `看不懂啊！！`                                                                  |
