...
date_updated: 2016-12-05 09:46:00
slug: article-8014-1.html
url: https://linux.cn/article-8014-1.html
url_from: http://www.tecmint.com/linux-image-conversion-tools/
image: album/201612/04/235739n64z4407mwwcc4yc.jpg
tags:
  - convert
  - mogrify
  - 图片转换
...
|   index | 日期                | 日期                                            | 评论                                                                                         |
|--------:|:--------------------|:------------------------------------------------|:---------------------------------------------------------------------------------------------|
|       0 | 2016-12-05 15:55:27 | 来自陕西宝鸡的 Firefox 50.0-GNU/Linux 用户      | `…………我来介绍一种简单的…………<br /> 用gimp》》》》》》`                                        |
|       1 | 2016-12-06 09:42:46 | 来自浙江的 Chromium 53.0-Ubuntu 用户            | `按照作者逻辑我再添加若干种方法完成转换，用PHP, python,c,c++,java等各种语言写个批量处理都算` |
|       2 | 2016-12-06 13:57:36 | 来自117.152.70.58的 Chrome 54.0-Windows 10 用户 | `如果在网站后台弄这个，人家用批处理，你用GUI<br /> TOO YOUNG`                                |
|       3 | 2016-12-06 21:42:58 | 绿色圣光 [Firefox 45.0-GNU/Linux]               | `说白了，就是用 ImageMagick 啊`                                                              |
