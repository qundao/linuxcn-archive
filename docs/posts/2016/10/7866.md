...
date_updated: 2016-10-16 08:26:00
slug: article-7866-1.html
url: https://linux.cn/article-7866-1.html
url_from: http://www.2daygeek.com/how-to-install-antergos-linux/
image: album/201610/15/222952tckavv922kevp4e8.jpg
tags:
  - antergos
  - arch linux
categories:
...
> 现在就让我来为你展示如何安装 Antergos，这个基于 Arch 的、给新手的最好发行版，要尝试 Arch 的用户可以试一试，我保证绝对值得一试。
...
|   index | 日期                | 日期                                                    | 评论                                                                                                                                                                                                                                                                                                                                     |
|--------:|:--------------------|:--------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2016-10-16 10:59:01 | 来自北京的 Chrome Mobile 43.0-Android 5.0 用户          | `看着不错啊`                                                                                                                                                                                                                                                                                                                             |
|       1 | 2016-10-16 11:01:23 | 龙尘飘 [Chrome 55.0-Windows 10]                         | `所以，<br /> 他和arch相比的优点是什么`                                                                                                                                                                                                                                                                                                  |
|       2 | 2016-10-16 11:09:22 | 来自广东广州的 Firefox 45.0-GNU/Linux 用户              | `这个系统用完之后你会感觉还不如直接装arch好`                                                                                                                                                                                                                                                                                             |
|       3 | 2016-10-16 11:39:01 | 来自上海的 Firefox 49.0-Mac 10.12 用户                  | `开篇就说明了是给新手用的，并不是每个人都会安装和配置Arch`                                                                                                                                                                                                                                                                               |
|       4 | 2016-10-16 14:20:02 | 来自山东青岛的 Firefox 49.0-Windows 10 用户             | `archwiki 现在是不打算对新人友好了吗`                                                                                                                                                                                                                                                                                                    |
|       5 | 2016-10-16 18:36:52 | GHLandy [Chrome 54.0-Windows 10]                        | `虽然没有尝试过这个发行版，但根据这篇文章来看，可能是安装过程更加简便一些。但说真的，刚刚开始尝试要用 Archlinux 的时候，的确安装不成功。后来细细的解读了 archwiki 中的每一步安装细节之后，才成功安装 Archlinux。对于定制要求较高的用户，尝试过 Archlinux 之后应该都会着迷。我个人感觉这是一个“完全源码定制”和“完全傻瓜式”的一个平衡点。` |
|       6 | 2016-10-16 18:53:16 | Wf_talk [Vivaldi 1.2-GNU/Linux]                         | `这系统顶执行不如arch吧?很多应用已经集成进去了`                                                                                                                                                                                                                                                                                          |
|       7 | 2016-10-17 08:30:49 | koolar [Chrome 45.0-Windows 10]                         | `字体特别丑，中文和英文都是。`                                                                                                                                                                                                                                                                                                           |
|       8 | 2016-10-18 03:09:16 | 来自湖南长沙的 QQ Browser 9.4-Windows 7 用户            | `这个shell主题不错，可以单独下载吗？`                                                                                                                                                                                                                                                                                                    |
|       9 | 2016-11-06 11:07:52 | 来自山东济南的 Chrome 53.0-Windows 10 用户              | `manjaro不服`                                                                                                                                                                                                                                                                                                                            |
|      10 | 2016-11-06 12:16:16 | baby-blue__ [Chrome 54.0-Arch Linux]                    | `不错,挺漂亮`                                                                                                                                                                                                                                                                                                                            |
|      11 | 2016-12-11 00:37:10 | 来自四川成都成都信息工程学院的 Firefox 50.0-Ubuntu 用户 | `玄学的发行版。。。。开机莫名logo一闪就黑屏，而且是有可能启动，也有可能启动不了`                                                                                                                                                                                                                                                         |
