...
date_updated: 2016-01-25 17:40:00
slug: article-6931-1.html
url: https://linux.cn/article-6931-1.html
url_from: http://www.toptal.com/nodejs/nodeos-the-javascript-based-operating-system
image: album/201601/25/174057ew38q31r82y9yk2c.jpg
tags:
  - javascript
  - node.js
  - nodeos
...
|   index | 日期                | 日期                                       | 评论                                                                                                                                           |
|--------:|:--------------------|:-------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2016-01-25 20:37:00 | fanbt [Firefox 43.0-Fedora]                | `这也能叫操作系统？你待么逗我？？？顶多顶多算得上Linux下的一款应用罢了……`                                                                      |
|       1 | 2016-01-25 21:36:34 | 来自福建泉州的 Sina Weibo 5.7-iOS 9.2 用户 | `这和现在直接在Linux上运行nodejs有什么区别？`                                                                                                  |
|       2 | 2016-01-26 14:50:20 | 来自山西晋中的 Chrome 39.0-Windows XP 用户 | `这个教程写得好，如果高校教材或编程的书都写成这样，天朝编程人才怎么的也能比现在多十个以的数量级，比起我朝上国，世界顶级大牛还是阿三哥籍的多啊` |
|       3 | 2016-01-26 22:27:51 | 哲学传播者 [Chrome 47.0-GNU/Linux]         | `这和直接运行node.js或是python没什么区别。`                                                                                                    |
|       4 | 2016-02-02 10:19:33 | 来自浙江杭州的 Firefox 44.0-Ubuntu 用户    | `如果说这个是大财，那么Firefox OS还不飞天上去了`                                                                                               |
|       5 | 2016-02-02 10:48:26 | 来自福建莆田的 Firefox 44.0-GNU/Linux 用户 | `ffmpeg（libav）的作者不是已经把linux内核移植到js平台了吗？那才算真正的基于Javascript的系统吧。`                                               |
|       6 | 2016-02-03 08:51:59 | 来自四川成都的 Chrome 48.0-GNU/Linux 用户  | `居然有 4 个赞，那个其实把模拟器或虚拟机的代码转译为 Javascript，最近那个在浏览器运行 Windows 95 的原理也是这样。`                             |
|       7 | 2016-02-03 15:39:59 | 来自福建的 Firefox 44.0-GNU/Linux 用户     | `仔细一看，确实是我注意看，抱歉。项目名称是jslinux，但全名是Javascript PC Emulator，即仍是虚拟机。`                                            |
