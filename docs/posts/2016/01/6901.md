...
date_updated: 2016-01-18 07:08:00
slug: article-6901-1.html
url: https://linux.cn/article-6901-1.html
url_from: http://www.ehowstuff.com/ssh-login-without-password-centos/
image: album/201601/17/210924tcfprpye35p3ascf.jpg
tags:
  - openssh
  - ssh
categories:
...
|   index | 日期                | 日期                                      | 评论                                                                                                                                           |
|--------:|:--------------------|:------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2016-01-18 08:51:08 | 来自四川成都的 Chrome 47.0-GNU/Linux 用户 | `需要对 .ssh 目录的权限进行设置, 以及 SELinux 权限<br /> <br /> chown go-rwx ~/.ssh<br /> restorecon -R ~/.ssh`                                |
|       1 | 2016-01-18 09:55:19 | linux [Chrome 47.0-Mac 10.11]             | `ssh-copy-id 这个命令会做相关的权限修改。但是如果手工复制 key 到远程服务器，有可能 .ssh 目录权限不对，是需要这样修正的。`                      |
|       2 | 2016-01-20 09:08:52 | 来自天津的 Vivaldi 1.0-GNU/Linux 用户     | `不知道安全不？`                                                                                                                               |
|       3 | 2016-01-20 21:05:26 | linux [Chrome 47.0-Mac 10.11]             | `相对来说，是最安全的方法了——但是再安全的方式也架不住规则漏洞——你要是非用一个公开的电脑，安装一堆你也不知道是什么的软件，还把私钥放里面。。。` |
|       4 | 2016-02-18 08:55:02 | zhengbin1030 [Opera 35.0-Windows 10]      | `学习一下，这个对自动化运维很有帮助的`                                                                                                         |
|       5 | 2016-12-05 16:24:49 | 来自美国的 Firefox 50.0-GNU/Linux 用户    | `建议将题目的centos/RhEL改成linux。方便大家搜索到。`                                                                                           |
