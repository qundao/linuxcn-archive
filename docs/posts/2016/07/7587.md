...
date_updated: 2016-07-19 09:26:00
slug: article-7587-1.html
url: https://linux.cn/article-7587-1.html
url_from: http://www.tecmint.com/awk-print-fields-columns-with-space-separator/
image: album/201607/17/232949rptp6m4mk744jzpp.png
tags:
  - awk
categories:
  - 技术
...
|   index | 日期                | 日期                                      | 评论                                                                                                              |
|--------:|:--------------------|:------------------------------------------|:------------------------------------------------------------------------------------------------------------------|
|       0 | 2016-07-19 10:27:13 | 来自陕西西安的 Chrome 51.0-GNU/Linux 用户 | `提个建议,代码框能否改成等款字体? 代码对不齐看起来很别扭.`                                                        |
|       1 | 2016-07-19 21:43:10 | linux [Chrome 50.0-Mac 10.11]             | `代码框必须是等宽字体啊，难道说你那边显示不是等宽？`                                                              |
|       2 | 2016-07-20 10:13:17 | 来自陕西西安的 Chrome 51.0-GNU/Linux 用户 | `果然是我自己的问题......<br /> 前段时间把droid卸了,改成source code,忘了同步改chrome的默认字体,直接回落到非等宽.` |
