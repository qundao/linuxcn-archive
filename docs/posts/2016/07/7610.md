...
date_updated: 2016-07-25 10:28:00
slug: article-7610-1.html
url: https://linux.cn/article-7610-1.html
url_from: http://www.tecmint.com/read-awk-input-from-stdin-in-linux/
image: album/201607/24/184000y6jicireooc03x05.png
tags:
  - awk
categories:
  - 技术
...
再来看另一个例子，我们[使用 awk 表达式](https://linux.cn/article-7599-1.html) ，在这里，我们想要在 awk 命令里使用一个表达式筛选出字符串来打印出属于 root 用户的文件。命令如下：
...
让我们再看另一个例子，我们使用一个 [awk 比较运算符](https://linux.cn/article-7602-1.html) 来匹配一个确定的字符串。
...
|   index | 日期                | 日期                                      | 评论                             |
|--------:|:--------------------|:------------------------------------------|:---------------------------------|
|       0 | 2016-07-27 19:59:15 | 来自浙江杭州的 Chrome 51.0-Windows 7 用户 | `下一节还没出来呢，期待中`       |
|       1 | 2016-07-27 20:00:19 | hadesLiu [Chrome 51.0-Windows 7]          | `看了前面几节，觉得基础好重要啊` |
|       2 | 2016-07-27 22:04:24 | linux [Chrome 52.0-Mac 10.11]             | `没有了。。`                     |
