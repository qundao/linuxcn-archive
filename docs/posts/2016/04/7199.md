...
date_updated: 2016-04-07 10:27:00
slug: article-7199-1.html
url: https://linux.cn/article-7199-1.html
url_from: https://fedoramagazine.org/take-screenshots-on-fedora/
image: album/201604/06/145207bdsiy2s82c23mrii.png
tags:
  - 截屏
categories:
  - 桌面应用
...
> Fedora 工作站附带了一个虽然简单，然而做截图却足够的工具。允许用户快速地对桌面、特定的窗口、或屏幕的任意部分进行截图。
