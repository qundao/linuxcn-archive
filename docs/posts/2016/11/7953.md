...
|       1 | 2016-11-15 04:13:48 | 来自香港的 Firefox 50.0-GNU/Linux 用户    | `dpkg -l - grep linux-image<br /> 先列出所有已安裝packages然後再用grep擷取關鍵詞<br /> <br /> gdebi path-to-.deb-file<br /> 命令列安裝.deb檔案<br /> <br /> gdebi-gtk path-to-.deb-file<br /> GUI安裝.deb檔案` |
