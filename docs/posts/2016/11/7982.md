...
date_updated: 2016-11-24 10:18:00
slug: article-7982-1.html
url: https://linux.cn/article-7982-1.html
url_from: http://www.2daygeek.com/aria2-command-line-download-utility-tool/
image: album/201611/23/222806ck6kn26h2j96ck96.jpg
tags:
  - aria2
  - wget
categories:
...
|   index | 日期                | 日期                                       | 评论                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
|--------:|:--------------------|:-------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2016-11-24 12:00:31 | 来自云南昆明的 Firefox 50.0-Windows 7 用户 | `好东西`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
|       1 | 2016-11-24 12:45:22 | LXY-WL [Epiphany 3.18-GNU/Linux]           | `zhangzonghui@zhangzonghui-F83VD:~$ sudo dpkg -i /home/zhangzonghui/下载/deepin-boot-maker_1.1.3-1_i386.deb<br /> 正在选中未选择的软件包 deepin-boot-maker:i386。<br /> (正在读取数据库 ... 系统当前共安装有 235665 个文件和目录。)<br /> 正准备解包 .../deepin-boot-maker_1.1.3-1_i386.deb&nbsp;&nbsp;...<br /> 正在解包 deepin-boot-maker:i386 (1.1.3-1) ...<br /> dpkg: 依赖关系问题使得 deepin-boot-maker:i386 的配置工作不能继续：<br /> deepin-boot-maker:i386 依赖于 p7zip-full.<br /> deepin-boot-maker:i386 依赖于 mtools.<br /> deepin-boot-maker:i386 依赖于 syslinux.<br /> deepin-boot-maker:i386 依赖于 syslinux-common.<br /> <br /> dpkg: 处理软件包 deepin-boot-maker:i386 (--install)时出错：<br /> 依赖关系问题 - 仍未被配置<br /> 正在处理用于 bamfdaemon (0.5.3~bzr0+16.04.20160824-0ubuntu1) 的触发器 ...<br /> Rebuilding /usr/share/applications/bamf-2.index...<br /> 正在处理用于 gnome-menus (3.13.3-6ubuntu3.1) 的触发器 ...<br /> 正在处理用于 desktop-file-utils (0.22-1ubuntu5+elementary2~ubuntu0.4.1) 的触发器 ...<br /> 正在处理用于 mime-support (3.59ubuntu1) 的触发器 ...<br /> 在处理时有错误发生：<br /> deepin-boot-maker:i386<br /> zhen&nbsp;&nbsp;mo&nbsp;&nbsp;jie&nbsp;&nbsp;jue` |
|       2 | 2016-11-24 13:20:19 | hello_linux [Chrome 51.0-Windows 7]        | `不错。`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
|       3 | 2016-11-24 21:34:42 | 绿色圣光 [Firefox 45.0-GNU/Linux]          | `根据深度官方的文档，需要你下载源码，自己编译。`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
|       4 | 2016-11-25 15:26:16 | 来自四川成都的 Chrome 54.0-GNU/Linux 用户  | `但是 aria2c 貌似没有 wget 的 --https-only 选项，用这个下载软件包虽然速度快，我担心会被降级 http，所以宁愿慢些，也用 wget 下载。`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
|       5 | 2016-11-30 13:53:13 | 何亮 [Chrome 54.0-Windows 7]               | `好东西，等回家下两个种子试试，留下一个邪恶的表情。`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
