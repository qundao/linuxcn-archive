...
|   index | 日期                | 日期                                            | 评论                                                                                                                      |
|--------:|:--------------------|:------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------|
|       0 | 2023-04-12 18:19:36 | 来自辽宁鞍山的 Chrome 78.0-GNU/Linux 用户       | `CodeNewRoman Nerd Font Mono <br /> <br /> terminus bold`                                                                 |
|       1 | 2023-04-13 01:49:48 | 来自江苏无锡的 Firefox 109.0-Ubuntu 用户        | `等宽字体也有问题。<br /> <br /> 如果中英文混排，有些字体并不严格遵循1个汉字等于两个英文字母宽度的规定。有些地方很头疼。` |
