...
date_updated: 2023-03-04 08:52:00
slug: article-15594-1.html
url: https://linux.cn/article-15594-1.html
url_from: https://itsfoss.com/linux-kernel-os/
image: album/202303/04/085224mw1qoq5kaukqzxmz.jpg
tags:
  - linux
  - 内核
categories:
...
|   index | 日期                | 日期                                                  | 评论                                                                                               |
|--------:|:--------------------|:------------------------------------------------------|:---------------------------------------------------------------------------------------------------|
|       0 | 2023-03-04 16:42:12 | 来自117.181.103.179的 Chrome 110.0-Windows 10 用户    | `怎么没有必要？<br /> 咱杠精就要用“Linux 只是一个内核，而不是一个操作系统”来纠正别人！`            |
|       1 | 2023-03-05 00:36:02 | 来自39.144.248.214的 Mobile Safari 16.3-iOS 16.3 用户 | `我就要用“Linux 只是一个内核，而不是一个操作系统”来纠正别人！书上也是这么写的。这么说本来就没错。` |
|       2 | 2023-03-05 05:41:05 | 来自江苏无锡的 Mobile Safari 14.0-iOS 14.0 用户       | `这是在准备重写一个兼容linux内核，以此避开GPL协议？`                                               |
|       3 | 2023-03-05 05:41:08 | 来自江苏无锡的 Mobile Safari 14.0-iOS 14.0 用户       | `这是在准备重写一个兼容linux内核，以此避开GPL协议？`                                               |
|       4 | 2023-03-09 23:23:03 | 来自北京的 Firefox 104.0-Windows 10 用户              | `Linux 只是一个内核，FreeBSD和Android才是完整操作系统`                                             |
