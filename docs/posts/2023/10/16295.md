...
date_updated: 2023-10-18 10:47:00
slug: article-16295-1.html
url: https://linux.cn/article-16295-1.html
url_from: https://itsfoss.com/gnome-minimize-button/
image: album/202310/18/104631i5gbbz3mwkfp5gmu.jpg
tags:
  - gnome
categories:
  - 桌面应用
...
|   index | 日期                | 日期                                               | 评论                                                                                                                                                                                                                                                  |
|--------:|:--------------------|:---------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2023-10-18 11:47:36 | 来自广东广州的 Chrome Mobile 118.0-Android 10 用户 | `「这种“无最小化按钮”的设计灵感来自苹果的 macOS。」<br /> 可是macOS的窗口有最大化和最小化按钮，不过最大化的行为与Windows不同，它会最大化占满一个单独的空间。在所有主流操作系统以及Linux的各种桌面中，似乎只有Gnome的窗口（默认情况下）只有关闭按钮。` |
|       1 | 2023-10-19 13:58:37 | 来自浙江杭州的 Chrome 118.0-Windows 10 用户        | `gnome在不让人用得舒服方面总是走得很领先，包括没有最小化最大化、托盘需要自己用插件……`                                                                                                                                                                 |
