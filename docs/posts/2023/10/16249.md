...
date_updated: 2023-10-03 00:19:00
slug: article-16249-1.html
url: https://linux.cn/article-16249-1.html
url_from: https://news.itsfoss.com/mozilla-firefox-progress/
image: album/202310/03/001913b1hfcfsl34ylcc6h.jpg
tags:
  - firefox
categories:
  - 观点
...
详细来说，你可以回顾一下 [Firefox 在 2021 年几乎损失了 5000 万用户](https://linux.cn/article-13642-1.html)。
...
|   index | 日期                | 日期                                               | 评论                                                                                                                                       |
|--------:|:--------------------|:---------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2023-10-03 08:54:16 | 来自广东广州的 Chrome Mobile 116.0-Android 10 用户 | `重度Google用户肯定会用Chrome而不是Firefox来访问Google服务，因为自家服务集成度更高，这不是用Firefox的理由。`                               |
|       1 | 2023-10-03 09:51:18 | 来自柬埔寨的 Chrome 117.0-GNU/Linux 用户           | `firefox 的 devtools 能换主题吗 ？<br /> 以前有试过一次 ，但是它的devtools 太不方便了`                                                     |
|       2 | 2023-10-03 10:26:47 | 来自广东广州的 Firefox 118.0-GNU/Linux 用户        | `firefox ux 一直有简洁大气的感觉，扩展功能也够用，没有更换的想法`                                                                          |
|       3 | 2023-10-04 11:23:49 | 来自浙江台州的 Firefox 78.0-GNU/Linux 用户         | `一直在用firefox，chromium用不习惯`                                                                                                        |
|       4 | 2023-10-05 14:17:12 | 来自江苏苏州的 Chrome 117.0-Windows 10 用户        | `只可惜linux下的firefox总是不能成功开启GPU加速，看B站4K8K时CPU都快冒烟了。。。。。windows下则自动就会开启。`                               |
|       5 | 2023-10-05 18:55:45 | 来自四川成都的 Chrome 117.0-GNU/Linux 用户         | `我是 firefox 可以, 但是 chrome/chromium 不行, Xe 核显.`                                                                                   |
|       6 | 2023-10-05 18:55:47 | 来自四川成都的 Chrome 117.0-GNU/Linux 用户         | `我是 firefox 可以, 但是 chrome/chromium 不行, Xe 核显.`                                                                                   |
|       7 | 2023-10-07 11:36:25 | 来自112.48.27.66的 Firefox 118.0-GNU/Linux 用户    | `重要的是现在很多插件只支持chromium系浏览器，包括很多三方插件网站默认下载.crx格式的，对Firefox的支持并不友好。Firefox还是应该增强宣传力度` |
|       8 | 2023-10-08 10:21:24 | 来自广西南宁的 Chrome 117.0-Windows 10 用户        | `就凭FF禁止中国用户安装广告屏蔽插件这一行为它就已经不再存在我的软件列表里了,哪怕它再好用。`                                                |
|       9 | 2023-10-09 16:11:30 | 来自广东韶关的 Firefox 119.0-GNU/Linux 用户        | `你要是有能力，可以给火狐翻案……`                                                                                                           |
|      10 | 2023-10-09 17:44:37 | 来自广东广州的 Chrome Mobile 116.0-Android 10 用户 | `这是因为输了官司，火狐真正的黑点是谋智版`                                                                                                 |
|      11 | 2023-10-29 23:18:17 | 来自四川成都的 Firefox 119.0-Windows 10 用户       | `这是因为中国广告商起诉了FF，又不是FF搞歧视`                                                                                               |
|      12 | 2023-11-27 01:37:23 | 来自福建三明的 Firefox 114.0-GNU/Linux 用户        | `zhuanlan.zhihu.&nbsp; &nbsp;com/p/484768591<br /> 其实github有uBlock的xpi<br /> github.&nbsp;&nbsp;com/gorhill/uBlock/`                   |
