...
date_updated: 2023-05-29 15:06:30
slug: article-15855-1.html
url: https://linux.cn/article-15855-1.html
url_from: https://itsfoss.com/rust-functions/
image: album/202305/29/150550h23qbhahwzb66hb1.jpg
tags:
  - rust
categories:
  - 软件开发
...
你可以把函数参数想象成一个传递给函数的 [元组](https://linux.cn/article-15837-1.html)。它可以接受多种数据类型的参数，而且你可以接受任意多个参数。所以，你不必局限于接受相同类型的参数。
