...
date_updated: 2023-01-25 21:18:00
slug: article-15480-1.html
url: https://linux.cn/article-15480-1.html
url_from: https://www.debugpoint.com/install-python-windows/
image: album/202301/25/211813u4mmhhffif58hmpu.jpg
tags:
  - python
categories:
  - 软件开发
...
在学习如何在 Windows 上安装 Python 之前，你可能想看看如何在 Linux 发行版（如 Ubuntu）上[轻松安装](https://linux.cn/article-15475-1.html) Python。如果你打算成为一名开发者，最好在 Linux 中尝试 Python。那么，你可能想看看 [如何在 Windows 之外安装 Linux（如 Ubuntu）](https://www.debugpoint.com/complete-guide-how-dual-boot-ubuntu-windows/)。
...
|   index | 日期                | 日期                                    | 评论                                        |
|--------:|:--------------------|:----------------------------------------|:--------------------------------------------|
|       0 | 2023-01-26 09:29:35 | 来自四川的 Chrome 109.0-Windows NT 用户 | `Linux CN，错误的<br /> Windows CN，正确的` |
