...
date_updated: 2019-07-11 00:09:51
slug: article-11083-1.html
url: https://linux.cn/article-11083-1.html
url_from: https://www.linuxtechi.com/debian-10-buster-installation-guide/
image: album/201907/11/000856swbwnfyknnbn3twk.jpg
tags:
  - debian
categories:
  - 桌面应用
...
|   index | 日期                | 日期                                           | 评论                                                                                                                                                                                                                                                      |
|--------:|:--------------------|:-----------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2019-07-11 12:48:18 | 来自美国的 Chrome Mobile 75.0-Android 用户     | `Good`                                                                                                                                                                                                                                                    |
|       1 | 2019-07-11 13:07:00 | 来自江西南昌的 Chrome 75.0-Windows 10 用户     | `如果是inetl+英伟达的笔记本实机安装教程就好了`                                                                                                                                                                                                            |
|       2 | 2019-07-11 13:07:04 | 来自江西南昌的 Chrome 75.0-Windows 10 用户     | `如果是inetl+英伟达的笔记本实机安装教程就好了`                                                                                                                                                                                                            |
|       3 | 2019-07-11 13:07:09 | 来自江西南昌的 Chrome 75.0-Windows 10 用户     | `如果是inetl+英伟达的笔记本实机安装教程就好了`                                                                                                                                                                                                            |
|       4 | 2019-07-11 16:52:17 | 来自河北的 Chrome Mobile 75.0-Android 用户     | `看桌面发现和Ubuntu好像`                                                                                                                                                                                                                                  |
|       5 | 2019-07-13 13:35:56 | 来自上海的 Chrome 75.0-Mac 10.14 用户          | `怎么说呢。Debian用的是原装的gnome。ubuntu以前的主要版本是自己开发的，后来也转到gnome，但ubuntu对gnome做了点改装。<br /> 所以，不是桌面跟ubuntu很像，是大家都用gnome，ubuntu进行了少许改装。`                                                             |
|       6 | 2019-07-16 15:02:36 | delrey [Mobile Safari 12.1-iOS 12.3]           | `Dh`                                                                                                                                                                                                                                                      |
|       7 | 2019-07-17 13:06:55 | delrey [Mobile Safari 12.1-iOS 12.3]           | `t n`                                                                                                                                                                                                                                                     |
|       8 | 2019-08-10 13:10:56 | 来自广东广州的 Chrome Mobile 63.0-Android 用户 | `这个系进去之后，桌面是空的，鼠标左键和右键都无法使用了，鼠标只能在任务栏可以使用，怎么才能使用桌面图标和鼠标`                                                                                                                                            |
|       9 | 2019-08-10 13:11:00 | 来自广东广州的 Chrome Mobile 63.0-Android 用户 | `这个系进去之后，桌面是空的，鼠标左键和右键都无法使用了，鼠标只能在任务栏可以使用，怎么才能使用桌面图标和鼠标`                                                                                                                                            |
|      10 | 2019-11-22 19:02:57 | 来自黑龙江的 Chrome 78.0-GNU/Linux 用户        | `在使用pxe一类的远程安装时，是否有方法实现远程控制。就是远程操作安装过程。opensuse可以实现ssh或vnc方式运行yast.ssh以实现另一台电脑操作安装过程。rehl和centos可以实现vnc方式远程控制安装过程，debian查过它官网，也有个ssh方式，但是不能实现图形方式操作。` |
|      11 | 2020-03-03 08:56:02 | 来自广东中山的 Chrome 80.0-Windows 7 用户      | `……这位兄弟的回复亮瞎我了……看来需要补很多很多的基础知识……`                                                                                                                                                                                                |
|      12 | 2021-04-18 08:02:18 | 来自江西赣州的 Chrome 89.0-Windows 10 用户     | `两年过去了，这位的intel笔记本实装好了吗？看来您是希望楼主给您手把手安装吧？`                                                                                                                                                                             |
