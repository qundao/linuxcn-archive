...
date_updated: 2019-07-04 13:38:00
slug: article-11056-1.html
url: https://linux.cn/article-11056-1.html
url_from: https://opensource.com/article/19/6/understanding-linux-permissions
image: album/201907/04/133751argz0pp7hy5gvv7q.jpg
tags:
  - 权限
categories:
  - 技术
...
|   index | 日期                | 日期                                              | 评论                                                                                                                                |
|--------:|:--------------------|:--------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2019-07-04 13:42:42 | 来自山东临沂的 Chrome 77.0-Windows 10 用户        | `速度好快！`                                                                                                                        |
|       1 | 2019-07-04 17:10:32 | robin [Chrome 77.0-Mac 10.12]                     | `学习了`                                                                                                                            |
|       2 | 2019-07-04 18:11:27 | az3901077 [Firefox 67.0-Windows 10]               | `复习了，基础的linux知识！`                                                                                                         |
|       3 | 2019-07-05 09:57:53 | 来自湖北武汉的 Chromium 74.0-Ubuntu 用户          | `中间一个图里面错了，不是owner，而是others<br /> 权限还有sticky bit，还有setuid，setgid`                                            |
|       4 | 2019-07-05 09:57:58 | 来自湖北武汉的 Chromium 74.0-Ubuntu 用户          | `中间一个图里面错了，不是owner，而是others<br /> 权限还有sticky bit，还有setuid，setgid`                                            |
|       5 | 2019-07-05 09:57:59 | 来自湖北武汉的 Chromium 74.0-Ubuntu 用户          | `中间一个图里面错了，不是owner，而是others<br /> 权限还有sticky bit，还有setuid，setgid`                                            |
|       6 | 2019-07-05 09:58:00 | 来自湖北武汉的 Chromium 74.0-Ubuntu 用户          | `中间一个图里面错了，不是owner，而是others<br /> 权限还有sticky bit，还有setuid，setgid`                                            |
|       7 | 2019-07-05 09:59:43 | 来自湖北武汉的 Chromium 74.0-Ubuntu 用户          | `中间一个图里面错了，不是owner，而是others<br /> 权限还有sticky bit，setuid，setgid<br /> 文件类型还有block file，socket, link等等` |
|       8 | 2019-07-05 10:05:50 | 来自上海的 Chrome 75.0-Windows 10 用户            | `750 rwx r-w ---????`                                                                                                               |
|       9 | 2019-07-16 15:10:42 | delrey [Mobile Safari 12.1-iOS 12.3]              | `Dj`                                                                                                                                |
|      10 | 2019-07-29 18:19:44 | 来自安徽淮南的 Chrome 75.0-Windows 10 用户        | `里面有好多错误，虽然有部分已标注`                                                                                                  |
|      11 | 2020-03-25 22:48:49 | 来自广东广州的 Chrome Mobile 74.0-Android 10 用户 | `650`                                                                                                                               |
