...
date_updated: 2019-01-16 16:25:20
slug: article-10449-1.html
url: https://linux.cn/article-10449-1.html
url_from: 
  https://opensource.com/article/18/3/manage-your-workstation-configuration-ansible-part-2
image: album/201901/16/162446gszu3hzkrewilswr.jpg
tags:
  - ansible
  - 工作站
categories:
...
在这个系列的[第一部分](https://linux.cn/article-10434-1.html)，我向你展示了 `ansible-pull` 命令的基本用法，我们创建了一个安装了少量包的剧本。它本身是没有多大的用处的，但是为后续的自动化做了准备。

在这篇文章中，将会达成闭环，而且在最后部分，我们将会有一个针对工作站自动配置的完整的工作解决方案。现在，我们将要设置 Ansible 的配置，这样未来将要做的改变将会自动的部署应用到我们的工作站上。现阶段，假设你已经完成了[第一部分](https://linux.cn/article-10434-1.html)的工作。如果没有的话，当你完成的时候回到本文。你应该已经有一个包含第一篇文章中代码的 GitHub 库。我们将直接在之前创建的部分之上继续。
