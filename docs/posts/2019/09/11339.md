...
date_updated: 2019-09-14 18:16:34
slug: article-11339-1.html
url: https://linux.cn/article-11339-1.html
url_from: https://theartofmachinery.com/2019/08/12/c_const_isnt_for_performance.html
image: album/201909/14/181535lsrt9t93k1c1n0mt.jpg
tags:
  - 常量
categories:
  - 软件开发
...
|   index | 日期                | 日期                                           | 评论                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
|--------:|:--------------------|:-----------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2022-01-25 09:47:40 | 来自119.8.243.20的 Chrome 97.0-Windows 10 用户 | `“我不明白为什么会有不了解 const 的人让这些变量加上 static。”这句话翻译不对。原文是：“I don’t see why anyone who didn’t care about const would make those variables static.”。<br /> 意思应该是如果去掉了const，我看不出这些变量还有是static的必要。<br /> 事实上static const和const局部变量在gcc中的处理是完全不同的。gcc会在栈里面为const局部变量分配空间（就和普通局部变量一样），并在使用前初始化，但是static const是一个放在rodata只读数据段中的变量，不占用栈空间也不需要初始化。` |
