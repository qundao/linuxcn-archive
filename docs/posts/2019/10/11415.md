...
|   index | 日期                | 日期                                   | 评论                                                                                                                                                                  |
|--------:|:--------------------|:---------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2019-10-06 18:02:52 | phoenix_wangxd [Chrome 77.0-Mac 10.14] | `rsync（remote synchronize），目前由 http://rsync.samba.org 维护。<br /> 该软件主要是用在Linux系统中，但在 windows 平台下也有相应的版本，如 cwrsync 和DeltaCopy 等。` |
