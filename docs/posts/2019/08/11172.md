...
date_updated: 2019-08-01 08:54:37
slug: article-11172-1.html
url: https://linux.cn/article-11172-1.html
url_from: https://www.linuxtechi.com/upgrade-debian-9-to-debian-10-command-line/
image: album/201908/01/085439kp8jtzp9f1phuuah.jpg
tags:
  - debian
categories:
  - 技术
...
我们已经在先前的文章中看到如何安装 [Debian 10（Buster）](https://linux.cn/article-11083-1.html)。今天，我们将学习如何从 Debian 9 升级为 Debian 10，虽然我们已将看到 Debian 10 和它的特色，所以这里我们不会深入介绍。但是可能读者没有机会读到那篇文章，让我们快速了解一下 Debian 10 和它的新功能。
...
|   index | 日期                | 日期                                       | 评论           |
|--------:|:--------------------|:-------------------------------------------|:---------------|
|       0 | 2021-07-05 21:04:25 | 来自辽宁丹东的 Chrome 93.0-Windows 10 用户 | `会丢数据吗？` |
|       1 | 2021-07-18 20:06:42 | 来自甘肃天水的 Chrome 89.0-Windows 10 用户 | `赞！！`       |
