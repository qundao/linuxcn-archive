...
date_updated: 2019-02-15 10:05:00
slug: article-10538-1.html
url: https://linux.cn/article-10538-1.html
url_from: https://www.ostechnix.com/how-to-display-thumbnail-images-in-terminal/
image: album/201902/15/100523ear82xl1yoolxe2r.png
tags:
  - 图像
  - 终端
categories:
...
> lsix 是一个简单的命令行实用程序，旨在使用 Sixel 图形格式在终端中显示缩略图。
...
|   index | 日期                | 日期                                              | 评论   |
|--------:|:--------------------|:--------------------------------------------------|:-------|
|       0 | 2019-02-15 10:24:24 | 来自山东临沂的 Opera Mobile 48.2-Android 8.1 用户 | `Cool` |
