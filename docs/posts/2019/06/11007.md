...
date_updated: 2019-06-23 08:55:32
slug: article-11007-1.html
...
image: album/201906/23/085446setqkshf5zk0tn2x.jpg
tags:
  - 内存
  - 脚本
categories:
...
|   index | 日期                | 日期                                           | 评论                                                                                                                                                                                                                |
|--------:|:--------------------|:-----------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2019-06-24 11:25:21 | 来自北京北京大学的 Firefox 67.0-GNU/Linux 用户 | `echo &quot;$(ps -eo pid,ppid,%mem,%Memory,cmd --sort=-%mem - head)&quot; &gt;&gt; $MESSAGE<br /> 应改为<br /> &nbsp;&nbsp;echo &quot;$(ps -eo pid,ppid,%mem,%cpu,cmd --sort=-%mem - head)&quot; &gt;&gt; $MESSAGE` |
|       1 | 2019-08-29 11:13:41 | q745195581 [Chrome 76.0-Windows 10]            | `很不错，适用于生产环境！`                                                                                                                                                                                          |
