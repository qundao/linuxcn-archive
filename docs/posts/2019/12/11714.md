...
date_updated: 2019-12-26 11:15:19
slug: article-11714-1.html
url: https://linux.cn/article-11714-1.html
url_from: https://opensource.com/article/19/10/programming-bash-loops
image: album/201912/26/111437f9pa3zqqwcc9wwg1.jpg
tags:
  - bash
categories:
  - 技术
...
本系列的 [第一篇文章](https://linux.cn/article-11552-1.html) 讨论了 bash 编程的一些简单命令行操作，如使用变量和控制操作符。[第二篇文章](https://linux.cn/article-11687-1.html) 探讨了文件、字符串、数字等类型和各种各样在执行流中提供控制逻辑的的逻辑运算符，还有 bash 中不同种类的扩展。本文是第三篇（也是最后一篇），意在考察在各种迭代的操作中使用循环以及怎么合理控制循环。
