...
date_updated: 2019-11-05 09:07:46
slug: article-11538-1.html
url: https://linux.cn/article-11538-1.html
url_from: https://fedoramagazine.org/how-rpm-packages-are-made-the-spec-file/
image: album/201911/05/090750of1l5tt91r1eqlag.jpg
tags:
  - rpm
categories:
  - 技术
...
在[关于 RPM 软件包构建的上一篇文章](https://linux.cn/article-11527-1.html)中，你了解到了源 RPM 包括软件的源代码以及 spec 文件。这篇文章深入研究了 spec 文件，该文件中包含了有关如何构建 RPM 的指令。同样，本文以 `fpaste` 为例。
...
现在我们准备构建 RPM 包。如果要继续执行以下命令，请确保遵循[上一篇文章](https://linux.cn/article-11527-1.html)中的步骤设置系统以构建 RPM。
