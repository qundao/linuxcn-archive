...
date_updated: 2014-10-20 11:11:38
slug: article-4045-1.html
url: https://linux.cn/article-4045-1.html
url_from: http://ask.xmodulo.com/change-network-interface-name-centos7.html
image: album/201410/20/111141dq96m6az91mjt1tc.png
tags:
  - centos 7
  - rhel 7
  - 网络接口
...
|   index | 日期                | 日期                                       | 评论                                                                                                                                                                                                                                                                                                                                |
|--------:|:--------------------|:-------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2014-10-20 20:06:54 | kashu                                      | `哎，现在改个名字变得这么复杂了……`                                                                                                                                                                                                                                                                                                  |
|       1 | 2015-04-01 14:22:13 | 贵在坚持                                   | `我们应该考虑的问题是是否需要修改名称？&nbsp;&nbsp;修改后是否会有弊端？&nbsp;&nbsp;<br /> 根据Centos7的网卡命名规则“接口名称被自动基于固件，拓扑结构和位置信息来确定”，可以看出不修改是有好处的！ <br /> 我们修改后，如果更换网卡硬件，就会导致eth0配置文件存在，而多出一个新的由Centos7命名规则的网卡，//这里我没有测试，是猜想。` |
|       2 | 2015-09-21 15:01:56 | 来自四川成都的 Chrome 43.0-Windows 10 用户 | `这个不行，，，修改过后启动报错。`                                                                                                                                                                                                                                                                                                  |
