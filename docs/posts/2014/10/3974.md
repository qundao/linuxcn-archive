...
date_updated: 2014-10-09 08:26:00
slug: article-3974-1.html
url: https://linux.cn/article-3974-1.html
url_from: http://www.tecmint.com/extend-and-reduce-lvms-in-linux/
image: album/201410/08/214627it4e0ylmyw96yxl9.jpg
tags:
  - lvm
categories:
  - 系统运维
...
* [使用LVM创建弹性磁盘存储——第一部分](https://linux.cn/article-3965-1.html)
...
|   index | 日期                | 日期                                   | 评论                                                                          |
|--------:|:--------------------|:---------------------------------------|:------------------------------------------------------------------------------|
|       0 | 2014-10-09 09:03:00 | 微博评论                               | `@mywiz`                                                                      |
|       1 | 2014-10-09 09:03:00 | 微博评论                               | `mk`                                                                          |
|       2 | 2014-10-09 11:07:08 | kyohand                                | `这个顶一下..想学习的东西`                                                    |
|       3 | 2014-11-05 11:08:26 | ykyx00                                 | `fdisk分区做的lvm<br /> 新加的大磁盘是 parted的分区<br /> 加不到lv里边去吗？` |
|       4 | 2019-08-12 10:53:49 | 来自北京的 Chrome 76.0-Windows 10 用户 | `可以添加,正常执行就可`                                                       |
