...
date_updated: 2014-01-13 09:39:00
slug: article-2469-1.html
url: https://linux.cn/article-2469-1.html
url_from: ''
image: album/201401/11/213307jav4rv119l3kjhb9.png
tags:
  - linux
  - 命令
  - 操作符
...
|   index | 日期                | 日期                                      | 评论                                                                                                                                                                             |
|--------:|:--------------------|:------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2019-09-07 03:42:15 | 来自浙江杭州的 Chrome 76.0-Mac 10.13 用户 | `A &amp;&amp; B -- C is not the same as if A then B else C.<br /> In this case, if A is true but B is false, C will run.<br /> SEE: github.卡姆/koalaman/shellcheck/wiki/SC2015` |
