...
|   index | 日期                | 日期                                         | 评论                                                                                                                                                                        |
|--------:|:--------------------|:---------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2014-08-31 15:29:19 | netb2c                                       | `用二维码，有点意思。`                                                                                                                                                      |
|       1 | 2014-08-31 19:33:00 | 微博评论                                     | `@小白在安同 考虑打包不`                                                                                                                                                    |
|       2 | 2014-08-31 20:47:44 | linux                                        | `嗯，这种GOOGLE 的多因子认证，都是用二维码绑定的。话说，咱们站点也支持 GOOGLE 认证的，你没试试？`                                                                           |
|       3 | 2014-08-31 21:03:00 | 微博评论                                     | `有趣的是增加了一把锁又为某人开放了一把锁`                                                                                                                                  |
|       4 | 2014-08-31 22:03:00 | 微博评论                                     | `先 Mark //@冰雪聪明琳之风:@小白在安同 考虑打包不`                                                                                                                          |
|       5 | 2014-08-31 23:33:04 | 微博评论                                     | `回复@nihaoxiongfei:怎么说？`                                                                                                                                               |
|       6 | 2014-08-31 23:33:04 | 微博评论                                     | `马//@小白在安同:先 Mark //@冰雪聪明琳之风:@小白在安同 考虑打包不`                                                                                                          |
|       7 | 2014-09-01 07:33:01 | 微博评论                                     | `Repost`                                                                                                                                                                    |
|       8 | 2014-09-02 11:17:04 |                                              | `这个能支持多手机验证么？`                                                                                                                                                  |
|       9 | 2015-02-16 13:00:56 | 来自 - 广东广州 的 Chrome/Windows 用户       | `最新的是linux桌面操作系统是fedora21功能很强大,fedora21有很多的新功能可以了解下：<br /> fedora21新功能介绍与下载地址:itpux. com/article-12-1.html`                          |
|      10 | 2015-02-16 13:01:50 | 来自 - 广东广州 的 Chrome/Windows 用户       | `fedora21安装教程:itpux .com/thread-2284-1-1.html<br /> Fedora21安装后的10大配置过程:itpux .com/thread-2285-1-1.html<br /> fedora20安装教程:itpux .com/thread-243-2-1.html` |
|      11 | 2015-04-17 11:35:02 | linux                                        | `可以，反正你用多个手机扫描上面的二维码即可。`                                                                                                                              |
|      12 | 2015-07-17 15:28:58 | 来自 - 内蒙古呼和浩特 的 Chrome/Windows 用户 | `此话怎讲？`                                                                                                                                                                |
|      13 | 2016-04-13 11:14:06 | 来自西藏的 Chrome 49.0-Windows 7 用户        | `所有东西都弄好了&nbsp;&nbsp;重新登陆的时候老是密码错误。我去&nbsp;&nbsp;求解`                                                                                              |
|      14 | 2016-04-21 02:15:12 | 来自湖南岳阳的 Chrome 50.0-Mac 10.11 用户    | `小编好逗！图片上将紧急验证码打了码，却没将初始密钥打码。小编明白Google Authenticator的原理吗？只要有初始密钥，就可以和别人同步显示30秒临时验证码啊！`                      |
|      15 | 2016-04-21 19:42:51 | linux [Chrome 49.0-Mac 10.11]                | `这里只是个例子罢了，严格来说，包括那个二维码也需要混淆一下。`                                                                                                              |
|      16 | 2017-08-09 17:59:35 | 来自北京的 Chrome 55.0-Windows 10 用户       | `问一下，服务器没有外网支持这个么？`                                                                                                                                        |
|      17 | 2017-08-09 21:59:06 | linux [Chrome 59.0-Mac 10.11]                | `与网络无关，只要保证你的服务器的时钟准确就行。`                                                                                                                            |
|      18 | 2017-08-18 21:34:31 | 来自重庆的 Firefox 55.0-Windows 7 用户       | `大概是讲时钟服务漏洞？`                                                                                                                                                    |
