...
|      13 | 2017-02-15 09:23:58 | linux [Chrome 56.0-Mac 10.11]                      | `你可能好像已经抹去了原来的 OS X 了，要么就是冲掉了原本的引导系统。这种情况下，你似乎只能找 apple 恢复系统了——如果你没有恢复光盘并有一个光驱（不知道有没有 USB 的恢复系统）的话。<br /> <br /> 如果是这样，有可能是安装过程中没注意安装 GRUB 的位置，分区时候也有可能有错误。` |
|      14 | 2017-04-15 13:40:27 | 来自香港香港科技大学的 Chrome 57.0-Windows 10 用户 | `为何装完了ubuntu 重启的时候，无法进入ubuntu系统`                                                                                                                                                                                                                              |
