...
date_updated: 2014-12-25 10:56:13
slug: article-4526-1.html
url: https://linux.cn/article-4526-1.html
url_from: http://ask.xmodulo.com/install-phpmyadmin-centos.html
image: album/201412/25/105616takjivihinhipzmy.jpg
tags:
  - phpmyadmin
categories:
  - 技术
...
在CentOS上安装phpMyAdmin，你第一步需要架设一台Web服务器(如Apache或nginx)，安装好MySQL/MariaDB数据库和PHP。根据你的偏好和需求，你可以从[LAMP](https://linux.cn/article-1567-1.html)和[LEMP](https://linux.cn/article-4314-1.html)中选择一种安装。

另一个要求是允许在你的CentOS上安装EPEL库。如果你还没设置过请[猛戳这里](https://linux.cn/article-2324-1.html)。
...
|   index | 日期                | 日期                                       | 评论                                                                                                                                                                                                                                                                    |
|--------:|:--------------------|:-------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2014-12-25 11:33:02 | 微博评论                                   | `有问必答，帅`                                                                                                                                                                                                                                                          |
|       1 | 2014-12-25 11:33:02 | 微博评论                                   | `刚刚玩，不知道怎么配置，在这收藏一下`                                                                                                                                                                                                                                  |
|       2 | 2014-12-28 23:56:37 | stupid_lee                                 | `nice`                                                                                                                                                                                                                                                                  |
|       3 | 2015-06-11 23:37:24 | 来自 - 山东青岛 的 Chrome/Windows 用户     | `呵呵好文章`                                                                                                                                                                                                                                                            |
|       4 | 2015-06-15 13:02:42 | 不简单                                     | `留存备用！`                                                                                                                                                                                                                                                            |
|       5 | 2015-11-06 12:27:16 | 来自陕西西安的 Chrome 45.0-Windows 10 用户 | `大哥请教下我搭建好了就是安装你这个方法安装的，不过我是虚拟机安装的，虚拟机内输入127.0.0.1/phpMyAdmin是可以访问的但是我物理机器访问就出现错误：Forbidden&nbsp; &nbsp;&nbsp; &nbsp; You don't have permission to access /phpMyAdmin on this server.请问是怎么回事啊。。` |
|       6 | 2016-04-13 16:49:41 | 来自北京的 Firefox 45.0-Windows 8.1 用户   | `pxe安装的时候会报错`                                                                                                                                                                                                                                                   |
|       7 | 2016-04-13 16:51:07 | 来自北京的 Firefox 45.0-Windows 8.1 用户   | `有大神帮忙一下么，批量分发7的时候会报错`                                                                                                                                                                                                                               |
|       8 | 2016-04-13 21:38:35 | linux [Chrome 49.0-Mac 10.11]              | `pxe 是什么？`                                                                                                                                                                                                                                                          |
