...
date_updated: 2015-10-23 08:00:00
slug: article-6456-1.html
url: https://linux.cn/article-6456-1.html
url_from: http://itsfoss.com/mytodo-list-manager/
image: album/201510/22/233114lru8rre117e58nj7.jpg
tags:
  - todo
categories:
  - 分享
...
通常我关注的软件都是那些不用折腾并且易用的（对图形界面而言）。这就是我把 [Go For It](http://itsfoss.com/go-for-it-to-do-app-in-linux/) 待办事项程序归到 [Linux 产能工具](https://linux.cn/article-6425-1.html) 列表的原因。今天，我要向你们展示另一款待办事项列表应用，和其它的待办事项软件有点不一样。
...
|   index | 日期                | 日期                                      | 评论             |
|--------:|:--------------------|:------------------------------------------|:-----------------|
|       0 | 2016-01-20 23:39:14 | 来自江苏无锡的 Chrome 49.0-GNU/Linux 用户 | `看上去值的一试` |
