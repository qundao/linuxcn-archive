...
date_updated: 2015-10-04 14:41:00
slug: article-6348-1.html
url: https://linux.cn/article-6348-1.html
url_from: http://www.tecmint.com/setup-ldap-server-and-configure-client-authentication/
image: album/201510/04/004634ndnpybdz1yj5qqya.png
tags:
  - rhcsa
categories:
  - 技术
...
如若你想，你可以使用在 [RHCSA 系列（十二）: 使用 Kickstart 完成 RHEL 7 的自动化安装](https://linux.cn/article-6335-1.html) 中使用 Kickstart 安装的机子来作为客户端。
...
|   index | 日期                | 日期                                            | 评论                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
|--------:|:--------------------|:------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2016-05-01 22:16:36 | interface [Chrome 49.0-Windows 7]               | `拜读中……`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
|       1 | 2016-05-01 22:19:55 | interface [Chrome 49.0-Windows 7]               | `第四步 “然后以下面的内容创建一个 LDIF 文件(ldaprootpasswd.ldif)：”&nbsp;&nbsp;这个在哪儿创建，直接用户vi写一个&nbsp;&nbsp;还是？求指点`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
|       2 | 2016-05-04 14:40:53 | linux [Chrome 50.0-Mac 10.11]                   | `vi 写一个`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
|       3 | 2016-05-08 23:16:18 | interface [Chrome 49.0-Windows 7]               | `谢谢指点`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
|       4 | 2016-06-07 18:12:47 | yutou83 [Internet Explorer 11.0-Windows 7]      | `想看下LDAP怎么架设, 试了很多次都不成功`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
|       5 | 2017-02-22 21:45:52 | interface [Chrome 56.0-Windows 10]              | `首先非常感谢：Gabriel Cánepa 、FSSlc 、wxy ，按照全文步骤逐步完成到第9步出现报错。<br /> [root@huwei ~]# ldapmodify -H ldapi:/// -f ldapdomin.ldif <br /> SASL/EXTERNAL authentication started<br /> SASL username: gidNumber=0+uidNumber=0,cn=peercred,cn=external,cauth<br /> SASL SSF: 0<br /> ldapmodify: wrong attributeType at line 5, entry &quot;olcDatabase={1onitor,cn=config&quot;<br /> 我现在还不太理解第五行错误在什么地方，所以决定回去看看你们https://linux.cn/article-6934-1.html 人邮的那本书，前面两张是免费的可以看看，说不准能找到答案。如果译者看到了我们的问题&nbsp;&nbsp;也请指点。我是个纯小白` |
|       6 | 2017-02-23 21:14:26 | interface [Chrome 56.0-Windows 10]              | `求指点`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
|       7 | 2017-02-23 21:50:57 | linux [Chrome 56.0-Mac 10.11]                   | `这行明明是“dn: olcDatabase={1}monitor,cn=config”`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
|       8 | 2017-02-24 20:42:09 | interface [Chrome 56.0-Windows 10]              | `抱歉 这个报错应该是我粘贴的错。实际上报错就提示<br /> [root@huwei ~]# ldapmodify -H ldapi:/// -f ldapdomin.ldif <br /> SASL/EXTERNAL authentication started<br /> SASL username: gidNumber=0+uidNumber=0,cn=peercred,cn=external,cn=auth<br /> SASL SSF: 0<br /> ldapmodify: wrong attributeType at line 5, entry &quot;olcDatabase={1}monitor,cn=config&quot;<br /> 我有逐一检查了一下，文件中的配置。请问FSSIc你有出现过类似的问题吗？`                                                                                                                                                                                |
|       9 | 2017-02-24 21:40:09 | linux [Chrome 56.0-Mac 10.11]                   | `如果说是第五行，我考虑你是否在复制的时候，丢失了该行的前缀空格。这篇原文在此处的格式不准确，我们在校对和发布过程中进行了修正。<br /> 这种配置文件采用的是类似 yaml 的格式，其中的空格缩进是有意义的。对于此格式，有如下要求要注意：<br /> 1、键值对采用冒号和一个空格分隔——空格是重要的。<br /> 2、太长的值如果换行表示的话，请用前缀空格缩进。<br /> <br /> 可参见：<br /> https://www.digitalocean.com/community/tutorials/how-to-use-ldif-files-to-make-changes-to-an-openldap-system`                                                                                                                                |
|      10 | 2017-06-07 19:19:12 | 来自北京的 Chrome 58.0-Mac 10.12 用户           | `请问你是怎么解决的？我也遇到同样的问题`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
|      11 | 2020-05-09 12:09:33 | 来自北京的 Chrome 78.0-Windows 10 用户          | `看到配置LDAP我就笑了<br /> 从来没整成功过`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
|      12 | 2022-01-24 17:20:16 | 来自辽宁大连的 Chrome 97.0-Windows 10 用户      | `每一段中间要加个空行`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
|      13 | 2022-08-29 14:02:52 | 来自亚太地区的 Chrome 104.0-Mac 10.15 用户      | `我也出现这个问题，仔细排查后发现有些行的开始和末尾会有空格，删除空格后完美解决`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
|      14 | 2023-09-08 11:27:38 | 来自四川成都的 Sogou Explorer 2-Windows 10 用户 | `我搜的没模式，全摸索，刚从坑里出来。这文章，步骤详细，清晰，算好的了，学到了，`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
