...
date_updated: 2015-11-17 13:38:59
slug: article-6593-1.html
url: https://linux.cn/article-6593-1.html
url_from: http://www.tecmint.com/setting-up-nfs-server-with-kerberos-based-authentication/
image: album/201511/17/133903qgfa1npbdfaqanye.jpg
tags:
  - rhce
categories:
  - 技术
...
在本系列的前一篇文章，我们回顾了[如何在可能包括多种类型操作系统的网络上配置 Samba 共享](https://linux.cn/article-6550-1.html)。现在，如果你需要为一组类 Unix 客户端配置文件共享，很自然的你会想到网络文件系统，或简称 NFS。
...
|   index | 日期                | 日期                                       | 评论                                                                                                                                          |
|--------:|:--------------------|:-------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2020-11-04 20:21:39 | 来自浙江杭州的 Chrome 86.0|Windows 10 用户 | 能否补充抓包分析进行挂载时的认证流程分析，因为我搭建一个环境看起来基于kerberos进行NFS的共享，但是实际客户端首次认证发送明文中，用户名不台准确 |
