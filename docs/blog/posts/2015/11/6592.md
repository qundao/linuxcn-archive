...
date_updated: 2015-11-17 13:19:40
slug: article-6592-1.html
url: https://linux.cn/article-6592-1.html
url_from: http://ask.xmodulo.com/set-java_home-environment-variable-linux.html
image: album/201511/17/131929scdx6dsxsweeawqj.png
tags:
  - java
  - java_home
categories:
...
|   index | 日期                | 日期                             | 评论                                                                                                                                                                                                                         |
|--------:|:--------------------|:---------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2015-11-18 10:29:31 | POCMON [Firefox 42.0-Ubuntu]     | `这个技巧要保留，原来都没有想过要这样做～<br /> 还是思维跟不上呀～`                                                                                                                                                          |
|       1 | 2015-11-18 13:30:02 | Tessedar [Chrome 42.0-GNU/Linux] | `使用这个技巧还是需要小心一些东西的：<br /> 若只装了一个jdk，那jdk需要安装在bash可以自动找到的位置；<br /> 如果装了多个，那就要管理好环境变量，或者设置好update-alternatives。<br /> 不然这个命令很可能会把环境变量设置错。` |
