...
date_updated: 2015-11-27 07:50:00
slug: article-6651-1.html
url: https://linux.cn/article-6651-1.html
url_from: http://ask.xmodulo.com/which-shell-am-i-using.html
image: album/201511/27/065300nnznqys2g616ovgw.jpg
tags:
  - shell
categories:
  - 技术
...
|   index | 日期                | 日期                                                    | 评论                                                                                     |
|--------:|:--------------------|:--------------------------------------------------------|:-----------------------------------------------------------------------------------------|
|       0 | 2015-11-27 17:33:18 | 来自福建漳州厦门大学漳州校区的 Firefox 42.0-Ubuntu 用户 | `第一方法中的代码ps-p $$就为ps -p $$，ps与-p之间有空格`                                  |
|       1 | 2015-11-27 19:13:58 | linux [Chrome 46.0-Mac 10.11]                           | `有的啊？难道你那边不显示？`                                                             |
|       2 | 2015-11-28 06:59:19 | 妖精的羁绊 [Chrome 11.0-GNU/Linux]                      | `你好，请问下这种黑色背景，浅蓝色边框，绿色竖线是用什么工具来做出来的？命令行的编辑工具` |
|       3 | 2015-11-28 07:49:02 | linux [Chrome 46.0-Mac 10.11]                           | `就是个 css 而已，可以自行查看 css 源码。`                                               |
|       4 | 2015-12-02 23:18:03 | 来自广东广州的 Firefox 42.0-Fedora 用户                 | `使用哪个shell都差不多, 基本上都兼容. linux使用systemd后, shell编程 基本上就不用了.`     |
|       5 | 2015-12-02 23:19:27 | 来自广东广州的 Firefox 42.0-Fedora 用户                 | `linux系统里面 python和perl功能最强大,是实现自动化的关键.`                               |
