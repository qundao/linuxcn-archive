...
date_updated: 2015-11-22 17:58:16
slug: article-6625-1.html
url: https://linux.cn/article-6625-1.html
url_from: http://itsfoss.com/shell-script-opens-text-editor/
image: album/201511/22/175818bng2njj12j1nm3g2.jpg
tags:
  - shell
  - 脚本
categories:
...
|   index | 日期                | 日期                                   | 评论                                                                                                                                                                                                          |
|--------:|:--------------------|:---------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2015-11-25 18:27:28 | 多多号 [Chrome 46.0-Mac 10.11]         | `Executable Text Files --&gt;选项<br /> 强烈要求你的 翻译插件`                                                                                                                                                |
|       1 | 2015-11-25 23:11:44 | linux [Chrome 46.0-Mac 10.11]          | `没明白。`                                                                                                                                                                                                               |
|       2 | 2016-09-27 18:26:50 | 来自西班牙的 Chromium 52.0-Ubuntu 用户 | `我建议加上这么两点：<br /> <br /> 1. 在脚本首行加上shebang：<br /> <br /> #!/bin/bash<br /> <br /> 2. 在.sh文件的属性里面，勾选“允许作为可执行文件允许”，否则你的方法不会奏效。当然也等同于chmod加上x选项。` |
