...
date_updated: 2015-06-17 09:35:01
slug: article-5645-1.html
url: https://linux.cn/article-5645-1.html
url_from: http://www.tecmint.com/command-line-web-browser-download-file-in-linux/
image: album/201506/17/093454xr85khhge38ao5kd.jpg
tags:
  - 下载
  - 命令行
categories:
...
|   index | 日期                | 日期                                           | 评论                                                                                                                                               |
|--------:|:--------------------|:-----------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2015-06-17 21:38:13 | ryt                                            | `不错！学到了一些以前不知道的东西`                                                                                                                 |
|       1 | 2015-09-20 11:45:11 | 来自河南郑州的 Sogou Explorer 2-Windows 7 用户 | `学习了`                                                                                                                                           |
|       2 | 2016-12-31 15:28:20 | 来自上海的 Firefox 50.0-Windows 10 用户        | `aria最强的就是可以多源地址下载，如果一个文件有多个镜像站，但是速度都很慢，aria可以从多个镜像同时下载到本地同一个文件`                             |
|       3 | 2019-09-30 10:07:36 | 来自福建厦门的 Chrome 77.0-Windows 10 用户     | `很赞! 我有个服务器 ip不能访问了, 就通过 link查看 page的内容. 感谢.<br /> 另外这篇排版很美, 动画也做得非常清晰. 请教动画是用哪个软件制作的, 谢谢.` |
