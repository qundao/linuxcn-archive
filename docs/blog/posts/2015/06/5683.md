...
date_updated: 2015-06-24 09:09:00
slug: article-5683-1.html
url: https://linux.cn/article-5683-1.html
url_from: http://linoxide.com/linux-how-to/use-docker-machine-cloud-provider/
image: album/201506/24/001357io5db3zedre5w1ue.jpg
tags:
  - docker
  - docker machine
categories:
...
|   index | 日期                | 日期                                      | 评论                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
|--------:|:--------------------|:------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2016-03-31 22:01:30 | 来自浙江杭州的 Chrome 45.0-Windows 7 用户 | `这片文章写的非常详细，谢谢作者的辛勤付出！<br /> 我是docker初学者，最近才开始接触docker-machine。<br /> 我想问个问题，很小白的问题，请勿怪。<br /> <br /> 我的局域网内有三台服务器A(192.168.1.100)、B(192.168.1.101)、C(192.168.1.102)。<br /> A上安装了docker-machine，B的操作系统是Centos7，C的操作系统是windows2008。<br /> (B和C都只有纯净的操作系统，没有安装任何与docker相关的软件)<br /> 现在我想通过A上的docker-machine，给B和C安装docker，请问应该怎么做？` |
