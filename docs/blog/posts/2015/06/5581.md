...
date_updated: 2015-06-06 21:40:31
slug: article-5581-1.html
url: https://linux.cn/article-5581-1.html
url_from: http://xmodulo.com/setup-ntp-server-centos.html
image: album/201506/06/214034n7w7j89jy87hiz9j.jpg
tags:
  - ntp
  - 时间
categories:
...
|   index | 日期                | 日期   | 评论                                                                                                                                                                                                                                                                                                    |
|--------:|:--------------------|:-------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2015-06-07 05:10:37 | .wind  | `在客户端还需要做crond时间同步任务吧？如果客户端对时间精准度要求很高，设置多长时间同步一次？`                                                                                                                                                                                                           |
|       1 | 2015-06-07 11:40:30 | linux  | `客户端如果支持 ntp ，那就最好用这个，客户端可以启动ntpd，也可以用ntpdate来更新。一般如果不是主机上的 bios 电池有问题的话，时间偏差没那么大，所以几个小时或者一天同步一次就够了。<br /> 一般大多数应用不需要那么高精度的时间同步。<br /> 另外，如果是做集群，比如 mysql 集群，那就一定要保证时间同步。` |
|       2 | 2015-06-07 20:52:14 | .wind  | `Thanks`                                                                                                                                                                                                                                                                                                |
