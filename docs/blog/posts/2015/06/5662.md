...
date_updated: 2015-06-20 10:17:00
slug: article-5662-1.html
url: https://linux.cn/article-5662-1.html
url_from: http://ask.xmodulo.com/apache-error-log-location-linux.html
image: album/201506/20/072012ngyjhs11fwfsz80g.jpg
tags:
  - apache
  - 日志
categories:
...
错误日志和访问日志文件为系统管理员提供了有用的信息，比如，为 Web 服务器排障，[保护](https://linux.cn/article-5068-1.html)系统不受各种各样的恶意活动侵犯，或者只是进行[各种各样的](https://linux.cn/article-5352-1.html)[分析](https://linux.cn/article-4405-1.html)以监控 HTTP 服务器。根据你 Web 服务器配置的不同，其错误/访问日志可能放在你系统中不同位置。
...
|   index | 日期                | 日期                                           | 评论                 |
|--------:|:--------------------|:-----------------------------------------------|:---------------------|
|       0 | 2015-06-20 23:24:14 | 不简单                                         | `不错，学习了！！！` |
|       1 | 2015-06-24 07:08:29 | 来自 - 吉林长春吉林大学 的 Chrome/Windows 用户 | `很好`               |
