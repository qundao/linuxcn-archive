...
|       2 | 2016-09-23 08:44:01 | 致命飞行 [Chrome 50.0|Windows XP]          | systemctl start named-chroot执行时报错。麻烦帮忙定位，谢谢。<br />                                                                                                                                                                                                                                                            |
...
|         |                     |                                            | Sep 23 08:30:55 localhost.localdomain systemd[1]: named-chroot.service failed.                                                                                                                                                                                                                                                |
|       3 | 2016-11-16 17:31:06 | 来自四川泸州的 Chrome 45.0|Windows 7 用户  | 你找到解决方法了吗？                                                                                                                                                                                                                                                                                                          |
|       4 | 2017-01-09 16:59:48 | yinghunrenzi [Safari 10.0|Mac 10.12]       | 这里我有个疑问，在centos6版本中，bind-chroot可以直接由/etc/init.d/named这个脚本加载/etc/sysconfig/named这个文件。然后在/etc/init.d/named脚本中已经写好了通过mount --bind做目录链接。不需要设置以上这些东西。<br />                                                                                                            |
|         |                     |                                            | <br />                                                                                                                                                                                                                                                                                                                        |
...
|       8 | 2017-05-04 15:47:54 | 来自北京的 Liebao|Windows 10 用户          | 我解决了 是named.conf权限问题 ，chown root.named named.conf<br />                                                                                                                                                                                                                                                             |
|         |                     |                                            | 之后重启服务，你试一下                                                                                                                                                                                                                                                                                                                   |
|       9 | 2019-01-21 14:48:19 | 来自北京的 Chrome 71.0|Windows 10 用户     | 这个请求日志怎么输出？                                                                                                                                                                                                                                                                                                        |
|      10 | 2019-01-21 15:40:52 | 来自北京的 Chrome 71.0|Windows 10 用户     | 在logging {<br />                                                                                                                                                                                                                                                                                                             |
|         |                     |                                            | &nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;channel里面新添加，都告诉找不到这个文件，我自己touch一个还是找不到，<br />                                                                                                                                                                                                                                          |
|         |                     |                                            | &nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;file “/var/named/chroot/var/log/dns.log”<br />                                                                                                                                                                                                              |
|         |                     |                                            | &nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;这个路径就是不行chown named.named log chmod 777 log都不行                                                                                                                                                                                                                                          |
...
|      13 | 2020-03-14 14:21:52 | 来自四川成都的 Chrome 80.0|Windows 10 用户 | 可以试下这个cp -rp&nbsp;&nbsp;/var/named/dynamic&nbsp;&nbsp;/var/named/chroot/var/named/<br />                                                                                                                                                                                                                                |
...
|         |                     |                                            | Mar 14 01:26:58 localhost.localdomain named[9969]: invalid managed-keys-d                                                                                                                                                                                                                                                     |
