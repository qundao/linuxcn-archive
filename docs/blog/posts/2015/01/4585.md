...
date_updated: 2015-01-03 09:32:00
slug: article-4585-1.html
url: https://linux.cn/article-4585-1.html
url_from: http://xmodulo.com/useful-bash-aliases-functions.html
image: album/201501/02/223953tqtiwwwo71t3iq55.png
tags:
  - alias
  - 别名
  - 命令行
...
|   index | 日期                | 日期                                   | 评论                                                                                                                                                                                                                                                                             |
|--------:|:--------------------|:---------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2015-01-03 10:33:02 | 微博评论                               | `收藏//@n4mine:转发微博`                                                                                                                                                                                                                                                         |
|       1 | 2015-01-03 10:33:02 | 微博评论                               | `mark`                                                                                                                                                                                                                                                                           |
|       2 | 2015-01-03 11:33:00 | 微博评论                               | `别名真的又简单又高效`                                                                                                                                                                                                                                                           |
|       3 | 2015-01-03 12:33:01 | 微博评论                               | `sweet`                                                                                                                                                                                                                                                                          |
|       4 | 2015-01-03 12:33:01 | 微博评论                               | `@我的印象笔记`                                                                                                                                                                                                                                                                  |
|       5 | 2015-01-03 12:45:02 | 来自 - 广西南宁 的 Chrome/Windows 用户 | `alias 作死=&quot;sudo rm -rf /&quot;`                                                                                                                                                                                                                                           |
|       6 | 2015-01-03 13:33:01 | 微博评论                               | `[花心][花心][花心]`                                                                                                                                                                                                                                                             |
|       7 | 2015-01-03 16:03:01 | 微博评论                               | `@我的印象笔记`                                                                                                                                                                                                                                                                  |
|       8 | 2015-01-03 16:11:17 | 来自 - 广东广州 的 Firefox/Linux 用户  | `ifconfig.me速度太慢。<br /> ipinfo(){<br /> &nbsp;&nbsp;ip=`curl ifconfig.jd-app.com 2&gt; /dev/null`<br /> &nbsp;&nbsp;info=`curl whois.pconline.com.cn/ip.jsp 2&gt; /dev/null - iconv --from-code=gb2312 --to-code=utf-8 - tail -1`<br /> &nbsp;&nbsp;echo $ip $info<br /> }` |
|       9 | 2015-01-03 16:33:00 | 微博评论                               | `[good]`                                                                                                                                                                                                                                                                         |
|      10 | 2015-01-03 16:33:00 | 微博评论                               | `ifconfig.me速度太慢，探索了一番，写了个函数：ipinfo(){ip=`curl ifconfig.jd-app.com 2&gt; /dev/null`; info=`curl whois.pconline.com.cn/ip.jsp 2&gt; /dev/null - iconv --from-code=gb2312 --to-code=utf-8 - tail -1`; echo $ip $info; }`                                          |
|      11 | 2015-01-03 19:03:01 | 微博评论                               | `Repost`                                                                                                                                                                                                                                                                         |
|      12 | 2015-01-03 20:03:02 | 微博评论                               | `... Oh my zsh`                                                                                                                                                                                                                                                                  |
|      13 | 2015-01-03 21:33:02 | 微博评论                               | `ifconfig.me速度太慢，探索了一番，写了个函数：ipinfo(){ip=`curl ifconfig.jd-app.com 2&gt; /dev/null`; info=`curl whois.pconline.com.cn/ip.jsp 2&gt; /dev/null - iconv --from-code=gb2312 --to-code=utf-8 - tail -1`; echo $ip $info; }`                                          |
|      14 | 2015-01-03 23:03:37 | 来自 - 湖南长沙 的 MSIE/Windows 用户   | `不是说大波么，光看见帽子和command`                                                                                                                                                                                                                                              |
|      15 | 2015-01-04 00:33:00 | 微博评论                               | `@我的印象笔记`                                                                                                                                                                                                                                                                  |
|      16 | 2015-01-04 09:47:49 | linux                                  | `哈哈哈，难道要配图僵尸么？`                                                                                                                                                                                                                                                     |
|      17 | 2015-01-04 09:51:05 | linux                                  | `alias dodie=&quot;sudo rm -rf --no-preserve-root /&quot;`                                                                                                                                                                                                                       |
