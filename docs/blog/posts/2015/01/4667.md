...
date_updated: 2015-01-14 20:59:17
slug: article-4667-1.html
url: https://linux.cn/article-4667-1.html
url_from: 
...
image: album/201501/14/205920fpfc8718ii15cxc1.jpg
tags:
  - ubuntu
  - uefi
  - windows
...
读者在读过我的[安装Ubuntu和Windows 8双系统教程](https://linux.cn/article-3178-1.html)以后，碰到的主要的问题是电脑直接启动到Windows 8而没有出现启动Ubuntu的选项。
...
理论上来说，如果你首先安装Ubuntu，那么你需要[关闭快速启动](https://linux.cn/article-3178-1.html#4_3289)。

希望你[按照这个指南创建一个UEFI Ubuntu 启动优盘](https://linux.cn/article-3178-1.html#4_1717)安装正确的UEFI引导程序。
...
|   index | 日期                | 日期                                                | 评论                                                                                                                                                                                                                                         |
|--------:|:--------------------|:----------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2015-01-14 21:03:05 | 微博评论                                            | `觉得用easybcd更好一点[呵呵]`                                                                                                                                                                                                                |
|       1 | 2015-01-14 21:33:02 | 微博评论                                            | `[酷]`                                                                                                                                                                                                                                       |
|       2 | 2015-01-14 21:33:02 | 微博评论                                            | `#HZ赫兹工作室#win8+ubuntu 双系统教程`                                                                                                                                                                                                       |
|       3 | 2015-01-14 21:33:02 | 微博评论                                            | `mark`                                                                                                                                                                                                                                       |
|       4 | 2015-01-14 21:33:02 | 微博评论                                            | `@我的印象笔记`                                                                                                                                                                                                                              |
|       5 | 2015-01-14 22:03:03 | 微博评论                                            | `mark。`                                                                                                                                                                                                                                     |
|       6 | 2015-01-14 22:03:03 | 微博评论                                            | `Repost`                                                                                                                                                                                                                                     |
|       7 | 2015-01-14 22:03:03 | 微博评论                                            | `我还在用MBR`                                                                                                                                                                                                                                |
|       8 | 2015-01-14 22:33:02 | 微博评论                                            | `好东西，学习了[嘻嘻]`                                                                                                                                                                                                                       |
|       9 | 2015-01-15 00:03:03 | 微博评论                                            | `这都不是事`                                                                                                                                                                                                                                 |
|      10 | 2015-01-15 00:03:03 | 微博评论                                            | `怪不得出问题[偷笑]`                                                                                                                                                                                                                         |
|      11 | 2015-01-15 00:33:01 | 微博评论                                            | `装了三天的ubuntu了……我还没装好……`                                                                                                                                                                                                           |
|      12 | 2015-01-17 14:33:02 | 微博评论                                            | `额， 用 EFI 的可以尝试一下在开机的时候按一下 F12 （就是选择启动设备的按键，我这里是F12。grub安装在 ubuntu 挂载点为/的分区），里面会有ubuntu这一选项的说~`                                                                                   |
|      13 | 2015-01-18 09:44:28 | 来自 - 河南信阳 的 Chrome/Windows 用户              | `输入上边的mountvol命令，没反应啊。。cd不到那个盘。。`                                                                                                                                                                                       |
|      14 | 2015-01-18 10:49:49 | softpaopao                                          | `我没有禁用安全启动，用easyUEFI添加了一个引导指向\EFI\ubuntu\shimx64.efi就可以了。。`                                                                                                                                                        |
|      15 | 2016-01-05 15:18:43 | 来自山东淄博的 Chromium 47.0-Ubuntu 用户            | `我在执行bcdedit /set {bootmgr} path \EFI\refind\refind_x64.efi时老是报参数错误。。。貌似没写错啊`                                                                                                                                           |
|      16 | 2016-03-29 17:59:25 | 来自北京的 Microsoft Edge 13.10586-Windows 10 用户  | `第二个图形界面非常炫酷，谢谢楼主分享！<br /> 可是如果我想把启动恢复成最初的启动该怎么更改设置呢？`                                                                                                                                          |
|      17 | 2016-08-06 19:27:13 | 来自上海的 Microsoft Edge 13.10586-Windows 10 用户  | `如果映射EFI后没有看到ubuntu文件夹是什么原因？`                                                                                                                                                                                              |
|      18 | 2016-12-31 10:02:48 | 来自江苏南京东南大学的 Chrome 45.0-Windows 8.1 用户 | `你好 ，使用第二种方法时到第5步xcopy显示无效驱动器规格，没有文件复制，怀疑一开始EFI映射G盘没有成功，必须映射G盘吗？<br /> 另，easybcd修复时显示EFI mode.add entry 时linux为灰色，无法添加。没看到笔者电邮，方便留一下电邮交流吗？非常感谢。` |
|      19 | 2017-07-27 09:43:38 | 来自重庆的 Chrome 59.0-Windows 10 用户              | `在PowerShell里{bootmgr}要加引号&nbsp;&nbsp;'{bootmgr}'<br /> <br /> 我也是上Quote上面查了一下才知道`                                                                                                                                        |
|      20 | 2020-10-09 12:47:42 | 来自223.104.64.197的 Chrome 86.0-Windows 10 用户    | `第一种方式给我整成开机蓝屏了。。。幸亏备了个pe修复引导才好了`                                                                                                                                                                               |
