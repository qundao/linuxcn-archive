...
date_updated: 2015-01-15 22:29:10
slug: article-4676-1.html
url: https://linux.cn/article-4676-1.html
url_from: http://ask.xmodulo.com/install-7zip-linux.html
image: album/201501/15/222913yqqkzkk6ix3ttfyl.jpg
tags:
  - 7zip
categories:
  - 技术
...
在 CentOS/RHEL 系统中，在运行下面命令前您需要确保 [EPEL 资源库](https://linux.cn/article-2324-1.html) 可用，但在 Fedora 系统中就不需要额外的资源库了。
...
|   index | 日期                | 日期                                 | 评论                                                                                                                                                                                                      |
|--------:|:--------------------|:-------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2015-01-15 23:37:38 | 来自 - 福建福州 的 Chrome/Linux 用户 | `ubuntu上默认的图形解压工具实在弱爆，解压出来就是各种ºìÄ´ó½ ÓÏ·´ë<br /> 如果7zFM能有成熟的移植到ubuntu的版本就好了<br /> 作为基本在图形界面处理的小白，尝试编译7zFM源码结果先天缺失windows.h还是哪个文件` |
|       1 | 2015-01-16 00:03:02 | 微博评论                             | `@我的印象笔记`                                                                                                                                                                                           |
