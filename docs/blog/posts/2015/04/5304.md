...
|       2 | 2015-06-15 15:30:56 | 来自 - 安徽合肥 的 Firefox/Linux 用户  | `(process:227): GLib-CRITICAL **: g_slice_set_config: assertion 'sys_page_size == 0' failed<br /> 这种错误不知到你可遇到过？<br /> 我是archlinux系统` |
...
|       5 | 2022-07-08 10:38:38 | 来自北京的 Chrome 103.0-Mac 10.15 用户 | `DISPLAY=$DISPLAY&nbsp;&nbsp;不生效<br /> DISPLAY=docker0IP$DISPLAY&nbsp;&nbsp;<br /> 加上 ifconfig 里 docker0 ip的这样是可以的`                      |
|       6 | 2022-07-08 10:38:41 | 来自北京的 Chrome 103.0-Mac 10.15 用户 | `DISPLAY=$DISPLAY&nbsp;&nbsp;不生效<br /> DISPLAY=docker0IP$DISPLAY&nbsp;&nbsp;<br /> 加上 ifconfig 里 docker0 ip的这样是可以的`                      |
