...
date_updated: 2015-04-16 18:27:21
slug: article-5282-1.html
url: https://linux.cn/article-5282-1.html
url_from: https://raymii.org/s/articles/HTTP_Public_Key_Pinning_Extension_HPKP.html
image: album/201504/16/182724cfrflf9lw44xxich.png
tags:
  - hpkp
  - hsts
  - https
...
|   index | 日期                | 日期                                      | 评论                                                                                                  |
|--------:|:--------------------|:------------------------------------------|:------------------------------------------------------------------------------------------------------|
|       0 | 2015-04-16 20:38:28 | 来自 - 北京 的 Chrome/Windows 用户        | `求Apache2 开启https的教程，win和linux的都可以，网上找到的都和模糊`                                   |
|       1 | 2016-12-20 10:42:57 | 来自云南大理的 Chrome 55.0-Windows 7 用户 | `感谢文章的翻译和发布者，我的网站也启用hpkp了`                                                        |
|       2 | 2016-12-20 12:59:50 | linux [Chrome 55.0-Mac 10.11]             | `【握手】`                                                                                            |
|       3 | 2022-01-21 20:09:21 | 来自四川南充的 Chrome 70.0-Windows 7 用户 | `友情提示：<br /> Chrome 68 开始弃用 HPKP，在 Chrome 72 正式移除 HPKP。<br /> 所以不用配置这玩意了。` |
