...
date_updated: 2015-09-25 13:55:55
slug: article-6294-1.html
url: https://linux.cn/article-6294-1.html
url_from: http://www.tecmint.com/combine-partitions-into-one-in-linux-using-mhddfs
image: album/201509/25/135558rzmww6wiqsk3imqm.png
tags:
  - mhddds
  - 文件系统
categories:
...
在RHEL/CentOS Linux系统中，你需要开启[epel仓库](https://linux.cn/article-2324-1.html)，然后执行下面的命令来安装mhddfs包。
...
|   index | 日期                | 日期                              | 评论                        |
|--------:|:--------------------|:----------------------------------|:----------------------------|
|       0 | 2015-09-25 14:09:39 | 绿色圣光 [Firefox 39.0|Windows 7] | 嗯~这个有意思。可以试一试。 |
|       1 | 2015-09-25 16:09:41 | fanbt [Firefox 40.0|Fedora]       | 不好用，还不如用BTRFS       |
