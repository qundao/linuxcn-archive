...
date_updated: 2015-09-14 15:03:35
slug: article-6212-1.html
url: https://linux.cn/article-6212-1.html
url_from: http://www.cli-nerd.com/2015/09/09/7-reasons-to-upgrade-to-node-v4-now.html
image: album/201509/14/150337fbb1xe1b53z770n3.jpg
tags:
  - es6
  - node.js
categories:
...
[Node.js 4.0.0 已经发布了](https://linux.cn/article-6181-1.html)。这是和 io.js 合并之后的首个稳定版本，它带来了一系列的新特性，支持 ES 6的大部分特性。已经有很多 [ES 6 的特性](https://nodejs.org/en/docs/es6/)介绍了，这里我们介绍一下该怎么使用它们。
...
|   index | 日期                | 日期                              | 评论                                                                                          |
|--------:|:--------------------|:----------------------------------|:----------------------------------------------------------------------------------------------|
|       0 | 2015-09-14 17:08:46 | little光光 [Chromium 44.0-Ubuntu] | `nodejs会越来越好的吧`                                                                        |
|       1 | 2015-09-22 15:29:35 | Pucmax [Chrome 43.0-Windows 7]    | `Nodejs，虽然我用的不是它，但仍然觉得很牛x！<br /> <br /> 不复杂、好用，它在一条正确的路上。` |
