...
date_updated: 2015-09-03 18:49:28
slug: article-6143-1.html
url: https://linux.cn/article-6143-1.html
url_from: http://xmodulo.com/setup-system-status-page.html
image: album/201509/03/183416gquqoquu38ym01qi.png
tags:
  - cachet
categories:
  - 技术
...
在基于 Red Hat 系统上，你首先需要[设置 REMI 软件库](https://linux.cn/article-4192-1.html)（以满足 PHP 的版本需求）。然后执行下面命令。
...
在基于 Red Hat 系统上设置 LAMP 的更多细节，参考这个[教程](https://linux.cn/article-5789-1.html)。
...
|   index | 日期                | 日期                                           | 评论                                                                                               |
|--------:|:--------------------|:-----------------------------------------------|:---------------------------------------------------------------------------------------------------|
|       0 | 2015-09-09 10:00:21 | 来自江苏南京的 Sogou Explorer 2|Windows 7 用户 | centos7.0&nbsp; &nbsp;yum安装的php是5.4.16，不满足cachet的安装要求啊，源码安装好麻烦哦。。。。。。 |
