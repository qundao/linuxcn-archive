...
|       2 | 2015-10-22 10:10:02 | i1zhuxian [Chrome 42.0|Windows 10]                | 例6：归档时同时保存原始权限和所有权<br />                                                          |
|         |                     |                                                   | # tar cJf ApacheLogs-$(date +%Y%m%d).tar.xz /var/log/httpd/* --same-permissions --same-owner<br /> |
