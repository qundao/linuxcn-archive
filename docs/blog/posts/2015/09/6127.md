...
date_updated: 2015-09-01 14:13:00
slug: article-6127-1.html
url: https://linux.cn/article-6127-1.html
url_from: http://www.tecmint.com/fdupes-find-and-delete-duplicate-files-in-linux/
image: album/201509/01/111653azfdd8pz0grep0vy.png
tags:
  - fdupes
  - 重复
categories:
...
在基于CentOS/RHEL和Fedora的系统上，你需要开启[epel仓库](https://linux.cn/article-2324-1.html)来安装fdupes包。
...
在执行以上命令后，让我们使用ls[命令](https://linux.cn/article-5109-1.html)验证重复文件是否创建。
...
|   index | 日期                | 日期                                      | 评论   |
|--------:|:--------------------|:------------------------------------------|:-------|
|       0 | 2020-04-22 15:16:07 | 来自陕西西安的 Chrome 81.0-Mac 10.15 用户 | `赞?`  |
