...
date_updated: 2015-03-03 11:04:00
slug: article-4972-1.html
url: https://linux.cn/article-4972-1.html
url_from: http://www.tecmint.com/create-luns-using-lvm-in-iscsi-target/
image: album/201503/02/150705ykpxc1w66gawck8w.png
tags:
  - iscsi
categories:
  - 系统运维
...
|   index | 日期                | 日期                                      | 评论                                                                                                                      |
|--------:|:--------------------|:------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------|
|       0 | 2015-03-03 12:03:03 | 微博评论                                  | `mk`                                                                                                                      |
|       1 | 2015-03-03 22:03:01 | 微博评论                                  | `@我的印象笔记`                                                                                                           |
|       2 | 2015-03-04 20:22:42 | 来自 - 云南昆明 的 Chrome/Windows 用户    | `老师，什么时候可以讲解决下LINUX下的多路径管理方面的知识呢？特别在多路径聚合之后，还可以用UDEV的方式来进行管理和识别吗？` |
|       3 | 2020-05-04 22:02:38 | 来自广东深圳的 Chrome 69.0-Windows 7 用户 | `撸主，sda分区完后，包括lv划分完后，不需要进行格式化，就能用了吗？`                                                       |
