...
date_updated: 2015-03-23 09:46:00
slug: article-5097-1.html
url: https://linux.cn/article-5097-1.html
url_from: http://xmodulo.com/backuppc-cross-platform-backup-server-linux.html
image: album/201503/20/235236goipii0u37jybbuo.jpg
tags:
  - backuppc
  - 备份
categories:
...
也许你没有从我先前关于 [backupninja](https://linux.cn/article-5096-1.html) 和 [backup-manager](https://linux.cn/article-4586-1.html) 的两篇文章中发现，我是一个超级备“粉”。当提到备份，我宁愿备份的太多而不希望备份不足，因为如果我们有需要的话，你将会感激你为重要数据生成额外的拷贝所付出的时间和精力。
...
在 CentOS/RHEL 6 上，首先要启用 [EPEL 软件仓库](https://linux.cn/article-2324-1.html)。在 CentOS/RHEL 7 上，请替代启用 [Nux Dextop](https://linux.cn/article-3889-1.html) 软件仓库。然后接着使用 `yum` 命令：
...
|   index | 日期                | 日期     | 评论   |
|--------:|:--------------------|:---------|:-------|
|       0 | 2015-03-23 11:33:01 | 微博评论 | 马克   |
|       1 | 2015-03-23 13:03:00 | 微博评论 | 马     |
