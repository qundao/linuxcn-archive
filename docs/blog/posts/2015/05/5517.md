...
date_updated: 2015-05-27 09:56:00
slug: article-5517-1.html
url: https://linux.cn/article-5517-1.html
url_from: 
  http://www.tecmint.com/manage-and-limit-downloadupload-bandwidth-with-trickle-in-linux/
image: album/201505/27/000021s8uwj3ig8voull7c.png
tags:
  - trickle
categories:
  - 技术
...
1. 对于 RHEL/CentOS 7/6， [开启EPEL仓库](https://linux.cn/article-2324-1.html)。这些用于企业版 Linux 的额外软件包是一个由Fedora项目维护的高质量、开源的软件仓库，而且百分之百与其衍生产品相兼容，如企业版本Linux和CentOS。 在这个仓库中trickle和ncftp两者都是可用的。
2. 按照如下方式安装ncftp：
