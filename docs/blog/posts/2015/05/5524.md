...
date_updated: 2015-05-27 16:17:52
slug: article-5524-1.html
url: https://linux.cn/article-5524-1.html
url_from: http://xmodulo.com/bgp-authentication-quagga.html
...
常用的Linux内核原生支持IPv4和IPv6的TCP MD5选项。因此，如果你从全新的[Linux机器](https://linux.cn/article-4232-1.html)构建了一台Quagga路由器，TCP的MD5功能会自动启用。剩下来的事情，仅仅是配置Quagga以使用它的功能。但是，如果你使用的是FreeBSD机器或者为Quagga构建了一个自定义内核，请确保内核开启了TCP的MD5支持（如，Linux中的CONFIG*TCP*MD5SIG选项）。
