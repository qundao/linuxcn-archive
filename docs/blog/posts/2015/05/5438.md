...
date_updated: 2015-05-13 07:28:00
slug: article-5438-1.html
url: https://linux.cn/article-5438-1.html
url_from: 
  http://linux.about.com/od/commands/tp/11-Linux-Terminal-Commands-That-Will-Rock-Your-World.htm
image: album/201505/12/233512pz5y93dzryzy9fur.png
tags:
  - 命令
  - 终端
categories:
...
|   index | 日期                | 日期                                             | 评论                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
|--------:|:--------------------|:-------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2015-05-13 08:30:42 | linlover                                         | `man -H这个不错`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
|       1 | 2015-05-13 08:51:46 | ZMOM1031                                         | `Ctrl + Shift + C - 图形界面下复制虚拟终端文本<br /> Ctrl + Shift + V - 图形界面下粘贴虚拟终端文本<br /> Ctrl + D - 删除当前光标字符 没字符的直接退出终端<br /> Ctrl + L - 替代clear<br /> reset - 终端出现乱写后使用这命令重置<br /> <br /> 其他一时想不起来了<br /> 顺便说一下，Linux用了2年多，19岁，无工作，求工作，坐标杭州 :-)`                                                                                                                                                                                                                                                                                                                                                                                           |
|       2 | 2015-05-13 11:24:35 | 崖山一劫                                         | `有些命令我没见过，有些命令那么熟悉<br /> <br /> --（linux招待所）`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
|       3 | 2015-05-13 17:12:01 | kashu                                            | `引用 “Shift + Insert - 向终端内粘贴文本”<br /> 重新描述一下：<br /> 在终端界面中使用鼠标选中相关内容之后，直接按shift + insert后就相当于复制并直接粘贴选中的内容<br /> （也就是，这一个组合键把ctrl + shift + c 和 ctrl + shift + v的工作一步就做到位了，方便！）`                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
|       4 | 2015-05-13 17:14:30 | kashu                                            | `man帮助文件需要有颜色其实很简单<br /> 下面是我的必备设置（追加到~/.bashrc文件中，然后直接source ~/.bashrc即可生效）<br /> <br /> # Set colors for man pages<br /> man() {<br /> &nbsp;&nbsp;env \<br /> &nbsp;&nbsp;LESS_TERMCAP_mb=$(printf &quot;\e[1;31m&quot;) \<br /> &nbsp;&nbsp;LESS_TERMCAP_md=$(printf &quot;\e[1;31m&quot;) \<br /> &nbsp;&nbsp;LESS_TERMCAP_me=$(printf &quot;\e[0m&quot;) \<br /> &nbsp;&nbsp;LESS_TERMCAP_se=$(printf &quot;\e[0m&quot;) \<br /> &nbsp;&nbsp;LESS_TERMCAP_so=$(printf &quot;\e[1;44;33m&quot;) \<br /> &nbsp;&nbsp;LESS_TERMCAP_ue=$(printf &quot;\e[0m&quot;) \<br /> &nbsp;&nbsp;LESS_TERMCAP_us=$(printf &quot;\e[1;32m&quot;) \<br /> &nbsp;&nbsp;man &quot;$@&quot;<br /> }` |
|       5 | 2015-05-14 09:15:58 | xgeek                                            | `很有用，有些忽略的tips使用时，有时候很能够提高效率`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
|       6 | 2015-05-14 22:40:13 | linux                                            | `其实你们都没有发现，这篇文章最令人吃惊的是题图。`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
|       7 | 2015-05-20 00:07:14 | zhongjiang_nudt                                  | `果然很多不知道啊.<br /> 但是sudo 命令,我相信刚开始用linux的都知道.`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
|       8 | 2015-05-20 09:19:48 | linux                                            | `不过 sudo !! 这个命令我虽然知道，但是从来不用，因为用“!!”重复上个命令，也许是错误的，尤其是以 root 权限来执行，一旦有误非常危险！！！<br /> <br /> ——————so，千万不要执行 sudo !!，千万不要执行 sudo !!，千万不要执行 sudo !!，重要的事情重复三遍。`                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
|       9 | 2016-07-19 13:53:21 | 何亮 [Chrome 49.0-Windows 7]                     | `Shift + Insert - 向终端内粘贴文本<br /> 这条命令，好酷`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
|      10 | 2016-09-08 23:06:32 | 来自内蒙古呼和浩特的 WeChat 6.3-Android 5.1 用户 | `跪求命令行举例字体，太漂亮了`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
|      11 | 2016-09-09 15:11:50 | linux [Chrome 52.0-Mac 10.11]                    | `字体就是普通等宽字体啊。我想你说的是配色？哈哈，我们的配色被微信上问了许多回，我写个文章来介绍一下吧。`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
|      12 | 2019-09-11 14:14:58 | 来自印度的 Chrome 76.0-Windows 10 用户           | `To check whether the Alexa App is already installed on your system or not, you can write the Alexa in your search box. If the app appears in the search results then the app is already installed but if it is not displaying in the results then you can download Alexa App by choosing any of the operating systems.The main difference between both the devices are the Echo has a built in speaker which is designed to listen to music, while the&nbsp;&nbsp;Echo dot only has a small simple speaker really designed for`                                                                                                                                                                                                |
