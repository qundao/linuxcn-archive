...
date_updated: 2015-05-11 14:44:40
slug: article-5427-1.html
url: https://linux.cn/article-5427-1.html
url_from: http://linoxide.com/linux-how-to/2-ways-create-docker-base-image/
image: album/201505/11/144443z73a10fo00aafra0.png
tags:
  - docker
  - 镜像
categories:
...
|   index | 日期                | 日期                                        | 评论                                                                                                           |
|--------:|:--------------------|:--------------------------------------------|:---------------------------------------------------------------------------------------------------------------|
|       0 | 2015-09-26 00:24:01 | 来自北京的 UC Browser 10.6-Android 4.3 用户 | `sudo debootstrap trusty trusty &gt; /dev/null<br /> 这个指令验证过了么？貌似是特定配置环境下的吧，本地无效啊` |
|       1 | 2016-07-06 15:38:28 | 来自福建泉州的 Chrome 45.0-Windows 7 用户   | `想请问一下，要自己把本地的android的iso文件，转换成docker镜像要怎么弄啊。`                                     |
