...
|       9 | 2015-12-24 17:22:32 | POCMON [Firefox 43.0-Ubuntu]                           | `ubuntu代表应该是LINUX桌面，无论你现在用的是什么？<br /> 只要是曾经用过UBUNTU一个月～`                                                                                            |
...
|      20 | 2015-12-26 20:41:47 | 来自北京的 Internet Explorer 11.0-Windows 10 用户      | `这个我看到LINUX系列一直默默做着背后的工作，那些需要大量计算，处理数据等工作，我喜欢Ubuntu,但是桌面使用上还是体验不好<br /> 其实我觉的做好自己的工作就是最好的，Ubuntu有些入魔了` |
