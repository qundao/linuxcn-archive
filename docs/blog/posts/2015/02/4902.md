...
date_updated: 2015-02-17 14:28:27
slug: article-4902-1.html
url: https://linux.cn/article-4902-1.html
url_from: http://www.tecmint.com/install-pxe-network-boot-server-in-centos-7/
image: album/201502/17/142831msc4mfmejsemfqq9.png
tags:
  - centos 7
  - pxe
  - 网络安装
...
* [在RHEL/CentOS 7中配置静态IP地址](https://linux.cn/article-3977-1.html)
...
|   index | 日期                | 日期                                       | 评论                                                                                                |
|--------:|:--------------------|:-------------------------------------------|:----------------------------------------------------------------------------------------------------|
|       0 | 2015-02-17 14:33:01 | 微博评论                                   | `@我的印象笔记`                                                                                     |
|       1 | 2015-02-17 15:33:03 | 微博评论                                   | `Repost`                                                                                            |
|       2 | 2015-02-17 15:33:03 | 微博评论                                   | `PXE安装我喜欢`                                                                                     |
|       3 | 2015-02-17 16:03:01 | 微博评论                                   | `Repost`                                                                                            |
|       4 | 2015-02-17 17:03:02 | 微博评论                                   | `@我的印象笔记`                                                                                     |
|       5 | 2015-02-17 21:33:02 | 微博评论                                   | `@我的印象笔记`                                                                                     |
|       6 | 2015-02-17 23:03:02 | 微博评论                                   | `干货`                                                                                              |
|       7 | 2015-07-10 18:01:10 | 来自 - 四川成都 的 Chrome/Windows 用户     | `货干，不错不错，马克`                                                                              |
|       8 | 2015-07-18 09:15:18 | 来自 - 浙江温州 的 Chrome/Windows 用户     | `如何让在配置文件设置让其自动判断是EFI还是Legacy然后引导对应文件?`                                  |
|       9 | 2015-10-24 20:41:36 | Dante [Firefox 41.0-Windows 7]             | `不全啊，后面还有kickstar呢`                                                                        |
|      10 | 2015-10-25 20:45:58 | linux [Chrome 46.0-Mac 10.11]              | `翻页。。。`                                                                                        |
|      11 | 2016-03-02 12:19:28 | wfzcted [Chrome 31.0-Windows XP]           | `虚拟机上的网卡是eno16777736，但是在真实的环境下安装不成功。请问在真实的环境下如何设置网卡名称呢？` |
|      12 | 2019-11-10 11:20:28 | 来自湖北鄂州的 Firefox 68.0-GNU/Linux 用户 | `boot from local 好像无效呢.<br /> 超时后会重新计时`                                                |
