...
date_updated: 2015-08-08 13:50:00
slug: article-5975-1.html
url: https://linux.cn/article-5975-1.html
url_from: http://xmodulo.com/access-linux-server-behind-nat-reverse-ssh-tunnel.html
image: album/201508/07/235248bx5kxx52gg8yyty4.jpg
tags:
  - nat
  - ssh
categories:
...
第一步，我们要设置从家庭服务器到中继服务器的[无密码 SSH 登录](https://linux.cn/article-5444-1.html)。这样的话，autossh 可以不需要用户干预就能重启一个损坏的反向 SSH 隧道。

下一步，在建立隧道的家庭服务器上[安装 autossh](https://linux.cn/article-5459-1.html)。
...
|   index | 日期                | 日期                                                            | 评论                                                                                                                                                                   |
|--------:|:--------------------|:----------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2015-08-08 22:54:41 | 来自辽宁的 Sina Weibo 5.3|Android 4.4 用户                      | @保存到为知笔记                                                                                                                                                        |
|       1 | 2015-08-09 14:00:15 | 来自山东菏泽的 Chrome 43.0|Windows 7 用户                       | @保存到为知笔记                                                                                                                                                        |
|       2 | 2016-09-14 21:40:59 | 来自湖北武汉华中科技大学同济医学院的 Chrome 52.0|Mac 10.11 用户 | “通过反向 SSH 隧道直接连接到网络地址变换后的服务器”这里的“relayserver~$ vi /etc/ssh/sshd_conf”有误，sshd_config才是有效的，即：“relayserver~$ vi /etc/ssh/sshd_config” |
