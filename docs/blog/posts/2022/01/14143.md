...
date_updated: 2022-01-03 10:59:18
slug: article-14143-1.html
url: https://linux.cn/article-14143-1.html
url_from: https://news.itsfoss.com/linux-distro-releases-2022/
image: album/202201/03/105918jgiiig5ont024oi2.png
tags:
  - 发行版
categories:
  - 技术
...
如果你错过了 [2021 年的 Linux 大事件](https://linux.cn/article-14103-1.html)，现在你也可以去回顾一下。
...
先来简单回顾一下 —— [elementary OS 6.1](https://news.itsfoss.com/elementary-os-6-1-release/)、[Zorin OS 16](https://news.itsfoss.com/zorin-os-16-release/)、[Pop!\_OS 21.10](https://linux.cn/article-14083-1.html) 和 Linux Mint 20.3 都是于 2021 年推出的大型 Linux 发行版的更新版。这些发行版都专注于改善用户体验、改进视觉、优化生产力。
...
[Ubuntu 21.10](https://linux.cn/article-13887-1.html) 的一系列改进也将在 Ubuntu 22.04 LTS 中一并出现。
...
毫无疑问，[Pop!\_OS 能够成为我的主力系统](https://linux.cn/article-14118-1.html)。
...
根据我对其 Beta 测试版本的体验，CutefishOS 在用户体验上 [可以与深度操作系统相媲美](https://linux.cn/article-14058-1.html)。当然我仍旧持谨慎态度，毕竟它还没到达稳定阶段。
...
[Fedora](https://getfedora.org) 团队已经从 [Linus Tech Tip 的 Linux 日用挑战系列视频](https://linux.cn/article-14053-1.html) 中认真地听取了用户反馈。
...
[Fedora 35](https://linux.cn/article-13949-1.html) 正是一个优秀案例，它带来了 GNOME 41 和全新的 KDE 变体版本。
...
|   index | 日期                | 日期                                                         | 评论                                                                                                                       |
|--------:|:--------------------|:-------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------|
|       0 | 2022-01-03 12:00:47 | 来自四川宜宾的 Chrome 96.0-Windows 10 用户                   | `英特尔做了一个独立的发行版—Clear OS，不知道用的人多不多？`                                                                |
|       1 | 2022-01-03 13:03:32 | 来自四川自贡的 Chrome Mobile 83.0-Android 11 用户            | `过了喜欢折腾的年纪了，应该一直 Debian 养老了吧。`                                                                         |
|       2 | 2022-01-03 13:09:02 | 来自四川自贡的 Chrome Mobile 83.0-Android 11 用户            | `才出来的时候，各 Lnux 社区都在讨论，但最后似乎没几个人用`                                                                 |
|       3 | 2022-01-03 15:36:07 | 来自浙江杭州的 Chrome 96.0-Windows 10 用户                   | `大部分都是debian系的`                                                                                                     |
|       4 | 2022-01-05 22:43:23 | 来自山西长治的 Chrome 96.0-Windows 10 用户                   | `一直喜欢Linux Mint，因为他简洁、相对不卡顿、适应能力强，新老硬件通吃。希望以后的版本能更加顺畅，起码能堪比win7的流畅度！` |
|       5 | 2022-01-12 09:17:20 | 来自黑龙江哈尔滨哈尔滨工业大学的 Chrome 97.0-Windows 10 用户 | `真养老还得是Ubuntu`                                                                                                       |
|       6 | 2022-01-21 19:22:37 | 来自浙江杭州的 Chrome 81.0-GNU/Linux 用户                    | `ubuntu的用户路过`                                                                                                         |
|       7 | 2022-02-10 10:40:51 | 来自河北唐山的 Chrome 98.0-Windows 10 用户                   | `Arch邪教信徒路过`                                                                                                         |
|       8 | 2022-08-15 23:15:19 | 来自广东深圳的 Chrome 93.0-GNU/Linux 用户                    | `win10转deepin路过`                                                                                                        |
|       9 | 2022-09-12 17:00:14 | 来自广东深圳的 Chrome 104.0-GNU/Linux 用户                   | `首推manjaro, 接着是mint, 其他都是非人类设计，不要因为一张图就觉得行了。是真用户就敢晒你的平时用的应用`                    |
|      10 | 2023-08-02 18:08:14 | 来自北京的 Firefox 113.0-Android 13 用户                     | `其实试着OpenSUSE、KDE Neon、Fedora之类都不错`                                                                             |
