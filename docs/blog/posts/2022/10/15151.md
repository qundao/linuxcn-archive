...
|   index | 日期                | 日期                                        | 评论                                                                                                                                                                                                                                             |
|--------:|:--------------------|:--------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2022-10-18 13:19:57 | 来自湖南郴州的 Chrome 106.0-Windows 10 用户 | `感觉最近很多这类项目，Debian 系这边已经有 MPR Pacstall 了（还有个 deb-get，但只是汇集第三方包，不包含自己打包）。<br /> <br /> 其实通用的 Linux 包管理工具已经有一个了，还是跨系统的，那就是 Homebrew。在 Linux 上用着也还行，不过一般用不到。` |
