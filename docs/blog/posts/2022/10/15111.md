...
date_updated: 2022-10-06 15:47:35
slug: article-15111-1.html
url: https://linux.cn/article-15111-1.html
url_from: https://opensource.com/article/21/6/java-serverless-functions
image: album/202210/06/154731xejvfcai8e0auimh.jpg
tags:
  - java
  - quarkus
  - 无服务器
...
对 [无服务器 Java](https://linux.cn/article-13429-1.html) 的研究始于函数 —— 就是按需求运行的一小段代码。这一阶段并没有持续很长时间。虽然在 1.0 阶段，基于虚拟机架构的函数使这种范式变得很流行，但它仍然有局限性，例如执行时间、协议和糟糕的本地开发体验，都不太理想，如下图所示。
...
|   index | 日期                | 日期                                        | 评论                                                   |
|--------:|:--------------------|:--------------------------------------------|:-------------------------------------------------------|
|       0 | 2022-10-19 23:08:59 | 来自江苏无锡的 Chrome 106.0|Windows 10 用户 | 我知道你想毁了java，但大部分人仍然会抱着spring的大腿。 |
|       1 | 2022-10-19 23:09:02 | 来自江苏无锡的 Chrome 106.0|Windows 10 用户 | 我知道你想毁了java，但大部分人仍然会抱着spring的大腿。 |
