...
date_updated: 2022-10-01 13:31:55
slug: article-15092-1.html
url: https://linux.cn/article-15092-1.html
url_from: https://opensource.com/article/22/9/linux-inxi-command
image: album/202210/01/133155q6i2xx2f2emn23f3.png
tags:
  - inxi
categories:
  - 技术
...
|   index | 日期                | 日期                                        | 评论                                                                                                                              |
|--------:|:--------------------|:--------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2022-10-08 14:47:17 | 来自广东深圳的 Chrome 105.0|Windows 10 用户 | ubuntu默认下载的inxi无法获取天气，需要将/etc/inxi.conf中的允许更新改为true. 执行sudo inxi -U 更新inxi软件，更新成功后即可正常使用 |
