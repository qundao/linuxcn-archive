...
date_updated: 2022-10-08 14:39:14
slug: article-15116-1.html
url: https://linux.cn/article-15116-1.html
url_from: https://news.itsfoss.com/no-pop-os-21-10/
image: album/202210/08/143915vpfvlqmqfumvqqvb.png
tags:
  - cosmic
categories:
  - 新闻
...
|   index | 日期                | 日期                                             | 评论                                                                                                                                                                                                                                        |
|--------:|:--------------------|:-------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2022-10-08 16:35:14 | 来自英国的 Firefox 91.0-Windows 10 用户          | `是将要完工时，系统不小心把桌面环境删了吧`                                                                                                                                                                                                  |
|       1 | 2022-10-10 10:44:16 | 来自湖北武汉的 Chrome 106.0-Windows 10 用户      | `看上面的效果截图，应该也是基于gtk3或gtk4构建的ui，强调rust无非是通过rust去调用gtk的c api。如果这么喜欢为rust构建生态，不如尝试让rust直接从底层构建ui toolkit，不过底层无论是直接基于x11还是类似skia这样的，也都还是c，同样要调用大量c api` |
|       2 | 2022-10-19 20:30:53 | 来自223.104.39.91的 Firefox 105.0-GNU/Linux 用户 | `现在已经说不基于 GTK3 / 4 了，而是要基于 Rust 原生的 GUI 库 iced`                                                                                                                                                                          |
