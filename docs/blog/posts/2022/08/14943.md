...
date_updated: 2022-08-18 17:17:00
slug: article-14943-1.html
url: https://linux.cn/article-14943-1.html
url_from: https://opensource.com/article/22/8/screenshots-linux
image: album/202208/18/172307e5du1dxqd66d66cm.jpg
tags:
  - 截图
  - 截屏
categories:
...
|   index | 日期                | 日期                                       | 评论                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
|--------:|:--------------------|:-------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2022-08-18 21:54:26 | 来自四川南充的 Opera 80.0-Windows 10 用户  | `还以为有啥不知道的截图方法呢，点进去一看还是车轱辘话。Linux 上各种截屏软件：<br /> <br /> + CoreShot<br /> + Deepin Screenshot<br /> + Escrotum<br /> + Flameshot<br /> + GNOME Screenshot<br /> + grim<br /> + gscreenshot<br /> + HotShots<br /> + imgur-screenshot<br /> + ksnip<br /> + Lightscreen<br /> + LXQt Screenshot<br /> + maim<br /> + MATE Screenshot<br /> + menyoki<br /> + mss<br /> + Pantheon Screenshot<br /> + ScreenCloud<br /> + ScreenGrab<br /> + Scrot<br /> + Shotgun<br /> + Shutter<br /> + Spectacle<br /> + Xfce4 Screenshooter<br /> + xwd` |
|       1 | 2022-08-29 12:25:15 | 来自亚太地区的 Chrome 104.0-GNU/Linux 用户 | `flameshot 也不错`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
