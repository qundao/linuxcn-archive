...
date_updated: 2022-04-07 16:39:00
slug: article-14442-1.html
url: https://linux.cn/article-14442-1.html
url_from: https://www.debugpoint.com/2022/03/gnome-files-43/
image: album/202204/07/163919x7t2hbblzmthmjfk.jpg
tags:
  - gnome
  - 文件管理器
categories:
...
> 我们测试了 GNOME “文件” v43 的开发版本，在这里将向你深入披露其外观、功能和性能的细节。
...
|   index | 日期                | 日期                                             | 评论                                                                                                                                                                                                                                                                                                                                                                            |
|--------:|:--------------------|:-------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2022-04-07 17:41:37 | 来自四川的 Chrome 100.0|Mac 11.15 用户           | GTK2、GTK3&nbsp;&nbsp;的包有一大堆，现在 GTK4 又来了，子孙同堂啊。                                                                                                                                                                                                                                                                                                              |
|       1 | 2022-04-07 17:47:43 | 来自四川的 Chrome 101.0|Mac 10.1 用户            | QT4 基本上算是死了，用 QT6 的软件还非常的少，现在几乎还是 QT5 的天下。                                                                                                                                                                                                                                                                                                          |
|       2 | 2022-04-07 19:29:51 | 来自河北沧州的 Chrome 90.0|GNU/Linux 用户        | 包括linux开发者也没几个用linux作为日常桌面，都是跑在虚拟机里的，文件一多，就卡成狗了。                                                                                                                                                                                                                                                                                          |
|       3 | 2022-04-07 21:41:50 | 来自四川的 Nokia Browser 7.3|Symbian^3 Anna 用户 | 不不不，只是你的机子配置太渣了，处理过几十万个文件的表示一点都不卡                                                                                                                                                                                                                                                                                                              |
|       4 | 2022-04-08 10:40:09 | 来自河北沧州的 Chrome 100.0|Windows 10 用户      | 几十万个文件？300个单个10G的mov 8k视频开缩略图预览， 玩过再来吹牛逼。                                                                                                                                                                                                                                                                                                           |
|       5 | 2022-04-08 15:06:06 | 来自台湾的 Firefox 99.0|GNU/Linux 用户           | 这种任务windows也够呛吧                                                                                                                                                                                                                                                                                                                                                         |
|       6 | 2022-04-09 09:28:57 | 来自四川的 Chrome 99.0|Mac 10.10 用户            | 开缩略图预览，用啥都卡，处理大量文件还开这功能，傻了吧唧的                                                                                                                                                                                                                                                                                                                      |
|       7 | 2022-04-14 11:42:44 | 来自河北沧州的 Chrome 100.0|Windows 10 用户      | 网上不能讨论问题，全是喷子                                                                                                                                                                                                                                                                                                                                                      |
|       8 | 2022-05-10 17:27:55 | 来自浙江杭州的 Chrome 101.0|Windows 10 用户      | 跑虚拟机里当然他妈的卡了                                                                                                                                                                                                                                                                                                                                                        |
|       9 | 2022-05-15 13:29:03 | 来自美国的 Chrome 99.101|GNU/Linux 用户          | 「没有从上下文菜单中创建一个新文件（文本、电子表格等）的选项」其實是有的，Nautilus的新建文件是依賴於home下的「模版」文件夾的，你可以將任何空白文件添加到 ~/模版 文件夾下，然後就可以在右鍵-新增文件看到它了，在「新增文件」的選項中不會顯示擴展名，只會顯示文件名。他的原理是從「模版」文件夾複製一份到你要創建的目錄，你甚至可以把常用的模版，例如合同的模版很方便的添加到右鍵 |
|      10 | 2023-01-13 11:20:03 | 来自山东的 Chrome 108.0|Windows 10 用户          | 捕捉云                                                                                                                                                                                                                                                                                                                                                                          |
