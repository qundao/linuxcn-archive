...
|       4 | 2023-02-14 12:03:29 | 来自浙江金华的 Chrome 110.0-GNU/Linux 用户  | `非常推荐这个系统。第一安装前必须要插上耳机，不然安装以后会外放有声音耳机无声，解决难度不是一般大。<br /> 第二死机黑屏都是显卡驱动引起的，建议在linux mint ubuntu下安装测试稳定以后再安装这个版本。因为这个版本没有驱动管理。` |
|       5 | 2023-02-14 12:03:31 | 来自浙江金华的 Chrome 110.0-GNU/Linux 用户  | `非常推荐这个系统。第一安装前必须要插上耳机，不然安装以后会外放有声音耳机无声，解决难度不是一般大。<br /> 第二死机黑屏都是显卡驱动引起的，建议在linux mint ubuntu下安装测试稳定以后再安装这个版本。因为这个版本没有驱动管理。` |
