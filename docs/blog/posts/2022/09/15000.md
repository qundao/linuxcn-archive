...
|       1 | 2022-09-06 00:00:27 | 来自湖北武汉的 Firefox 104.0|Windows 10 用户                  | 有一件事想说：前几天在B站上看到了一个视频：主要内容是讲述如何给刚上大学的大学生挑选电脑：其中绝大多数都是推荐Windows系统的PC，最犀利的一句话是：如果你还在Windows和mac之间犹豫，那就说明你不需要mac。但是这也说明了软件生态的重要性。在国外可能GNU+Linux能非常火热，但是在国内的教育工具普遍还是依赖Windows的情况下，使用Linux作为日常的操作系统还是十分困难的。<br /> |
