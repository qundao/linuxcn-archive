...
date_updated: 2022-07-29 07:51:00
slug: article-14873-1.html
url: https://linux.cn/article-14873-1.html
url_from: https://news.itsfoss.com/debian-non-free/
image: album/202207/29/075143o0jogujivuigw05s.jpg
tags:
  - debian
  - 固件
categories:
...
|   index | 日期                | 日期                                   | 评论                                                                                                                                                                                                                                                                |
|--------:|:--------------------|:---------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2022-07-29 13:58:06 | 来自湖南的 Firefox 91.0|GNU/Linux 用户 | 先以自由包的标准创建一个非官方的测试包，专用于管理自由/非自由固件之间的顺利切换；可以解决许多用户的实际问题，不外乎就是显卡网卡驱动；但不必把它包含在官方镜像里，许多用户就是看重官方自由镜像，并愿意在此基础上加装个别闭源驱动的，只要简化这个需求的学习成本就好。 |
