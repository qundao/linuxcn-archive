...
|       1 | 2022-06-19 23:34:45 | 来自上海的 Chrome 102.0|Windows 10 用户     | 启用 RPM Fusion 软件源用的是yum的命令，可以改成dnf。<br />                                           |
|         |                     |                                             | 官方提供的也是dnf                                                                                           |
|       2 | 2022-06-22 10:12:57 | 来自四川成都的 Chrome 102.0|Windows 10 用户 | 有一个不是那么重要的配置，但是我觉得可以考虑配置一下:<br />                                          |
