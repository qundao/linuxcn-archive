...
date_updated: 2022-06-19 09:25:00
slug: article-14728-1.html
url: https://linux.cn/article-14728-1.html
url_from: https://www.insidentally.com/articles/000028/
image: album/202206/19/092500aruw5nlz5z5weesa.jpg
tags:
  - fedora
categories:
  - 技术
...
|   index | 日期                | 日期                                        | 评论                                                                                                                      |
|--------:|:--------------------|:--------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------|
|       0 | 2022-06-19 16:38:17 | 来自陕西西安的 Chrome 102.0-GNU/Linux 用户  | `丰富的本地源是最后的希望！！！`                                                                                          |
|       1 | 2022-06-19 23:34:45 | 来自上海的 Chrome 102.0-Windows 10 用户     | `启用 RPM Fusion 软件源用的是yum的命令，可以改成dnf。<br /> 官方提供的也是dnf`                                            |
|       2 | 2022-06-22 10:12:57 | 来自四川成都的 Chrome 102.0-Windows 10 用户 | `有一个不是那么重要的配置，但是我觉得可以考虑配置一下:<br /> 在$HOME/.config/user.dir 下可以配置家目录下默认文件夹的名字` |
|       3 | 2022-08-27 15:37:26 | 来自广西桂林的 Firefox 102.0-GNU/Linux 用户 | `涉及大量软件更新的升级建议用sudo dnf offline-upgrade &lt;download - reboot&gt;，防止升级时发生意外。`                    |
|       4 | 2022-11-01 07:15:21 | 来自英国的 Firefox 106.0-GNU/Linux 用户     | `F35开始自带power-profiles-daemon，跟tlp是冲突的，再装一个tlp只会更耗电`                                                  |
|       5 | 2023-02-14 16:31:14 | 来自山西临汾的 Firefox 109.0-GNU/Linux 用户 | `tlp赞一个，对笔记本电池是真的友好`                                                                                       |
