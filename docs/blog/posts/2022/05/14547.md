...
|       2 | 2022-05-07 15:47:48 | 来自四川成都的 Firefox 101.0|Windows 10 用户      | 个人觉得，用户贡献程序高的发行版最适合程序员，提名 Arch Linux。<br />                                                                                             |
|         |                     |                                                   | <br />                                                                                                                                                            |
|         |                     |                                                   | 很多时侯，官方仓库中的软件是不能满足需求的，得安装些第三方软件。但很多软件只提供源码，或者只编译一下，不对各发行版打包，或者只对一两个发行版打包。                                                                                         |
|       3 | 2022-05-07 15:55:45 | 来自四川成都的 Firefox 100.0|Windows 10 用户      | 像 CentOS / Ubuntu，虽然资料的确很多，但一些软件安装教程都是在教你编译前先装哪些依赖，编译参数有哪些，编译这玩意玩一两次就熟悉了。<br />                          |
|         |                     |                                                   | <br />                                                                                                                                                            |
|         |                     |                                                   | 唯独没有人写个编译脚本、打个包出来供下载，Arch Linux 的 AUR 有 79717 个软件包的构建脚本，更有很多很多个人维护的软件源（见：wiki.archlinux.org/title/User_repo）。                                                     |
|       4 | 2022-05-07 16:09:00 | 来自四川成都的 Firefox 98.0|Windows 10 用户       | 其它发行版倒也有社区源，但维护及时度和包数量差很远。<br />                                                                                                        |
|         |                     |                                                   | <br />                                                                                                                                                            |
|         |                     |                                                   | 而且似乎很多发行版的社区源都没有进各镜像站，但 Arch Linux 有三个社区源（arch4edu、archlinuxarm、archlinuxcn）进了各镜像站的。                                                                              |
...
|       7 | 2023-02-18 13:14:18 | 来自美国的 Firefox 109.0|Windows 10 用户          | NixOS用户路过，非常适合程序员，缺点是太小众，门槛较高。<br />                                                                                                     |
