...
|       3 | 2022-05-13 16:29:48 | 来自浙江台州的 Firefox 78.0|GNU/Linux 用户   | apt install -y&nbsp;&nbsp;smplayer&nbsp;&nbsp;mpv libmpv-dev mencoder<br />                        |
|         |                     |                                              | apt install -y&nbsp;&nbsp;x264 libx264-dev h264enc x265 libx265-dev libde265-dev libde265-0 <br /> |
|         |                     |                                              | apt install -y&nbsp;&nbsp;gstreamer1.0-alsa&nbsp;&nbsp;gstreamer1.0-pulseaudio<br />               |
|         |                     |                                              | apt install -y&nbsp;&nbsp;gstreamer1.0-libav&nbsp;&nbsp;<br />                                     |
|         |                     |                                              | apt install -y&nbsp;&nbsp;gstreamer1.0-tools <br />                                                |
|         |                     |                                              | apt install -y&nbsp;&nbsp;gstreamer1.0-plugins-good&nbsp;&nbsp;<br />                              |
|         |                     |                                              | apt install -y&nbsp;&nbsp;gstreamer1.0-plugins-bad&nbsp;&nbsp;<br />                               |
|         |                     |                                              | apt install -y&nbsp;&nbsp;gstreamer1.0-plugins-base&nbsp;&nbsp;gstreamer1.0-plugins-ugly           |
