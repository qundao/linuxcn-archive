...
date_updated: 2022-05-25 11:29:28
slug: article-14634-1.html
url: https://linux.cn/article-14634-1.html
url_from: https://opensource.com/article/22/5/use-sudo-linux
image: album/202205/25/112907rfzfc3gqppx8p61n.jpg
tags:
  - root
  - su
  - sudo
...
|   index | 日期                | 日期                                         | 评论                                                                                                                                                                        |
|--------:|:--------------------|:---------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2022-05-25 12:49:33 | 来自浙江宁波的 Firefox 100.0|Windows 10 用户 | 我用doas替代sudo,结果很多软件都是会提斯我用sudo解决权限的问题，这是跟sudo深度捆绑了嘛？注意安全的unix和linux默认市没有sudo的。如果sudo是安全的，就会成为POSIX标准的一部分！ |
