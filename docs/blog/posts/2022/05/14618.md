...
date_updated: 2022-05-20 15:45:38
slug: article-14618-1.html
url: https://linux.cn/article-14618-1.html
url_from: ''
image: album/202205/20/154430b9a0mvigzpj9gj0v.jpg
tags:
  - 安全漏洞
  - 白帽黑客
  - 谷歌
...
> • 美国司法部修订反黑客法律，将不对白帽黑客追究责任 • 2 个严重程度为 9.8 级的漏洞正在被利用！ • 谷歌宣布开源卸载友好协议 PSP
...
之前我们 [报道](https://linux.cn/article-14574-1.html) 过 F5 的 BIG-IP 防火墙有一个评分为 9.8（满分为 10）的漏洞正在被利用，F5 已经提供了相关补丁。而更早一些时候，VMware 多个产品系列的未修补版本也被发现存在 9.8 级的安全漏洞。这两个漏洞使攻击者有能力远程执行恶意代码或命令，并以不受约束的 root 系统权限运行。而根据披露的补丁，攻击者可以很快就开发出相关的攻击代码，并将其积极投入利用。
