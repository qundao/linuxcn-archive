...
date_updated: 2022-03-25 11:58:00
slug: article-14394-1.html
url: https://linux.cn/article-14394-1.html
url_from: https://github.com/LCTT/Articles/pull/8
image: album/202203/25/115607eqtmmuuiklimazqt.jpg
tags:
  - linux
categories:
  - 技术
...
> “用户态 Linux” 是什么？它是一种可以在用户态运行的 Linux 内核。
...
|   index | 日期                | 日期                                              | 评论                                                                                                         |
|--------:|:--------------------|:--------------------------------------------------|:-------------------------------------------------------------------------------------------------------------|
|       0 | 2022-03-25 12:23:50 | 来自四川自贡的 Chrome 85.0-Windows 7 用户         | `创建大的空文件时，可以用 fallocate 替代 dd，速度更快，一瞬间的事。<br /> <br /> fallocate -l 2GiB ./rootfs` |
|       1 | 2022-03-27 18:52:20 | 来自山东潍坊的 Chrome Mobile 92.0-Android 10 用户 | `这个用的是 truncate 扩大文件的吗`                                                                           |
