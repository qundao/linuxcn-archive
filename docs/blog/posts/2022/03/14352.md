...
|       6 | 2022-03-13 13:16:14 | 来自四川的 Internet Explorer 22.0-GNU/Linux 用户 | `UA 是可以改的。<br /> <br /> Chrome 可以安装 'User-Agent Switcher and Manager' 这款扩展修改 UA。`                                                                                       |
...
|      11 | 2022-03-13 19:42:47 | 来自四川的 Chrome 91.0-Mac 10.15 用户            | `在低内存机子上，内存占用大的确会影响到体验 (一般来说，低内存的机子配置也可能会较低)。<br /> <br /> 32G 内存表示，这点占用无所谓 (KDE 会自启一些无用的服务，关闭后会降低一些内存占用)。` |
|      12 | 2022-06-24 21:07:07 | 来自上海的 Chrome 102.0-GNU/Linux 用户           | `KDE YYDS!<br /> 我也不怎么喜欢gnome,而且gnome动画开头总是比较卡<br /> <br /> 但当今世界上最好的几个发行版不是“Debian,Arch”吗<br /> <br /> 不知道啥时候 debian testing更新kde 5.25`      |
