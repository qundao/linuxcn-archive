...
date_updated: 2019-03-17 09:26:42
slug: article-10624-1.html
url: https://linux.cn/article-10624-1.html
url_from: https://www.linux.com/blog/learn/2019/2/all-about-curly-braces-bash
image: album/201903/17/092645rcem688e5m583tpc.jpg
tags:
  - 花括号
categories:
  - 技术
...
花括号在之前的《[点的含义](https://linux.cn/article-10465-1.html)》这篇文章中已经出现过了，当时我们只对点号 `.` 的用法作了介绍。但在构建一个序列的过程中，同样不可以缺少花括号。
...
|   index | 日期                | 日期                                       | 评论         |
|--------:|:--------------------|:-------------------------------------------|:-------------|
|       0 | 2019-03-17 11:49:59 | 来自安徽阜阳的 Firefox 65.0|GNU/Linux 用户 | 好文章！mark |
