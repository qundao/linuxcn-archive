...
date_updated: 2019-03-04 01:49:50
slug: article-10587-1.html
url: https://linux.cn/article-10587-1.html
url_from: https://www.linux.com/blog/learn/2019/2/and-ampersand-and-linux
image: album/201903/04/014953jqxs74t33www3tdw.png
tags:
  - 命令行
categories:
  - 技术
...
如果阅读过我之前的三篇文章（[1](https://linux.cn/article-10465-1.html)、[2](https://linux.cn/article-10502-1.html)、[3](https://linux.cn/article-10529-1.html)），你会觉得掌握连接各个命令之间的连接符号用法也是很重要的。实际上，命令的用法并不难，例如 `mkdir`、`touch` 和 `find` 也分别可以简单概括为“建立新目录”、“更新文件”和“在目录树中查找文件”而已。
