...
date_updated: 2019-03-20 22:15:26
slug: article-10636-1.html
url: https://linux.cn/article-10636-1.html
url_from: https://opensource.com/article/19/1/productivity-tool-cryptpad
image: album/201903/20/221532o83zd9s89ypl9eq2.jpg
tags:
  - 笔记
categories:
  - 分享
...
|   index | 日期                | 日期                                       | 评论                                                                                                                                                                                                                                                                                                   |
|--------:|:--------------------|:-------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2019-03-21 10:01:45 | 来自浙江杭州的 Chrome 74.0-Windows 10 用户 | `为啥推广不开，可能就是因为操作不友好的原因，看了下sourceforce的，2015年的。反正我还没找到安装手册，以及下载位置，`                                                                                                                                                                                    |
|       1 | 2019-03-21 16:00:47 | PTLin [Firefox 66.0-GNU/Linux]             | `你好<br /> 这个软件的GitHub repository在这里：https://github.com/xwiki-labs/cryptpad<br /> 软件安装指南在这里：https://github.com/xwiki-labs/cryptpad/wiki/Installation-guide<br /> Docker Image使用构建和使用方法在这里：https://github.com/xwiki-labs/cryptpad/blob/master/docs/cryptpad-docker.md` |
