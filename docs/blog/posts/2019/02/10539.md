...
date_updated: 2019-02-15 10:26:00
slug: article-10539-1.html
url: https://linux.cn/article-10539-1.html
url_from: https://opensource.com/article/19/1/productivity-tool-taskboard
image: album/201902/15/102622fqth2o5tcthqqovp.png
tags:
  - 看板
categories:
  - 分享
...
正如我在本系列的[第二篇文章](https://linux.cn/article-10454-1.html)中所写的那样，[看板](https://en.wikipedia.org/wiki/Kanban)现在非常受欢迎。但并非所有的看板都是相同的。[TaskBoard](https://taskboard.matthewross.me/) 是一个易于在现有 Web 服务器上部署的 PHP 应用，它有一些易于使用和管理的功能。
