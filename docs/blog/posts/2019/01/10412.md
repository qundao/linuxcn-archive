...
date_updated: 2019-01-04 09:48:37
slug: article-10412-1.html
url: https://linux.cn/article-10412-1.html
url_from: https://opensource.com/article/18/12/linux-toy-youtube-dl
image: album/201901/04/094842dm9jhmg99meolcqm.png
tags:
  - 终端
  - 视频
categories:
...
今天我们要在昨天的玩具 [MPlayer](https://linux.cn/article-10393-1.html) 上再加上一个 [youtube-dl](https://rg3.github.io/youtube-dl/)。
...
如果你昨天没有安装 [MPlayer](https://linux.cn/article-10393-1.html)，请继续安装好，如果你之前没有安装 libcaca 则需要安装它。如果你直接用 MPlayer 在命令行中播放视频 ( `$ mplayer fireplace.webm` )，它能够播放，但是会在一个自己的窗口中，这不是我们想要的。
...
一定要看看昨天的玩具，[在 Linux 终端收听广播](https://linux.cn/article-10393-1.html)，明天还要再来！
