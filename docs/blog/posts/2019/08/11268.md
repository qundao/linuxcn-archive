...
date_updated: 2019-08-25 22:02:00
slug: article-11268-1.html
url: https://linux.cn/article-11268-1.html
url_from: https://opensource.com/article/18/12/podman-and-user-namespaces
image: album/201908/25/220204khh9psjo1phllkok.jpg
tags:
  - podman
  - 容器
categories:
...
[Podman](https://podman.io/) 是 [libpod](https://github.com/containers/libpod) 库的一部分，使用户能够管理 pod、容器和容器镜像。在我的上一篇文章中，我写过将 [Podman 作为一种更安全的运行容器的方式](https://linux.cn/article-11261-1.html)。在这里，我将解释如何使用 Podman 在单独的用户命名空间中运行容器。
