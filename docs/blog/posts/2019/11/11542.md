...
date_updated: 2019-11-06 11:02:00
slug: article-11542-1.html
url: https://linux.cn/article-11542-1.html
url_from: https://www.2daygeek.com/linux-find-top-memory-consuming-processes/
image: album/201911/06/110149r81efjx12afjat7f.jpg
tags:
  - 内存
categories:
  - 技术
...
Linux 的 `top` 命令是用来监视 Linux 系统性能的最好和最知名的命令。它在交互界面上显示运行的系统进程的实时视图。但是，如果要查找内存消耗最大的进程，请 [在批处理模式下使用 top 命令](https://linux.cn/article-11491-1.html)。
