...
date_updated: 2019-11-21 08:16:06
slug: article-11598-1.html
url: https://linux.cn/article-11598-1.html
url_from: https://itsfoss.com/zfs-ubuntu/
image: album/201911/21/081609la0a7c7kpypppkt8.jpg
tags:
  - zfs
categories:
  - 技术
...
Ubuntu 19.10 的主要新特性之一就是 [ZFS](https://linux.cn/article-10034-1.html)。现在你可以很容易的无需额外努力就可以在 Ubuntu 系统上安装 ZFS了。
...
我写过一个文章详细介绍 [什么是 ZFS以及它有哪些特性](https://linux.cn/article-10034-1.html)。如果你感兴趣可以去阅读下。
...
|   index | 日期                | 日期                                       | 评论                                                                    |
|--------:|:--------------------|:-------------------------------------------|:------------------------------------------------------------------------|
|       0 | 2019-11-21 19:38:11 | 来自日本的 Chrome Mobile 78.0-Android 用户 | `注意一个最重要的点：<br /> zfs无法移除硬盘，只能替换。这点和btrfs不同` |
