...
> 如果你想从第九级目录回到第三级目录，那么使用 cd 命令是很糟糕的。
> 有什么解决方案呢？
...
|   index | 日期                | 日期                                               | 评论                                 |
|--------:|:--------------------|:---------------------------------------------------|:-------------------------------------|
|       0 | 2019-04-08 23:49:57 | 来自河南开封的 Chrome Mobile 72.0-Android 8.0 用户 | `用了bd.zsh&nbsp;&nbsp;感觉挺方便的` |
