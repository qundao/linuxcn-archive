...
date_updated: 2019-07-24 09:11:04
slug: article-11142-1.html
...
image: album/201907/24/091111leufqj6vujuu9evz.png
tags:
  - sudo
categories:
  - 技术
...
> 正如名字暗示的那样，你无论何时用大写字母输入 Linux 命令，SUDO 程序都会将它们作为 sudo 用户运行！这意味着，你无需在要运行的 Linux 命令前面输入 sudo。
...
|   index | 日期                | 日期                                  | 评论                         |
|--------:|:--------------------|:--------------------------------------|:-----------------------------|
|       0 | 2019-07-29 16:30:30 | 来自北京的 Chrome 70.0|Windows 7 用户 | 还需要按shift或CapsLook 麻烦 |
