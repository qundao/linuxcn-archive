...
date_updated: 2019-07-19 05:42:57
slug: article-11120-1.html
url: https://linux.cn/article-11120-1.html
url_from: https://opensource.com/article/19/7/cross-compiling-gcc
image: album/201907/19/054242nwhludz9tm2lwd8t.jpg
tags:
  - gcc
  - 编译
categories:
...
|   index | 日期                | 日期                                       | 评论                                                                                                                                               |
|--------:|:--------------------|:-------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2019-10-26 11:42:03 | 来自广东东莞的 Chrome 77.0-Windows 10 用户 | `其实有个小小小问题：<br /> 在ubuntu上使用arm-linux-gnueabi-gcc命令，所需要安装的软件包为apt-get install gcc-arm-linux-gnueabi<br /> （找了半天）` |
|       1 | 2019-10-26 11:42:08 | 来自广东东莞的 Chrome 77.0-Windows 10 用户 | `其实有个小小小问题：<br /> 在ubuntu上使用arm-linux-gnueabi-gcc命令，所需要安装的软件包为apt-get install gcc-arm-linux-gnueabi<br /> （找了半天）` |
