...
date_updated: 2019-06-08 21:57:00
slug: article-10951-1.html
...
image: album/201906/08/215622oqdhiuhocsndijlu.jpg
tags:
  - ntp
categories:
  - 系统运维
...
* [如何在 Linux 上安装、配置 NTP 服务器和客户端？](https://linux.cn/article-10811-1.html)
* [如何安装和配置 Chrony 作为 NTP 客户端？](https://linux.cn/article-10820-1.html)
...
|   index | 日期                | 日期                                        | 评论   |
|--------:|:--------------------|:--------------------------------------------|:-------|
|       0 | 2019-07-10 09:17:56 | 来自北京的 Firefox 67.0-Windows 10 用户     | `good` |
|       1 | 2022-06-27 14:49:30 | 来自江苏泰州的 Chrome 100.0-Windows 10 用户 | `good` |
