...
date_updated: 2019-06-05 00:51:40
slug: article-10939-1.html
url: https://linux.cn/article-10939-1.html
url_from: https://opensource.com/article/19/3/mobile-particulate-matter-sensor
image: album/201906/05/005121bbveeavwgyc1i1gk.jpg
tags:
  - pm2.5
  - 树莓派
  - 颗粒物
...
大约一年前，我写了一篇关于如何使用树莓派和廉价传感器测量[空气质量](https://linux.cn/article-9620-1.html)的文章。我们这几年已在学校里和私下使用了这个项目。然而它有一个缺点：由于它基于无线/有线网，因此它不是便携的。如果你的树莓派、你的智能手机和电脑不在同一个网络的话，你甚至都不能访问传感器测量的数据。
...
首先，安装树莓派的[PIXEL 桌面环境](https://linux.cn/article-8459-1.html)：
...
我对去年的代码做了些小修改。因此如果你之前搭建过空气质量项目，确保用[原文章](https://linux.cn/article-9620-1.html)中的指导为 AQI 网站重新下载脚本和文件。
