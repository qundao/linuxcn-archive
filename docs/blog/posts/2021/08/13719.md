...
|       2 | 2021-08-26 20:54:15 | 来自广西桂林的 Chrome Mobile 92.0|Android 10 用户 | 之前装 Manjaro GNOME 时默认用的是 Wayland，结果不小心整出了 bug，shell 基本用不了，Alt + F2 输 r 提示 Wayland 会话不支持重启 GNOME Shell，从此 Wayland 是路人<br /> |
|         |                     |                                                   | —— imgradeone                                                                                                                                                       |
