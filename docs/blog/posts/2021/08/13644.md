...
date_updated: 2021-08-03 13:28:29
slug: article-13644-1.html
url: https://linux.cn/article-13644-1.html
url_from: https://opensource.com/article/21/7/cron-linux
image: album/202108/03/132733qhmt6mavtbh66m5j.jpg
tags:
  - cron
  - crontab
categories:
...
> cron 定时器是一个可以按照计划自动运行命令的工具。 定时器是一个可以按照计划自动运行命令的工具。
