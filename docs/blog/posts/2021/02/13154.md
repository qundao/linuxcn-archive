...
date_updated: 2021-02-26 11:31:33
slug: article-13154-1.html
url: https://linux.cn/article-13154-1.html
url_from: https://fedoramagazine.org/latex-typesetting-part-3-formatting/
image: album/202102/26/113031wattha0hojj4f4ej.png
tags:
  - latex
categories:
  - 技术
...
本 [系列](https://fedoramagazine.org/tag/latex/) 介绍了 LaTeX 中的基本格式。[第 1 部分](https://linux.cn/article-13112-1.html) 介绍了列表。[第 2 部分](https://linux.cn/article-13146-1.html) 阐述了表格。在第 3 部分中，你将了解 LaTeX 的另一个重要特性：细腻灵活的文档排版。本文介绍如何自定义页面布局、目录、标题部分和页面样式。
