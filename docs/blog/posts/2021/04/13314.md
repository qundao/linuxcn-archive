...
|   index | 日期                | 日期                                                  | 评论                                                                                                                                                                                                                                                                        |
|--------:|:--------------------|:------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2021-04-21 09:28:38 | 来自天津的 Chrome 90.0-GNU/Linux 用户                 | `qh-ydj@qhydj-ThinkPad-T410:~$ sudo apt install scrcpy<br /> [sudo] qh-ydj 的密码： <br /> 正在读取软件包列表... 完成<br /> 正在分析软件包的依赖关系树&nbsp; &nbsp;&nbsp; &nbsp; <br /> 正在读取状态信息... 完成&nbsp; &nbsp;&nbsp; &nbsp; <br /> E: 无法定位软件包 scrcpy` |
