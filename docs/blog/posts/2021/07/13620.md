...
date_updated: 2021-07-27 08:30:10
slug: article-13620-1.html
url: https://linux.cn/article-13620-1.html
url_from: https://opensource.com/article/21/7/dnf-vs-apt
image: album/202107/27/083002sd5zzxu37yhiz6yc.jpg
tags:
  - apt
  - dnf
  - 包管理器
...
|   index | 日期                | 日期                                      | 评论                                                                                                                                  |
|--------:|:--------------------|:------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2021-07-27 10:59:22 | 来自陕西西安的 Chrome 90.0-GNU/Linux 用户 | `我觉得将很多软件组件包集合积累到发行ISO里给用户能给用户带来应用部署的真正方便。尤其在没有网络得环境里！！！`                         |
|       1 | 2021-07-27 22:56:23 | 来自上海的 Chrome 92.0-Mac 10.15 用户     | `按照我的理解，已经尽力集成了。<br /> 以往分CD和DVD版本，也是按照CD和DVD的最大容量。<br /> <br /> 现在网络快了，这么做的意义不大了。` |
|       2 | 2021-07-27 23:00:50 | 来自上海的 Chrome 92.0-Mac 10.15 用户     | `我觉得软件包、软件包管理器，还有各种镜像，是人类历史上的伟大工程。<br /> 致敬。`                                                     |
|       3 | 2021-07-31 18:20:33 | 白栋毅 [Chrome 92.0-Windows 10]           | `是啊，只是方便分几个文件下载`                                                                                                        |
|       4 | 2021-07-31 18:21:41 | 白栋毅 [Chrome 92.0-Windows 10]           | `还记得2003年安装RH9的时候，3个CD里的RPM有时候不够用，需要在网上找.rpm文件。然后自己 rpm -ivh 来安装，然后就开始依赖噩梦！`           |
|       5 | 2021-08-04 13:40:38 | 来自河南郑州的 Chrome 90.0-GNU/Linux 用户 | `应该算到开源界的伟大工程，也是Linux普及的基础`                                                                                       |
|       6 | 2021-08-07 23:17:32 | plus2z [Chrome 92.0-Windows 10]           | `好久没用Ubuntu，以前一直都是绑着-get一起用。现在是简化了嘛`                                                                          |
