...
date_updated: 2021-09-25 08:40:00
slug: article-13817-1.html
url: https://linux.cn/article-13817-1.html
url_from: https://itsfoss.com/install-ubuntu-desktop-raspberry-pi/
image: album/202109/25/084015z4cfiiy8e1ezmmz0.jpg
tags:
  - ubuntu
  - 树莓派
categories:
...
|   index | 日期                | 日期                                          | 评论                                       |
|--------:|:--------------------|:----------------------------------------------|:-------------------------------------------|
|       0 | 2021-10-22 07:58:14 | 来自210.12.30.86的 Chrome 94.0-Mac 10.15 用户 | `实用`                                     |
|       1 | 2022-04-02 15:09:37 | 来自广东的 Chrome 99.0-Windows 10 用户        | `技术活，当赏！`                           |
|       2 | 2022-07-20 11:58:49 | 来自陕西汉中的 Chrome 103.0-Windows 10 用户   | `如何通过修改配置文件的方式，配置WiFi连接` |
