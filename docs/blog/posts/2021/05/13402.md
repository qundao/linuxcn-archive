...
date_updated: 2021-05-18 11:00:06
slug: article-13402-1.html
url: https://linux.cn/article-13402-1.html
url_from: https://opensource.com/article/20/5/manage-startup-systemd
image: album/202105/18/105928u3r3593k3z38ly5k.jpg
tags:
  - systemd
  - 启动
categories:
...
你可能知道 SystemV（systemd 的前身，我在这个系列的 [第一篇文章](https://linux.cn/article-12214-1.html) 中解释过）通过 Sxx 前缀命名启动脚本来决定启动顺序，xx 是一个 00-99 的数字。然后 SystemV 利用文件名来排序，然后按照所需的运行级别执行队列中每个启动脚本。
...
|   index | 日期                | 日期                                      | 评论     |
|--------:|:--------------------|:------------------------------------------|:---------|
|       0 | 2021-05-18 17:03:35 | 来自海南海口的 Chrome 90.0|GNU/Linux 用户 | 文章很好 |
