...
date_updated: 2021-05-31 20:15:21
slug: article-13446-1.html
url: https://linux.cn/article-13446-1.html
url_from: https://opensource.com/article/20/11/flutter-lists-mobile-app
image: album/202105/31/201442luk1u6vqz3h3k8jn.jpg
tags:
  - flutter
categories:
  - 软件开发
...
Flutter 是一个流行的开源工具包，它可用于构建跨平台的应用。在文章《[用 Flutter 创建移动应用](https://linux.cn/article-12693-1.html)》中，我已经向大家展示了如何在 Linux 中安装 [Flutter](https://flutter.dev/) 并创建你的第一个应用。而这篇文章，我将向你展示如何在你的应用中添加一个列表，点击每一个列表项可以打开一个新的界面。这是移动应用的一种常见设计方法，你可能以前见过的，下面有一个截图，能帮助你对它有一个更直观的了解：
