...
date_updated: 2021-05-19 11:20:40
slug: article-13404-1.html
url: https://linux.cn/article-13404-1.html
url_from: https://opensource.com/article/21/4/linux-reasons
image: album/202105/19/111929by99711lq1iuz7y1.jpg
tags:
  - linux
categories:
  - 观点
...
不管我周围的用户被限制在什么范围内，我都可以 [自由地使用可以在我的电脑上工作的最好的工具](https://linux.cn/article-13133-1.html)，并且以我希望的方式工作。
...
[Linux 提供了可选择的特性](https://linux.cn/article-13284-1.html)。一个强大的社区，充满了真实的人际关系，结合 Linux 提供的选择自由，所有这些都让用户对他们运行的软件有信心。因为我读过一些源码，也因为我信任哪些维护我没读过的代码的人，[所以我信任 Linux](https://opensource.com/article/21/2/open-source-security)。
...
尝试使用 Linux 来 [创作一些艺术作品](https://linux.cn/article-13157-1.html)。
...
当他们在谈编程的时候，没有人谈封包。作为一个开发者，你必须将你的代码提供给您的用户，否则你将没有任何用户。Linux 使得开发人员可以轻松地 [发布应用程序](https://opensource.com/article/21/2/linux-packaging)，用户也可以轻松地 [安装这些应用程序](https://linux.cn/article-13160-1.html)。
...
不过，你不需要从最顶层开始。你可以学习在笔记本电脑或者台式机上[自动](https://opensource.com/article/21/2/linux-automation)完成任务，并通过一个 [好的终端](https://linux.cn/article-13186-1.html) 远程控制系统。
...
无论你是一个新手系统管理员，还是仅仅是要将一个将文件分发给室友，Linux 都可以使 [文件共享变得轻而易举](https://linux.cn/article-13192-1.html)。
...
[来安装 Linux 吧](https://linux.cn/article-13164-1.html)!
