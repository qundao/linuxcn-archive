...
date_updated: 2018-02-25 09:38:00
slug: article-9383-1.html
url: https://linux.cn/article-9383-1.html
url_from: http://www.linuxjournal.com/content/creating-adventure-game-terminal-ncurses
image: album/201802/25/100828w9xu9oaiyptt8oah.jpg
tags:
  - ncurses
categories:
  - 软件开发
...
我[之前的文章](https://linux.cn/article-9348-1.html)介绍了 ncurses 库，并提供了一个简单的程序展示了一些将文本放到屏幕上的 curses 函数。在接下来的文章中，我将介绍如何使用其它的 curses 函数。
