...
date_updated: 2018-02-04 22:13:00
slug: article-9311-1.html
url: https://linux.cn/article-9311-1.html
url_from: http://linuxtechlab.com/creating-master-slave-replication-mariadb/
image: album/201802/04/221301ve5vvocwioceiz5t.jpg
tags:
  - mariadb
  - 主从复制
  - 数据库
...
在我们前面的教程中，我们已经学习了 [如何安装和配置 MariaDB](https://linux.cn/article-8320-1.html)，也学习了 [管理 MariaDB 的一些基础命令](https://linux.cn/article-9306-1.html)。现在我们来学习，如何在 MariaDB 服务器上配置一个主从复制。
...
MariaDB 安装到这些机器上之后，我们继续进行本教程。如果你需要安装和配置 MariaDB 的教程，请查看[**这个教程**](https://linux.cn/article-8320-1.html)。
