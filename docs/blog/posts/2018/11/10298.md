...
date_updated: 2018-11-30 23:31:44
slug: article-10298-1.html
url: https://linux.cn/article-10298-1.html
url_from: https://kerneltalks.com/howto/how-to-enter-single-user-mode-in-suse-12-linux/
image: album/201811/30/233149a2mpf33zhmclgzmj.png
tags:
  - 单用户
categories:
  - 技术
...
|   index | 日期                | 日期                                      | 评论                                                     |
|--------:|:--------------------|:------------------------------------------|:---------------------------------------------------------|
|       0 | 2020-12-02 18:36:18 | 来自广东深圳的 Chrome 83.0-Windows 7 用户 | `安装完英伟达显卡驱动重启后，图形界面黑屏就一个光标在闪` |
