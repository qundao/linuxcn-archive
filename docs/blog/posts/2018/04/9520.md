...
date_updated: 2018-04-07 10:31:05
slug: article-9520-1.html
url: https://linux.cn/article-9520-1.html
url_from: https://ruslanspivak.com/lsbasi-part2/
image: album/201804/07/103057jm2ojoccjg3jj3ey.jpg
tags:
  - 编译器
  - 解释器
categories:
...
今天我会向你们展示一个全新的计算器，与 [第一部分](https://linux.cn/article-9399-1.html) 相比，它可以做到：
...
与 [第一部分](https://linux.cn/article-9399-1.html) 的版本相比，主要的代码改动有：
...
[第一部分](https://linux.cn/article-9399-1.html) 中你学到了两个重要的概念，叫做 <ruby> 标记 <rt>  token </rt></ruby> 和<ruby> 词法分析 <rt>  lexical analyzer </rt></ruby>。现在我想谈一谈<ruby> 词法 <rt>  lexeme </rt></ruby>、 <ruby> 解析 <rt>  parsing </rt></ruby> 和<ruby> 解析器 <rt>  parser </rt></ruby>。
