...
date_updated: 2018-04-08 19:17:00
slug: article-9528-1.html
url: https://linux.cn/article-9528-1.html
url_from: https://manybutfinite.com/post/page-cache-the-affair-between-memory-and-files/
image: album/201804/08/191716biaoeie8ofpmpbgg.jpg
tags:
  - 内存管理
  - 缓存
categories:
...
上一篇文章中我们学习了内核怎么为一个用户进程 [管理虚拟内存](https://linux.cn/article-9393-1.html)，而没有提及文件和 I/O。这一篇文章我们将专门去讲这个重要的主题 —— 页面缓存。文件和内存之间的关系常常很不好去理解，而它们对系统性能的影响却是非常大的。
