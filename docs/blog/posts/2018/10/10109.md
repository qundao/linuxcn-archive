...
date_updated: 2018-10-12 23:23:11
slug: article-10109-1.html
url: https://linux.cn/article-10109-1.html
url_from: https://opensource.com/article/18/8/first-linux-kernel-patch
image: album/201810/12/232258vhhxss30uszh9fpf.jpg
tags:
  - 内核
  - 补丁
  - 贡献
...
* **Greg Kroah-Hartman** 的 [staging tree](https://www.kernel.org/doc/html/v4.15/process/2.Process.html) 是提交你的 [第一个补丁](https://kernelnewbies.org/FirstKernelPatch) 的最好的地方，因为他更容易接受新贡献者的补丁。在你熟悉了补丁发送流程以后，你就可以去发送复杂度更高的子系统专用的补丁。
...
* 阅读 [归档的内核邮件](mailto:linux-kernel@vger.kernel.org)。
