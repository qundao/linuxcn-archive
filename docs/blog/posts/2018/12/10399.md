...
date_updated: 2018-12-30 19:33:35
slug: article-10399-1.html
url: https://linux.cn/article-10399-1.html
url_from: 
  https://www.linux.com/blog/learn/intro-to-linux/2018/7/users-groups-and-other-linux-beasts-part-2
image: album/201812/30/193339hj9zyiyosbnbdrjo.jpg
tags:
  - 用户
  - 用户组
categories:
...
在正在进行的 Linux 之旅中，我们了解了[如何操作文件夹或目录](https://linux.cn/article-10066-1.html)，现在我们继续讨论 权限、用户 和 组，这对于确定谁可以操作哪些文件和目录是必要的。[上次](https://linux.cn/article-10370-1.html)，我们展示了如何创建新用户，现在我们将重新起航：
...
你需要在根目录下[创建一个目录](https://linux.cn/article-10066-1.html)：
