...
date_updated: 2023-06-23 11:44:00
slug: article-15935-1.html
url: https://linux.cn/article-15935-1.html
url_from: https://itsfoss.com/milestone-rust-program/
image: album/202306/23/114333ni9fkzpykmz37zpu.jpg
tags:
  - rust
categories:
  - 软件开发
...
> 在 Rust 基础系列的最后一章里，让我们现在用 Rust 编写一个程序
...
到目前为止，我们已经讲解了包括 [变量、可变性、常量](https://linux.cn/article-15771-1.html)、[数据类型](https://linux.cn/article-15811-1.html)、[函数](https://linux.cn/article-15855-1.html)、[if-else 语句](https://linux.cn/article-15896-1.html) 和 [循环](https://linux.cn/article-15908-1.html) 在内的一些关于 Rust 编程的基础知识。
...
|   index | 日期                | 日期                                     | 评论              |
|--------:|:--------------------|:-----------------------------------------|:------------------|
|       0 | 2023-06-25 17:06:45 | 来自上海的 Firefox 110.0|Android 10 用户 | clear and concise |
