...
date_updated: 2023-10-19 11:37:26
slug: article-16298-1.html
url: https://linux.cn/article-16298-1.html
url_from: https://itsfoss.com/bash-comments/
image: album/202310/19/113658dld7b9987xa89l99.jpg
tags:
  - bash
  - 注释
  - 现场文档
...
> 
> ? `#` 注释规则的唯一例外是脚本开头的 `#!/bin/bash` 行。它称为 [释伴](https://linux.cn/article-3664-1.html)，用于指定运行脚本时要使用的解释器。有不同的 Shell，语法也可能不同。因此，一个好的做法是指定脚本是为哪个 Shell 编写的。例如，如果是 ksh，则可以使用 `#!/bin/ksh`.
> 
> 
> 
