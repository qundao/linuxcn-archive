...
date_updated: 2023-10-10 22:43:00
slug: article-16273-1.html
url: https://linux.cn/article-16273-1.html
url_from: https://itsfoss.com/gnome-search/
image: album/202310/10/224338y0d7dgqlez0e0nmz.jpg
tags:
  - gnome
  - 搜索
categories:
...
|   index | 日期                | 日期                                               | 评论                                                                                                                                                                                              |
|--------:|:--------------------|:---------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2023-10-11 16:10:59 | 来自广东广州的 Chrome Mobile 116.0-Android 10 用户 | `相当于macOS的Spotlight和Alfred`                                                                                                                                                                  |
|       1 | 2023-10-11 16:20:22 | 来自江苏无锡的 Firefox 118.0-Ubuntu 用户           | `花梢而不实用。。。`                                                                                                                                                                              |
|       2 | 2023-10-12 15:11:59 | 只三言两语 [Firefox 118.0-Ubuntu]                  | `我觉得利用搜索来进行一些日常计算的功能非常好用，这是我之间没有尝试过的。这样比使用计算器更直观，也更方便，以前我都是通过shell或是python来计算的，缺点很显然计算结果要等到按下回车键之后才知道。` |
