...
date_updated: 2023-10-22 08:21:43
slug: article-16307-1.html
url: https://linux.cn/article-16307-1.html
url_from: https://itsfoss.com/ubuntu-install-nix-package-manager/
image: album/202310/22/082116ket5ed87padptmbw.jpg
tags:
  - nix
  - nixos
categories:
...
[人们喜欢使用不可变的 NixOS](https://linux.cn/article-15606-1.html) 的原因之一是它的 Nix 包管理器。

它有超过 80,000 个软件包，这可能与 Debian 软件包的数量相差比较大，但仍然令人印象深刻。

好处是你不必仅仅为了包管理器而 [安装 NixOS](https://linux.cn/article-15624-1.html)。与 [Homebrew](https://linux.cn/article-14065-1.html) 和 Rust 的 [Cargo 包管理器](https://linux.cn/article-13938-1.html) 一样，你可以在当前发行版中使用 Nix 包管理器。
...
> 
> **[NixOS 系列](https://linux.cn/article-15606-1.html)**
> 
> 
> 
