...
date_updated: 2017-01-08 09:35:00
slug: article-8099-1.html
url: https://linux.cn/article-8099-1.html
url_from: https://opensource.com/article/16/11/managing-devices-linux
image: album/201701/07/110422hj9xt9xsfgvvbefs.jpg
tags:
  - 文件系统
  - 设备文件
categories:
...
Linux 目录结构中有很多有趣的功能，这次我会讲到 `/dev` 目录一些迷人之处。在继续阅读这篇文章之前，建议你看看我前面的文章。[Linux 文件系统](https://linux.cn/article-6132-1.html)，[一切皆为文件](https://linux.cn/article-7669-1.html)，这两篇文章介绍了一些有趣的 Linux 文件系统概念。请先看看 - 我会等你看完再回来。
