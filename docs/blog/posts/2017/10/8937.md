...
date_updated: 2017-10-07 22:35:00
slug: article-8937-1.html
url: https://linux.cn/article-8937-1.html
url_from: 
  https://kylewbanks.com/blog/tutorial-opengl-with-golang-part-2-drawing-the-game-board
image: album/201710/07/223453r5tqot1qsp0s6ga6.jpg
tags:
  - golang
  - opengl
categories:
...
欢迎回到《OpenGL 与 Go 教程》。如果你还没有看过[第一节](https://linux.cn/article-8933-1.html)，那就要回过头去看看那一节。
...
|   index | 日期                | 日期                                           | 评论                                                                                                                          |
|--------:|:--------------------|:-----------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2022-04-07 15:05:26 | 来自广东广州的 Sogou Explorer 2-Windows 7 用户 | `makeCells()<br /> 第一行应该是<br /> cells := make([][]*cell, rows, columns)<br /> 建议修改下，虽然结果一样的，这样好理解些` |
