...
date_updated: 2017-06-29 11:31:00
slug: article-8651-1.html
url: https://linux.cn/article-8651-1.html
url_from: 
  http://www.2daygeek.com/powerline-adds-powerful-statusline-to-vim-bash-tumx-in-ubuntu-fedora-debian-arch-linux-mint/
image: album/201706/29/113131dqpqahdfjm9o8hq8.png
tags:
  - powerline
  - 命令行
  - 状态行
...
|   index | 日期                | 日期                                  | 评论                                                                                                                                                 |
|--------:|:--------------------|:--------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2017-06-29 18:15:16 | 来自北京的 Chrome 59.0|GNU/Linux 用户 | 在vim那几张图暴露了，powline在不同字体下很不稳定，很多字体都有对不齐的问题，会上下错位几个像素                                                       |
|       1 | 2017-07-01 11:34:22 | linux [Chrome 58.0|Mac 10.11]         | 嗯，powerline 的字体问题是它最麻烦的地方，其实这篇写的过于简陋了，可以本篇相关的几篇，powerline 的字体安装和配置是个大问题。当然，配置好了就很爽了。 |
