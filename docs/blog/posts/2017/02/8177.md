...
date_updated: 2017-02-05 18:49:00
slug: article-8177-1.html
url: https://linux.cn/article-8177-1.html
url_from: https://opensource.com/article/17/1/solid-state-drives-linux-enabling-trim-ssds
image: album/201702/05/184842xf7yyd74l774yb77.jpg
tags:
  - ssd
  - 磁盘
categories:
...
|   index | 日期                | 日期                                             | 评论                                                                                                                                                                                                         |
|--------:|:--------------------|:-------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2017-02-05 19:10:21 | 来自黑龙江哈尔滨的 Sina Weibo 6.12-iOS 10.2 用户 | `很牛`                                                                                                                                                                                                       |
|       1 | 2017-02-06 06:49:42 | 来自芬兰的 Chrome 55.0-Windows 10 用户           | `可以定期执行fstrim命令，但是不建议在mount / fstab 中使用discard 选项`                                                                                                                                       |
|       2 | 2017-02-06 08:34:33 | linux [Chrome 55.0-Mac 10.11]                    | `原因呢？`                                                                                                                                                                                                   |
|       3 | 2017-02-06 14:31:21 | hsyan2008 [Chrome 55.0-GNU/Linux]                | `为什么呢`                                                                                                                                                                                                   |
|       4 | 2017-02-07 18:22:37 | 来自江苏常州的 Safari-GNU/Linux 用户             | `开启 fstrim.service 比较好一点`                                                                                                                                                                             |
|       5 | 2017-02-08 00:46:40 | 来自湖南长沙的 QQ Browser 9.5-Windows 7 用户     | `大幅影响寿命。`                                                                                                                                                                                             |
|       6 | 2017-02-10 22:36:25 | kashu [Chromium 66.0-Xubuntu 14.04]              | `这老外是道听途说的 -o discard 吧<br /> 你们去原文底下的评论区看看大伙的回复就明白了……<br /> <br /> 原作者的回复要么是Thanks for sharing，要么是Thanks for your comments。<br /> 一点主见也没有，根本不懂……` |
|       7 | 2017-02-11 07:45:14 | 来自河南郑州的 Chrome 51.0-Windows 7 用户        | `因为这个选项要求SSD每次删除文件都进行trim操作，比较号资源，尤其是在文件操作很频繁的时候。所以可以考虑用cron来定期trim`                                                                                      |
|       8 | 2017-03-11 23:27:26 | baby-blue__ [Chrome 56.0-Mac 10.12]              | `不记得在哪里看到过，确实是不建议在fstab上启用discard，定期手动fstrim比较靠谱`                                                                                                                               |
