...
date_updated: 2017-02-09 11:50:00
slug: article-8186-1.html
url: https://linux.cn/article-8186-1.html
url_from: http://www.tecmint.com/check-remote-port-in-linux/
image: album/201702/09/115052qfsnhhyp8i6i8u6w.png
tags:
  - nc
  - netcat
  - 端口
...
我们可以使用 `[netstat](8个实用的netcat命令实例)` 或其他几个 Linux 命令如 [NMAP](https://linux.cn/tag-nmap.html) 在本地机器上轻松地[列出 Linux 中的打开端口](https://linux.cn/article-8081-1.html)。
...
|   index | 日期                | 日期                                      | 评论                                                                                                                                         |
|--------:|:--------------------|:------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2017-02-09 12:23:04 | 来自四川成都的 Chrome 55.0-GNU/Linux 用户 | `&gt; /dev/tcp/DNSNAME_OR_IP/PORT<br /> <br /> 这样可以测 tcp 端口，至于 udp 端口，虽然也可以用，但是受限于协议本身，不能看出端口是否打开。` |
|       1 | 2017-02-09 12:25:13 | 来自四川成都的 Chrome 55.0-GNU/Linux 用户 | `P.S. 译者简介成作者简介了。`                                                                                                                |
|       2 | 2017-02-09 21:40:29 | linux [Chrome 56.0-Mac 10.11]             | `汗，谁干的？！`                                                                                                                             |
|       3 | 2017-02-09 21:41:00 | linux [Chrome 56.0-Mac 10.11]             | `有趣的命令！`                                                                                                                               |
