...
date_updated: 2017-02-15 10:07:00
slug: article-8210-1.html
url: https://linux.cn/article-8210-1.html
url_from: http://fasterland.net/activate-global-menu-kde-plasma-5-9.html
image: album/201702/15/081047mnd5cucm55uocn5d.jpg
tags:
  - kde
  - 全局菜单
categories:
...
|   index | 日期                | 日期                                                | 评论                                                                                                                                                                                 |
|--------:|:--------------------|:----------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2017-02-15 11:20:36 | 来自浙江台州的 Firefox 51.0-Windows 10 用户         | `习惯了 windows 而言全局菜单挺蛋疼，再一个 KDE 本来就是类 windows 的窗口，全局菜单更像是 macOS 以及 gnome 这类的窗口风格。<br /> 所以习惯问题，无所谓好不好了。在我看来根本不需要。` |
|       1 | 2017-02-15 13:00:25 | 来自内蒙古呼和浩特的 QQ Browser 9.5-Windows 10 用户 | `全局菜单很好用吗？非常不理解，求解答`                                                                                                                                               |
|       2 | 2017-02-15 14:26:14 | 来自浙江的 Yandex Browser 17.1-Windows 7 用户       | `还是有人喜欢的，就像KDE下很多人会把任务栏从下面挪到头顶，硬是让KDE瞬间有了MAC OS和GNOME的感觉^_^`                                                                                   |
|       3 | 2017-02-15 21:24:21 | 来自四川成都的 Chrome 55.0-GNU/Linux 用户           | `KDE 默认布局更贴近 Windows，而 Gnome 3 无论怎么看都像是 macOS 的 Clone。`                                                                                                           |
|       4 | 2017-02-15 23:36:06 | 来自安徽合肥的 Chrome 55.0-Windows 10 用户          | `GNOME3的布局太松散，把比较菜单和工具栏较多的应用搞得一点都不好看，比如Eclipse`                                                                                                      |
|       5 | 2017-02-16 00:48:07 | 来自湖南长沙的 QQ Browser 9.5-Windows 7 用户        | `这都是主题可以解决的`                                                                                                                                                               |
|       6 | 2017-02-17 00:06:17 | 来自安徽合肥的 Chrome 47.0-Windows 10 用户          | `主题已废，没用，gnome天生就不是干这个的料，不信看他官方的应用`                                                                                                                      |
|       7 | 2017-02-18 00:37:40 | 绿色圣光 [Firefox 45.0-GNU/Linux]                   | `不喜欢全局菜单`                                                                                                                                                                     |
|       8 | 2017-02-20 21:47:32 | 枫落夜舞 [Chrome 56.0-Windows 10]                   | `这次回归的全局菜单功能最早出现在KDE3时代，当时的全局菜单不仅是Qt程序，连GTK都能支持，可惜现在的版本只对Qt程序有效了，没有太大意义，毕竟Linux环境下很多重量级的应用都是GTK相关的。`  |
