...
date_updated: 2017-02-24 09:47:00
slug: article-8236-1.html
url: https://linux.cn/article-8236-1.html
url_from: http://www.tecmint.com/view-yum-history-to-find-packages-info/
image: album/201702/24/051207yrormo3potnokouk.jpg
tags:
  - yum
  - 历史
categories:
...
[Yum](https://linux.cn/tag-yum.html) 是 RHEL/CentOS 的一个基于 rpm 的交互式高级包管理器，用户可以用它来安装新的软件包、卸载或清除旧的/不需要的软件包。它可以[自动运行系统更新](https://linux.cn/article-8015-1.html)，并执行依赖分析，对已安装的或可用的软件包进行查询等等。
...
|   index | 日期                | 日期                                  | 评论                                                 |
|--------:|:--------------------|:--------------------------------------|:-----------------------------------------------------|
|       0 | 2017-02-24 23:52:04 | 来自上海的 Chrome 56.0|Mac 10.12 用户 | 很想念fedora，也有点想念yum，不过最新的开始用dnf了。 |
