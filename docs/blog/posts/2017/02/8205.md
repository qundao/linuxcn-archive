...
date_updated: 2017-02-15 08:34:00
slug: article-8205-1.html
url: https://linux.cn/article-8205-1.html
url_from: 
  http://piboards.com/2017/01/07/block-ads-on-all-your-devices-at-home-with-pi-hole-and-an-orange-pi/
image: album/201702/14/223814u92zabccblv1v26v.png
tags:
  - orange pi
  - 广告拦截
  - 树莓派
...
|   index | 日期                | 日期                                       | 评论                                                                                                                      |
|--------:|:--------------------|:-------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------|
|       0 | 2017-02-15 10:03:16 | 不着调的小男生 [Chrome 50.0-Windows XP]    | `手头有一个OrangePi Zero 一个树莓派2B 回家测试一下，哈哈，但是我用OPenWrt过滤广告效果还是可以的。。。希望这个也是如此...` |
|       1 | 2017-02-15 10:14:43 | 来自广东中山的 Chrome 56.0-GNU/Linux 用户  | `DNS劫持！`                                                                                                               |
|       2 | 2017-02-15 23:02:15 | 来自江苏南京的 Firefox 51.0-GNU/Linux 用户 | `本质上是自愿形式的DNS劫持。我想知道有没有类似于DNSPOD的私人服务，以此来阻止广告？`                                       |
|       3 | 2017-02-16 08:35:57 | FoamValue [Chrome 56.0-Mac 10.12]          | `广告很烦，特别是那种诱惑性质的！`                                                                                        |
|       4 | 2017-02-16 18:21:04 | linux [Chrome 56.0-Mac 10.11]              | `国外有，OpenDNS`                                                                                                         |
|       5 | 2017-02-16 21:42:08 | fanbt [Firefox 51.0-Fedora]                | `Fedora下测试可用，目前必须关闭SElinux才正常，回头研究下看看有没有办法不关SElinux`                                        |
|       6 | 2017-02-17 00:44:39 | 来自上海的 Chrome 48.0-Windows 10 用户     | `其实，手动hosts 一样可以封掉，原理一样脚本同步`                                                                          |
