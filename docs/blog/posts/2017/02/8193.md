...
date_updated: 2017-02-11 10:00:00
slug: article-8193-1.html
url: https://linux.cn/article-8193-1.html
url_from: http://www.linuxroutes.com/quick-guide-how-to-hack-windows-with-kali-linux/
image: album/201702/10/224036lcbuz28jyo3u4fo4.png
tags:
  - kali
  - msf
  - 攻击
...
|   index | 日期                | 日期                                        | 评论                                                                                                                            |
|--------:|:--------------------|:--------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2017-02-11 16:20:15 | 拿铁不加糖 [Chrome 56.0-Windows 10]         | `破解之前应该标注一下Windows的具体版本号，这种漏洞应该已经被fix了吧！`                                                          |
|       1 | 2017-02-12 08:02:59 | 来自丹麦的 Mobile Safari 10.0-iOS 10.2 用户 | `“如果你可以在目标机器上运行你的代码，则可以在目标机器上运行你的代码。”<br /> 这篇文章没有任何基本的安全知识，真是“贻笑大方”。` |
|       2 | 2017-02-13 12:30:32 | 来自广东的 Chrome 56.0-Windows 10 用户      | `“现在你需要在 Windows 上运行 program.exe”<br /> 看到这里，我一口老血喷了出来。`                                                |
|       3 | 2017-02-13 14:11:51 | linux [Chrome 56.0-Mac 10.11]               | `:-D`                                                                                                                           |
|       4 | 2017-02-13 14:12:36 | linux [Chrome 56.0-Mac 10.11]               | `我开始也是以为……结果等我校对到这里是发现，也是一口老血喷到键盘上了……`                                                          |
|       5 | 2017-02-15 16:14:39 | 陳-鄭 [Firefox 51.0-Windows 7]              | `“现在你需要在 Windows 上运行 program.exe”<br /> 我就不说啥了！！！！！！现在正在吐血。`                                        |
|       6 | 2017-02-16 08:58:58 | 来自重庆的 Firefox 51.0-Windows 10 用户     | `也喷了一口老血`                                                                                                                |
|       7 | 2017-02-16 18:21:47 | linux [Chrome 56.0-Mac 10.11]               | `帮举盆接着 ……`                                                                                                                 |
|       8 | 2017-02-17 18:56:17 | 来自上海的 Firefox 51.0-Windows 7 用户      | `至于怎么把program.exe运送到目标主机上并成功执行，那就看黑客的真实技术了。`                                                     |
|       9 | 2017-02-20 13:48:21 | 来自江苏南京的 Chrome 56.0-Windows 7 用户   | `呵呵`                                                                                                                          |
|      10 | 2017-03-31 19:26:43 | Ghjoker [Firefox 45.0-GNU/Linux]            | `不管是不是三鹿奶粉，，先插个眼。。。`                                                                                          |
|      11 | 2020-08-04 16:42:43 | 来自广东深圳的 Firefox 68.0-GNU/Linux 用户  | `我希望我能用我家的Kali按照你的方法黑进我们学校（滑稽）`                                                                        |
|      12 | 2020-08-04 16:43:54 | 来自广东深圳的 Firefox 68.0-GNU/Linux 用户  | `我盆刚好被偷了。。。`                                                                                                          |
|      13 | 2020-08-04 16:44:56 | 来自广东深圳的 Firefox 68.0-GNU/Linux 用户  | `拿U盘运送到目标机器里去（滑稽）`                                                                                               |
|      14 | 2023-12-16 21:01:45 | 来自北京的 Chrome 121.0-Windows 10 用户     | `装作chatgpt发给别人（我被这样坑过）`                                                                                           |
