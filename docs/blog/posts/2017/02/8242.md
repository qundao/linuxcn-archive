...
date_updated: 2017-02-27 11:51:20
slug: article-8242-1.html
url: https://linux.cn/article-8242-1.html
url_from: 
  https://www.howtoforge.com/tutorial/how-to-install-nextcloud-with-nginx-and-php-fpm-on-centos-7/
image: album/201702/27/115114jv8a6y6awr83a6i3.jpg
tags:
  - nextcloud
  - owncloud
categories:
...
|   index | 日期                | 日期                                                   | 评论                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
|--------:|:--------------------|:-------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2017-02-27 12:52:13 | 来自浙江台州的 Firefox 51.0-Windows 10 用户            | `php 的选择挺多的&nbsp;&nbsp;<br /> remi 源，提供了 php 5.5 - 7.1 的所有版本，比较推荐这个。<br /> centos-release-scl-rh 源，提供了 php 5.5 - 5.6 版本。`                                                                                                                                                                                                                                                                                                                                    |
|       1 | 2017-02-27 12:53:02 | 来自浙江台州的 Firefox 51.0-Windows 10 用户            | `release-scl-rh 源 还有 php 7.0 版本的`                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
|       2 | 2017-03-10 10:03:11 | 天舞飞星 [Firefox 52.0-Ubuntu]                         | `SELinux打的标确定是正确的？没有遗漏？`                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
|       3 | 2017-04-13 19:15:29 | 来自湖南长沙的 Chrome 56.0-Windows 7 用户              | `确实报错，SElinux`                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
|       4 | 2017-07-07 21:52:35 | 来自四川成都的 Firefox 54.0-Windows 10 用户            | `老厉害了，，已经安装成功，没有任何问题。。 有问题也是我造成的`                                                                                                                                                                                                                                                                                                                                                                                                                              |
|       5 | 2017-07-31 19:45:34 | xingji929 [Chrome 55.0-Windows 7]                      | `可以导入公司内域内用户吗`                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
|       6 | 2017-08-12 19:01:30 | 来自福建厦门的 Microsoft Edge 15.15063-Windows 10 用户 | `nginx -t<br /> nginx: [emerg] unknown directive &quot; &quot; in /etc/nginx/conf.d/nextcloud.conf:2<br /> nginx: configuration file /etc/nginx/nginx.conf test failed`                                                                                                                                                                                                                                                                                                                      |
|       7 | 2017-08-25 17:58:12 | 明月登楼 [Chrome 60.0-Windows 10]                      | `难道没有中文版的嘛？`                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
|       8 | 2017-09-17 21:46:54 | 来自广东深圳的 Chrome 55.0-Windows 7 用户              | `一到这里就出错，什么原因呢？请帮忙解答，谢谢。<br /> [root@centos conf.d]# nginx -t<br /> nginx: [emerg] unknown directive &quot;tream&quot; in /etc/nginx/conf.d/nextcloud.conf:1<br /> nginx: configuration file /etc/nginx/nginx.conf test failed<br /> [root@centos conf.d]# systemctl restart nginx<br /> Job for nginx.service failed because the control process exited with error code. See &quot;systemctl status nginx.service&quot; and &quot;journalctl -xe&quot; for details.` |
|       9 | 2017-09-20 09:09:39 | 来自广东广州的 Firefox 55.0-Windows 10 用户            | `小编，请问我都完成了以上的步骤并没有报错，但是浏览器访问不了，大概是哪里出问题了`                                                                                                                                                                                                                                                                                                                                                                                                           |
|      10 | 2020-11-03 17:38:50 | 来自美国的 Firefox 78.0-Windows 10 用户                | `第3步中，【输入以下 mysql 查询语句来创建新的数据库和用户】部分，命令部分和截图中显示的不一致，命令文本部分多了“&amp;nbsp”<br /> <br /> 按住截图中的安装完成，为啥无法访问呢？`                                                                                                                                                                                                                                                                                                              |
