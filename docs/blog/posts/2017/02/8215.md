...
date_updated: 2017-02-17 07:30:00
slug: article-8215-1.html
url: https://linux.cn/article-8215-1.html
url_from: https://www.rosehosting.com/blog/basic-screen-command-usage-and-examples/
image: album/201702/16/183553i0rbcwvooncoevck.jpg
tags:
  - screen
categories:
  - 系统运维
...
|   index | 日期                | 日期                                       | 评论                                                                                                                       |
|--------:|:--------------------|:-------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------|
|       0 | 2017-02-17 08:31:23 | fanbt [Firefox 51.0-Fedora]                | `个人认为screen最大的用途不是运行的任务不中断，而是用于远程协助和教学目的，这可以让被协助者和学员清楚看到你的每一步操作。` |
|       1 | 2019-04-19 10:32:16 | 来自广东广州的 Chrome 73.0-Windows 10 用户 | `screen状态为Attached的时候连上不，用`screen -D&nbsp;&nbsp;-r ＜session-id&gt;`，-D -r 先踢掉前一用户，再登陆`             |
|       2 | 2019-04-19 10:32:21 | 来自广东广州的 Chrome 73.0-Windows 10 用户 | `screen状态为Attached的时候连上不，用`screen -D&nbsp;&nbsp;-r ＜session-id&gt;`，-D -r 先踢掉前一用户，再登陆`             |
|       3 | 2019-04-19 10:32:53 | 来自广东广州的 Chrome 73.0-Windows 10 用户 | `不小心评论了两次，抱歉`                                                                                                   |
