...
date_updated: 2017-09-09 18:14:00
slug: article-8853-1.html
url: https://linux.cn/article-8853-1.html
url_from: https://www.tecmint.com/integrate-ubuntu-to-samba4-ad-dc-with-sssd-and-realm/
image: album/201709/09/181412dtnflmmtymtod5py.jpg
tags:
  - samba
  - sssd
categories:
...
1. [在 Ubuntu 上用 Samba4 创建一个活动目录架构](https://linux.cn/article-8065-1.html)
...
14、 从一个 [安装了 RSAT 工具的](https://linux.cn/article-8097-1.html) Windows 机器上你可以打开 AD UC 并浏览“<ruby> 电脑 <rt>  computers </rt></ruby>”容器，并检验是否有一个使用你机器名的对象帐号已经创建。
