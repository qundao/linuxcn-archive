...
date_updated: 2017-09-03 16:37:49
slug: article-8835-1.html
url: https://linux.cn/article-8835-1.html
url_from: https://www.linux.com/learn/cleaning-your-linux-startup-process
image: album/201709/03/163752hjzalg5ijiduamml.png
tags:
  - systemd
  - 启动
  - 服务
...
|   index | 日期                | 日期                                               | 评论                                                                                                                                                                                                                 |
|--------:|:--------------------|:---------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2017-09-03 18:12:54 | 来自北京的 Firefox 56.0-GNU/Linux 用户             | `不错的文章，参照清理了一下服务`                                                                                                                                                                                     |
|       1 | 2017-09-04 09:05:55 | 来自陕西西安的 Chrome 60.0-GNU/Linux 用户          | `时间证明SYSTEMD是个好东西、GNOME也是个好东西。不过SYSTEMD还是需要具有良好的用户配置界面，二进制不是给人看滴！！！尤其在系统无法启动的时候！！！`                                                                    |
|       2 | 2017-09-04 09:17:27 | 来自四川成都的 Chrome 60.0-GNU/Linux 用户          | `所谓文本格式也是二进制，只是系统底层支持的好。说用文本格式比二进制方便的， 是因为那些工具方便，像 C 语言操作字符串，可不是那么方便。至于 Gnome 和 systemd 是个好东西，这个持保留意见，这两个软件部分组件比较好用。` |
|       3 | 2017-09-05 19:02:38 | 来自上海的 Chrome 59.0-Windows 7 用户              | `请问一下贵站用的什么富文本编辑器啊，还支持注解`                                                                                                                                                                     |
|       4 | 2017-09-05 20:52:29 | linux [Chrome 60.0-Mac 10.11]                      | `这是我们自己加的功能，其实就是一个 H5 标签。`                                                                                                                                                                       |
|       5 | 2017-09-07 00:14:47 | 来自河南郑州的 Chrome Mobile 40.0-Android 7.0 用户 | `今天刚学习完systemd，晚上就遇见文章了。哈，复习一遍systemd用法。`                                                                                                                                                   |
|       6 | 2017-09-13 13:23:47 | actanble [Chrome 60.0-Windows 10]                  | `markdownx 可以。 你可以考虑下； 其中 h1,h2 这列东西；可以自己定义好样式；另外目录概要是 利用content 占行显示百分比; 通过 h1 或者 h2 bs4 提出索引; 挑转是根据 #div_id 跳转的，`                                      |
