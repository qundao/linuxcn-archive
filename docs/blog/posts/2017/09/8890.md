...
date_updated: 2017-09-22 09:39:25
slug: article-8890-1.html
url: https://linux.cn/article-8890-1.html
url_from: 
  https://blog.tartanllama.xyz/c++/2017/06/19/writing-a-linux-debugger-source-break/
image: album/201709/22/093850q8zlc89bpd1idpkc.jpg
tags:
  - 调试器
categories:
  - 软件开发
...
[Elves 和 dwarves](https://linux.cn/article-8719-1.html) 这篇文章，描述了 DWARF 调试信息是如何工作的，以及如何用它来将机器码映射到高层源码中。回想一下，DWARF 包含了函数的地址范围和一个允许你在抽象层之间转换代码位置的行表。我们将使用这些功能来实现我们的断点。
