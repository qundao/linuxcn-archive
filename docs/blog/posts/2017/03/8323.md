...
date_updated: 2017-03-21 15:21:43
slug: article-8323-1.html
url: https://linux.cn/article-8323-1.html
url_from: 
  https://www.rosehosting.com/blog/set-up-and-configure-a-firewall-with-firewalld-on-centos-7/
image: album/201703/21/152148ell9lvv66vf959yz.jpg
tags:
  - firewalld
  - 防火墙
categories:
...
|   index | 日期                | 日期                                                | 评论                                                                                                        |
|--------:|:--------------------|:----------------------------------------------------|:------------------------------------------------------------------------------------------------------------|
|       0 | 2017-03-23 16:51:07 | 来自河北廊坊的 Chrome 58.0-Windows 10 用户          | `我想知道firewalld可以搞定全局禁用网络下仅允许某一个应用服务通过网络（端口号随机）吗。`                     |
|       1 | 2017-04-29 18:22:22 | 来自四川德阳的 Chrome Mobile iOS 58.0-iOS 10.3 用户 | `似乎是不能的`                                                                                              |
|       2 | 2017-05-16 14:42:24 | 不太冷 [Liebao-Windows 7]                           | `转走了`                                                                                                    |
|       3 | 2017-07-25 17:49:17 | 来自北京的 Chrome 59.0-Windows 7 用户               | `firewall 是否可以限制所有的传出网络连接，例如DROP正在访问本机以外80端口的链接呢（类似iptables的OUTPUT）？` |
