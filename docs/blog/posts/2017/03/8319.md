...
date_updated: 2017-03-19 10:32:00
slug: article-8319-1.html
url: https://linux.cn/article-8319-1.html
url_from: http://www.tecmint.com/install-python-in-linux/
image: album/201703/19/053959s707j3taptyzea3t.jpg
tags:
  - python
  - python3
categories:
...
虽然我们可以使用 [yum](https://linux.cn/tag-yum.html) 和 [aptitude](https://linux.cn/tag-aptitude.html)（或 [apt-get](https://linux.cn/tag-apt-get.html)）安装核心安装包以及它们的依赖，但在这儿，我将阐述如何使用源代码进行安装。
...
|   index | 日期                | 日期                                   | 评论                                                                          |
|--------:|:--------------------|:---------------------------------------|:------------------------------------------------------------------------------|
|       0 | 2017-03-19 20:20:39 | 不着调的小男生 [Chrome 57.0|Windows 7] | pacman _S python&nbsp; &nbsp; 既可以完成python3.6的安装，啦啦啦、、污啦啦.... |
|       1 | 2017-03-22 04:26:09 | 来自美国的 Firefox 45.0|Windows 7 用户 | pyenv用户路过                                                                 |
