...
date_updated: 2017-03-12 13:35:00
slug: article-8295-1.html
url: https://linux.cn/article-8295-1.html
url_from: http://www.tecmint.com/secure-ftp-server-using-ssl-tls-on-ubuntu/
image: album/201703/12/104507p0fbu1w81fmed8io.jpg
tags:
  - ftp
  - ftps
  - ssl
...
3、在我们进行 vsftpd 配置之前，对于那些[已启用 UFW 防火墙](https://linux.cn/article-8087-1.html)的用户，你们必须打开端口 `990` 和 `40000` - `50000`，来在 vsftpd 配置文件中分别启用 TLS 连接端口和被动端口的端口范围：
