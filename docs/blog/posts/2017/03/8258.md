...
date_updated: 2017-03-02 10:35:34
slug: article-8258-1.html
url: https://linux.cn/article-8258-1.html
url_from: http://www.tecmint.com/manage-samba4-dns-group-policy-from-windows/
image: album/201703/02/103407nb3hkxosffb4x34x.jpg
tags:
  - dns
  - samba
categories:
...
接着前一篇教程写的关于[使用 Windows 10 的 RSAT 工具来管理 Samba4 活动目录架构](https://linux.cn/article-8097-1.html)，在这篇文章中我们将学习如何使用微软 DNS 管理器远程管理我们的 Samba AD 域控制器的 DNS 服务器，如何创建 DNS 记录，如何创建反向查找区域以及如何通过组策略管理工具来创建域策略。

`![](/data/attachment/album/201703/02/103407nb3hkxosffb4x34x.jpg)`

#### 要求

1、 [在 Ubuntu 16.04 系统上使用 Samba4 软件来创建活动目录架构（一）](https://linux.cn/article-8065-1.html)

2、 [在 Linux 命令行下管理 Samba4 AD 架构（二）](https://linux.cn/article-8070-1.html)

3、 [使用 Windows 10 的 RSAT 工具来管理 Samba4 活动目录架构 （三）](https://linux.cn/article-8097-1.html)
