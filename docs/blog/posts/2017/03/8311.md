...
date_updated: 2017-03-16 09:38:00
slug: article-8311-1.html
url: https://linux.cn/article-8311-1.html
url_from: 
  http://www.linuxandubuntu.com/home/best-windows-like-linux-distributions-for-new-linux-users
image: album/201703/16/054539jk22xqvr4lmrli7a.jpg
tags:
  - windows
  - 发行版
categories:
...
|   index | 日期                | 日期                                            | 评论                                                                                                                                                                                                                                                                                                                                                                                |
|--------:|:--------------------|:------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2017-03-16 09:59:58 | 来自四川成都的 Chrome 56.0-GNU/Linux 用户       | `KDE 4/5 界面风格接近 Windows，GNOME 3 界面风格接近 macOS。至于其他说界面风格接近 Windows 的，一般是指 Windows XP，少部分是 Windows 7，至于接近 Windows 8/8.1，Windows 10 的，应该是没有的，因为这三个 Windows 系统不仅启用了扁平化风格，而且以扁平化风格运行的大部分程序是有其专门的运行平台。而目前 Linux 桌面是没有这类程序的，除非把只是使用了 Linux 内核的 Android 系统算上。` |
|       1 | 2017-03-16 13:20:13 | 来自江苏的 Firefox 52.0-Windows 8.1 用户        | `阅`                                                                                                                                                                                                                                                                                                                                                                                |
|       2 | 2017-03-16 13:58:13 | 来自四川成都的 Chrome 56.0-GNU/Linux 用户       | `回禀皇上，少了个“朕”字。`                                                                                                                                                                                                                                                                                                                                                          |
|       3 | 2017-03-16 17:41:24 | 来自浙江杭州的 Vivaldi 1.7-GNU/Linux 用户       | `现在的Windows都不长这个样子了，这些模仿旧Windows还这么丑四不像的东西慢慢就不会存在了……至于cinnamon其实不能算仿Windows，要好看还是新KDE好`                                                                                                                                                                                                                                          |
|       4 | 2017-03-19 11:52:33 | 来自内蒙古兴安的 Firefox 52.0-Windows 7 用户    | `测试`                                                                                                                                                                                                                                                                                                                                                                              |
|       5 | 2017-03-19 21:17:52 | 来自黑龙江大庆的 Firefox 45.0-GNU/Linux 用户    | `我觉得仿这个东西真没多大必要,新手接触linux就应该摒弃用Windows养成的习惯.不然为什么放着Windows不用非要来折腾Linux呢.`                                                                                                                                                                                                                                                               |
|       6 | 2017-03-20 03:10:36 | yomun [Chrome 57.0-GNU/Linux]                   | `用 linux 的用户就是喜欢接受新的事物<br /> <br /> 界面只不过是表象而已，linux 用户真正追求的是..&nbsp;&nbsp;<br /> <br /> 安全, 稳定, 节省资源`                                                                                                                                                                                                                                     |
|       7 | 2017-04-10 19:24:13 | Ghjoker [Firefox 45.0-GNU/Linux]                | `没毛病老铁`                                                                                                                                                                                                                                                                                                                                                                        |
|       8 | 2020-03-31 08:09:34 | 来自39.168.138.232的 Chrome 80.0-GNU/Linux 用户 | `kali-undercover 应该也算是一个`                                                                                                                                                                                                                                                                                                                                                    |
