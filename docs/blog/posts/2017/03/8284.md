...
|       2 | 2017-03-09 17:30:24 | 不着调的小男生 [Chrome 55.0|Windows 7]     | 虽然我用Arch作为主系统V，但是看到本文的错误我还是要热心指出的。Ubuntu是debian的衍生版，mint是Ubuntu的衍生。文章开头第二段我觉得有歧义。<br />                                                                                                |
|         |                     |                                            | <br />                                                                                                                                                                                                                                       |
|         |                     |                                            | 看到评论说Arch的待遇，也不完全是。Arch虽然很激进，但是不对于内核这一块，我编译的OrangePiZero的内核合适实时内核4.10 而Arch用的却是4.9.8的内核，准确说Ubuntu建议跟新到长期支持内核，不要用测试版的，可以体验一下实时内核。本来Ubuntu就不稳定。                                                                                                |
...
|       7 | 2017-04-05 20:14:55 | yomun [Chrome 57.0|GNU/Linux]              | 要注意官网所提供的网卡驱动,<br />                                                                                                                                                                                                            |
|         |                     |                                            | 他们都有说明内核可用的版本<br />                                                                                                                                                                                                                          |
|         |                     |                                            | <br />                                                                                                                                                                                                                          |
|         |                     |                                            | 如果内核超过支持的版本, <br />                                                                                                                                                                                                                          |
