...
date_updated: 2017-03-31 09:28:00
slug: article-8358-1.html
url: https://linux.cn/article-8358-1.html
url_from: 
  http://www.tecmint.com/join-additional-ubuntu-dc-to-samba4-ad-dc-failover-replication/
image: album/201703/31/092100ye4goo4v1c1zefoe.jpg
tags:
  - samba
categories:
  - 系统运维
...
17、这些 DNS 记录也可以从注册过的[已安装了 RSAT 工具的 Windows 机器](https://linux.cn/article-8097-1.html)上查询到。打开 DNS 管理器，展开到你的域 tcp 记录，如下图所示：
...
最后，如果你想在 Linux 系统上使用 Samba4 活动目录账号来进行本地认证，或者为 AD LDAP 账号授予 root 权限，请查看[在 Linux 命令行下管理 Samba4 AD 架构](https://linux.cn/article-8070-1.html) 这篇教程的 第 2 步和第 3 步。
