...
date_updated: 2017-04-29 08:12:00
slug: article-8458-1.html
url: https://linux.cn/article-8458-1.html
url_from: 
  https://www.howtoforge.com/tutorial/how-to-perform-directory-comparison-using-meld/
image: album/201704/28/231515nzyxjbufhebuj1kb.jpg
tags:
  - meld
  - 比较
categories:
...
我们已经从一个新手的角度[了解](https://linux.cn/article-8402-1.html)了 Meld （包括 Meld 的安装），我们也提及了一些 Meld 中级用户常用的小技巧。如果你有印象，在新手教程中，我们说过 Meld 可以比较文件和文件夹。已经讨论过怎么比较文件，今天，我们来看看 Meld 怎么比较文件夹。
...
|   index | 日期                | 日期                                       | 评论                                                          |
|--------:|:--------------------|:-------------------------------------------|:--------------------------------------------------------------|
|       0 | 2017-04-30 21:45:28 | 绿色圣光 [Firefox 45.0-GNU/Linux]          | `必备软件之一`                                                |
|       1 | 2017-05-04 09:35:28 | 来自广东广州的 Firefox 45.0-Ubuntu 用户    | `so good !`                                                   |
|       2 | 2017-06-26 19:05:40 | Fa1c0n [Opera 45.0-Windows 10]             | `恩，很喜欢这东西~`                                           |
|       3 | 2017-06-26 21:18:02 | 来自四川宜宾的 Firefox 54.0-GNU/Linux 用户 | `好软件啊<br /> diffuse对比文件内容<br /> meld对比文件夹内容` |
