...
date_updated: 2017-04-03 11:15:00
slug: article-8371-1.html
url: https://linux.cn/article-8371-1.html
url_from: https://www.howtoforge.com/tutorial/linux-command-line-tips-tricks-part-2/
image: album/201704/03/072146d3k3y3dz6nvk4w13.jpg
tags:
  - dirs
  - popd
  - pushd
...
在本系列的[第一部分](https://linux.cn/article-8335-1.html)中，我们通过讨论 `cd -` 命令的用法，重点介绍了 Linux 中的命令行导航。还讨论了一些其他相关要点/概念。现在进一步讨论，在本文中，我们将讨论如何使用 `pushd` 和 `popd` 命令在 Linux 命令行上获得更快的导航体验。
