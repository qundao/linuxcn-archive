...
|   index | 日期                | 日期                                      | 评论                                                                                        |
|--------:|:--------------------|:------------------------------------------|:--------------------------------------------------------------------------------------------|
|       0 | 2017-04-11 09:50:14 | 来自四川成都的 Chrome 57.0|GNU/Linux 用户 | 我为 cd .. 创建的别名是仿照 MS-DOS，少输一个空格。<br />              |
|         |                     |                                           | <br />                                                                |
|         |                     |                                           | alias cd..='cd ..'                                                    |
|       1 | 2017-04-11 10:26:56 | 来自四川成都的 Chrome 57.0|GNU/Linux 用户 | 此外还有<br />                                                        |
|         |                     |                                           | <br />                                                                |
...
|       5 | 2017-04-21 09:41:35 | 来自北京的 Chrome 58.0|GNU/Linux 用户     | 直接cd,就是转到home目录，为啥还要多敲两个字母呢？<br />               |
|         |                     |                                           | <br />                                                                |
|         |                     |                                           | 至于上级目录，看到别人是用<br />                                                   |
|         |                     |                                           | <br />                                                                |
|         |                     |                                           | alias .. = 'cd ../'<br />                                |
