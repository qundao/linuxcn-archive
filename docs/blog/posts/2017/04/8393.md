...
date_updated: 2017-04-11 09:13:44
slug: article-8393-1.html
url: https://linux.cn/article-8393-1.html
url_from: https://www.howtoforge.com/tutorial/command-line-aliases-in-linux/
image: album/201704/11/091317jjjj0fs3017hz14s.jpg
tags:
  - 命令行
  - 导航
categories:
...
|   index | 日期                | 日期                                      | 评论                                                                                                                                                                                                                       |
|--------:|:--------------------|:------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2017-04-11 09:50:14 | 来自四川成都的 Chrome 57.0-GNU/Linux 用户 | `我为 cd .. 创建的别名是仿照 MS-DOS，少输一个空格。<br /> <br /> alias cd..='cd ..'`                                                                                                                                       |
|       1 | 2017-04-11 10:26:56 | 来自四川成都的 Chrome 57.0-GNU/Linux 用户 | `此外还有<br /> <br /> alias cls='printf &quot;\033c&quot;'<br /> <br /> 用于清屏，比 clear 少输两个字母，且实现方式类似 MS-DOS 的 cls。<br /> <br /> alias gzip='gzip --keep'<br /> <br /> 压缩/解压文件后，保留输入文件` |
|       2 | 2017-04-11 11:04:15 | linux [Chrome 57.0-Mac 10.11]             | `很赞！`                                                                                                                                                                                                                   |
|       3 | 2017-04-11 11:04:45 | linux [Chrome 57.0-Mac 10.11]             | `不错不错！`                                                                                                                                                                                                               |
|       4 | 2017-04-11 14:24:56 | lwang [Chrome 50.0-Windows 7]             | `Ctrl+L`                                                                                                                                                                                                                   |
|       5 | 2017-04-21 09:41:35 | 来自北京的 Chrome 58.0-GNU/Linux 用户     | `直接cd,就是转到home目录，为啥还要多敲两个字母呢？<br /> <br /> 至于上级目录，看到别人是用<br /> <br /> alias .. = 'cd ../'<br /> alias ... = 'cd ../../'<br /> <br /> 也同样比bk2,3来的方便`                              |
