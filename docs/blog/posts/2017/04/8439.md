...
date_updated: 2017-04-23 17:09:00
slug: article-8439-1.html
url: https://linux.cn/article-8439-1.html
url_from: 
  https://opensource.com/article/16/12/yearbook-top-open-source-creative-tools-2016
image: album/201704/23/170852i0g3xtw0pw811w8k.jpg
tags:
  - 创意
  - 设计
categories:
...
[GIMP](https://opensource.com/tags/gimp) [在 2015 年迎来了它的 20 周岁](https://linux.cn/article-7131-1.html)，使得它成为这里资历最久的开源创造型应用之一。GIMP 是一款强大的应用，可以处理图片，创作简单的绘画，以及插图。你可以通过简单的任务来尝试 GIMP，比如裁剪、缩放图片，然后循序渐进使用它的其它功能。GIMP 可以在 Linux、Mac OS X 以及 Windows 上使用，是一款跨平台的应用，而且能够打开、导出一系列格式的文件，包括在与之相似的软件 Photoshop 上广为应用的那些格式。
...
|   index | 日期                | 日期                                      | 评论                                                                            |
|--------:|:--------------------|:------------------------------------------|:--------------------------------------------------------------------------------|
|       0 | 2017-07-19 11:17:20 | 来自陕西西安的 Chrome 43.0|GNU/Linux 用户 | 这一堆软件里有一半以上的都不能用，经常崩溃，图片处理还好，视频处理还得去win下。 |
