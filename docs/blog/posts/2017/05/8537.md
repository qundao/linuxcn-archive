...
date_updated: 2017-05-24 09:41:00
slug: article-8537-1.html
url: https://linux.cn/article-8537-1.html
url_from: https://www.tecmint.com/delete-huge-files-in-linux/
image: album/201705/24/064946fqc1vu7oxi1bixos.jpg
tags:
  - 删除
categories:
  - 技术
...
**建议阅读：**[3 个在 Linux 中永久/安全删除文件/文件夹的方法](https://linux.cn/article-8123-1.html)
...
|   index | 日期                | 日期                                               | 评论                                                                                                                                        |
|--------:|:--------------------|:---------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2017-05-24 10:43:01 | 来自四川成都的 Chrome 57.0-GNU/Linux 用户          | `这个也应该要看具体文件系统吧？`                                                                                                            |
|       1 | 2017-05-24 21:17:35 | hello_linux [Chrome 51.0-Windows 7]                | `感谢分享`                                                                                                                                  |
|       2 | 2017-05-25 01:25:02 | 来自广东广州的 Chrome Mobile 37.0-Android 7.0 用户 | `创建一个空文件，再用mv覆盖大文件。试过删除差不多二百G日志文件，二、三秒完成，最后重启一下程序~`                                            |
|       3 | 2017-05-25 07:08:27 | 来自江苏苏州的 Chrome 58.0-Windows 10 用户         | `好，windows 的删除真的sb是的，拖慢，就应该这种技术嘛`                                                                                      |
|       4 | 2017-05-25 23:14:50 | 来自四川成都的 Mobile Safari 10.0-iOS 10.3 用户    | `假如大文件叫做bigfile可以直接用如下命令先让其变小文件在删除啊，而且超快:<br /> echo &quot;&quot; &gt;&nbsp;&nbsp;bigfile<br /> rm bigfile` |
