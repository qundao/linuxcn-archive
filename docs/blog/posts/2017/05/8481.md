...
date_updated: 2017-05-06 08:05:00
slug: article-8481-1.html
url: https://linux.cn/article-8481-1.html
url_from: http://www.rodsbooks.com/linux-uefi/
image: album/201705/05/232225rsydrjnujbcsdmdn.jpg
tags:
  - bios
  - grub
  - uefi
...
作者：[Roderick W. Smith](mailto:rodsmith@rodsbooks.com) 译者：[fuowang](https://github.com/fuowang) 校对：[wxy](https://github.com/wxy)
...
|   index | 日期                | 日期                                               | 评论                                                                                                                              |
|--------:|:--------------------|:---------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2017-05-08 18:34:44 | 来自陕西西安的 Chrome 58.0|GNU/Linux 用户          | Gnu项目组就是应该搞个类似与Gnu/BOIS的玩意。或者直接像树梅派，Gnu/Linux就可以搞定一切啦。UEFI和DRM确实很恶心！！！有点反人类！！！ |
|       1 | 2017-05-10 11:25:39 | 来自湖北武汉的 Chrome Mobile 58.0|Android 7.1 用户 | 怎么一堆废话。                                                                                                                    |
|       2 | 2019-03-24 21:22:29 | 来自上海的 Chrome 74.0|Windows 10 用户             | 神舟T65有个很操蛋的问题,就是大部分Linux发行版无法正常走到live界面,都会卡在启动X环境的位置,也尝试过禁用开源的N卡驱动,问题依旧      |
|       3 | 2019-12-30 15:50:32 | 来自安徽芜湖的 Chrome 77.0|Windows 10 用户         | xxxxx                                                                                                                             |
