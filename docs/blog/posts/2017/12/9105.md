...
date_updated: 2017-12-03 19:31:14
slug: article-9105-1.html
url: https://linux.cn/article-9105-1.html
url_from: https://opensource.com/article/17/6/linking-linux-filesystem
image: album/201712/03/193119ay3qk3y9e0qq4xex.png
tags:
  - 文件系统
  - 符号链接
  - 链接
...
在我为 opensource.com 写过的关于 Linux 文件系统方方面面的文章中，包括 [Linux 的 EXT4 文件系统的历史、特性以及最佳实践](https://linux.cn/article-8685-1.html)； [在 Linux 中管理设备](https://linux.cn/article-8099-1.html)；[Linux 文件系统概览](https://linux.cn/article-8887-1.html) 和 [用户指南：逻辑卷管理](https://opensource.com/business/16/9/linux-users-guide-lvm)，我曾简要的提到过 Linux 文件系统一个有趣的特性，它允许用户从多个位置来访问 Linux 文件目录树中的文件来简化一些任务。
...
在 [Linux 的 EXT4 文件系统的历史、特性以及最佳实践](https://linux.cn/article-8685-1.html)一文中，我曾探讨过这样一个事实，每个文件都有一个包含该文件信息的 inode，包含了该文件的位置信息。上述文章中的[图2](https://linux.cn/article-8685-1.html#3_19182)展示了一个指向 inode 的单一目录项。每个文件都至少有一个目录项指向描述该文件信息的 inode ，目录项是一个硬链接，因此每个文件至少都有一个硬链接。
