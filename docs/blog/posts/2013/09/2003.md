...
date_updated: 2013-09-24 20:01:00
slug: article-2003-1.html
url: https://linux.cn/article-2003-1.html
url_from: ''
...
> Ubuntuzilla 是一个包含最新版本Mozilla Firefox，Mozilla Thunderbird，和Mozilla Seamonkey软件的APT仓库，这个仓库将适用于Ubuntu以及所有的Debian衍生发行版。Ubuntuzilla在Ubuntu论坛的第三方项目区域有一个支  ...
