...
slug: article-2324-1.html
url: https://linux.cn/article-2324-1.html
url_from: ''
image: album/201312/02/234203dr5rr4yhakaybalk.jpg
tags:
  - centos
  - epel
  - linux
...
> EPEL 是什么？
> EPEL (Extra Packages for Enterprise Linux，企业版Linux的额外软件包) 是Fedora小组维护的一个软件仓库项目，为RHEL/CentOS提供他们默认不提供的软件包。这个源兼容RHEL及像CentOS和Scientific Linu ...
...
|   index | 日期                | 日期                                   | 评论       |
|--------:|:--------------------|:---------------------------------------|:-----------|
|       0 | 2021-10-08 09:08:53 | 来自香港的 Chrome 94.0|Windows 10 用户 | 非常有帮助 |
