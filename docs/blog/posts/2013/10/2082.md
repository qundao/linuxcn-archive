...
date_updated: 2013-10-11 22:14:00
slug: article-2082-1.html
url: https://linux.cn/article-2082-1.html
url_from: ''
image: album/201310/11/132232op9qo2kfzkofc67k.png
tags:
  - calculator
  - calculator app
  - 应用程序
...
> Ubuntu Touch Core Apps是一个官方的项目，目前正在定制一套核心应用程序，应用程序包括从音乐播放器到天气工具和RSS阅读器。
> 在丰富的核心应用程序里面也有一个Calculator App，在界面漂亮的计算器里面融合了方便有 ...
