...
slug: article-2143-1.html
url: https://linux.cn/article-2143-1.html
url_from: ''
image: album/201310/22/151153t4cncn88xclu14tn.png
tags:
  - apt-fast
  - apt-get
  - linux
...
> apt-fast是一个为 apt-get 和 aptitude 做的 shell脚本封装 ，通过对每个包进行并发下载的方式可以大大减少APT的下载时间。apt-fast使用aria2c或axel下载管理器来减少APT下载时间。就像传统的apt-get包管理器一样，a ...
