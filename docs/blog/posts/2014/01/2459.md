...
date_updated: 2014-01-09 11:06:00
slug: article-2459-1.html
url: https://linux.cn/article-2459-1.html
url_from: ''
image: album/201401/09/101331cgxukeukkr2l2x21.png
tags:
  - linux
  - watch
  - 命令
...
|   index | 日期                | 日期                                       | 评论                                                                                                                                       |
|--------:|:--------------------|:-------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2021-10-04 18:57:44 | 来自湖北武汉的 Chrome 94.0|Windows 10 用户 | watch -n1 &quot;sensors | grep temp | awk '{ print $2 }'&quot; 和 sensors | grep temp得到的输出是一样的，awk并不能正常工作。完全错误的例子 |
