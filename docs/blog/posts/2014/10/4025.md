...
date_updated: 2014-10-16 14:20:11
slug: article-4025-1.html
url: https://linux.cn/article-4025-1.html
url_from: http://www.tecmint.com/install-sysstat-in-linux/
image: album/201410/16/141737dy24thy1om12dof2.png
tags:
  - sysstat
categories:
  - 系统运维
...
* [**iostat**](https://linux.cn/article-4024-1.html): 输出CPU的统计信息和所有I/O设备的输入输出（I/O）统计信息。
...
|   index | 日期                | 日期                             | 评论                                                                               |
|--------:|:--------------------|:---------------------------------|:-----------------------------------------------------------------------------------|
|       0 | 2015-04-19 11:12:22 | _Dreamer                         | `有点意思。。。`                                                                   |
|       1 | 2016-06-26 01:32:02 | Coohx [WeChat 6.3-Android 4.4]   | `可以，学习了`                                                                     |
|       2 | 2016-07-06 17:45:29 | 飞残月 [Chrome 49.0-Windows 8.1] | `不建议使用yum remove 删除软件，这样会把依赖的也给删掉。要是删除可以使用rpm -e 。` |
|       3 | 2016-12-22 16:29:56 | 何亮 [Chrome 54.0-Windows 7]     | `好长时间没有折腾Linux了`                                                          |
