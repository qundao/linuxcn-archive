...
date_updated: 2014-10-20 12:04:00
slug: article-4046-1.html
url: https://linux.cn/article-4046-1.html
url_from: https://www.codementor.io/git-tutorial/git-rebase-split-old-commit-master
image: album/201410/20/120426xxp4qkbxm5vqylk4.jpg
tags:
  - git
  - git rebase
categories:
...
|   index | 日期                | 日期     | 评论                                                                                                                                                                                                                                                                        |
|--------:|:--------------------|:---------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2014-10-20 12:33:01 | 微博评论 | `用起来感觉很危险`                                                                                                                                                                                                                                                          |
|       1 | 2014-10-20 14:33:00 | 微博评论 | `这就是传说中的“变基”。`                                                                                                                                                                                                                                                    |
|       2 | 2014-10-20 16:33:00 | 微博评论 | `变基神器。。//@陈伟琪在肇庆: 这就是传说中的“变基”。`                                                                                                                                                                                                                       |
|       3 | 2014-10-20 16:33:00 | 微博评论 | `长大的标志不是学会做rebase，而是学会不做rebase。//@Linux中国: 变基神器。。//@陈伟琪在肇庆: 这就是传说中的“变基”。`                                                                                                                                                         |
|       4 | 2014-10-20 17:03:00 | 微博评论 | `基佬们快来学 //@时趣张首华: //@Linux中国: 变基神器。。//@陈伟琪在肇庆: 这就是传说中的“变基”。`                                                                                                                                                                             |
|       5 | 2014-10-20 17:03:00 | 微博评论 | `@我的印象笔记 //@Linux中国:变基神器。。//@陈伟琪在肇庆: 这就是传说中的“变基”。`                                                                                                                                                                                            |
|       6 | 2014-10-20 17:03:00 | 微博评论 | `为什么不从f2出一个新branch，diff f3 修改以后合并到主分支呢？rebase本身就不是推荐使用的东西。而且这货把Repo搞反了。//@Linux中国: 变基神器。。//@陈伟琪在肇庆: 这就是传说中的“变基”。`                                                                                       |
|       7 | 2014-10-20 17:03:00 | 微博评论 | `[挖鼻屎]//@米粽粽: 基佬们快来学 //@时趣张首华: //@Linux中国: 变基神器。。//@陈伟琪在肇庆: 这就是传说中的“变基”。`                                                                                                                                                          |
|       8 | 2014-10-20 17:03:00 | 微博评论 | `git高级技能--变基`                                                                                                                                                                                                                                                         |
|       9 | 2014-10-20 22:33:00 | 微博评论 | `@群英汇蒋鑫 帮忙给看看？是这样么？//@小和平鸽: 为什么不从f2出一个新branch，diff f3 修改以后合并到主分支呢？rebase本身就不是推荐使用的东西。而且这货把Repo搞反了。//@Linux中国: 变基神器。。//@陈伟琪在肇庆: 这就是传说中的“变基”。`                                        |
|      10 | 2014-10-20 22:33:00 | 微博评论 | `另辟途径不愿变基啊右右右。//@Linux中国:@群英汇蒋鑫 帮忙给看看？是这样么？//@小和平鸽: 为什么不从f2出一个新branch，diff f3 修改以后合并到主分支呢？rebase本身就不是推荐使用的东西。而且这货把Repo搞反了。//@Linux中国: 变基神器。。//@陈伟琪在肇庆: 这就是传说中的“变基”。` |
|      11 | 2014-10-20 23:03:00 | 微博评论 | `rebase在多team合作开发是是很有用的。abc team都要修改某git下的东西，但abc team都不应该直接merge master分支，而是建立自己的分支，然后定期提交commit。当需要提交之前从主枝rebase别的team的改动，把冲突解决在自己branch上。`                                                   |
|      12 | 2014-10-21 13:03:01 | 微博评论 | `很好的文章啊，这正是交互式变基大显身手的地方，试试就知道哪个方便了。 //@Linux中国: @群英汇蒋鑫 帮忙给看看？是这样么？//@小和平鸽: 为什么不从f2出一个新branch，diff f3 修改以后合并到主分支呢？rebase本身就不是推荐使用的东西。而且这货把Repo搞反了。`                      |
