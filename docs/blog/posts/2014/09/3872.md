...
date_updated: 2014-09-22 09:11:31
slug: article-3872-1.html
url: https://linux.cn/article-3872-1.html
url_from: http://itsfoss.com/uninstall-ubuntu-linux-windows-dual-boot/
image: album/201409/22/091132mard1rprpcrrrlfq.jpeg
tags:
  - linux
  - ubuntu
  - 卸载
...
我在过去已经多次涉及到[在UEFI模式下安装Ubuntu 14.04与Windows 8/8.1双启动](https://linux.cn/article-3178-1.html)的话题。 但是要怎么从**Windows双启动中卸载Ubuntu呢**？下面我们将看到的教程适用于任意的Linux操作系统，如Ubuntu，Linux Mint，Elementary OS或其它任意Linux发行版。
...
|   index | 日期                | 日期                                   | 评论                                                                                                           |
|--------:|:--------------------|:---------------------------------------|:---------------------------------------------------------------------------------------------------------------|
|       0 | 2014-09-22 09:47:02 | 微博评论                               | 很好的内容，鼓励一下                                                                                           |
|       1 | 2014-09-22 09:51:07 |                                        | 双系统的话，我都是用easybcd做引导，grub2不会装到MBR上去                                                        |
|       2 | 2014-09-22 10:33:00 | 微博评论                               | 早就不用双启动了。不但麻烦，还造成分区的识别问题！                                                             |
|       3 | 2014-09-22 13:03:01 | 微博评论                               | 收藏                                                                                                           |
|       4 | 2014-09-22 14:03:00 | 微博评论                               | 表示到现在也搞不定uefi，还是bios➕grub得心应手                                                                 |
|       5 | 2014-09-22 23:17:28 |                                        | “Linux中国”为毛不是双系统移除Windows？                                                                         |
|       6 | 2014-10-06 20:12:23 | 来自 - 上海 的 Safari/Windows 用户     | 因為那個不用教                                                                                                 |
|       7 | 2015-04-30 12:24:41 | 来自 - 浙江嘉兴 的 Chrome/Windows 用户 | 该方法只适合MBR分区方式，如果是GPT方式，就没有效果，不过GPT方式可以很好的修复，linux的入口可以使用EasyUEFI去除 |
