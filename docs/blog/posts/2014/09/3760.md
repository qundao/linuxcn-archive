...
date_updated: 2014-09-05 10:40:54
slug: article-3760-1.html
url: https://linux.cn/article-3760-1.html
url_from: http://www.tecmint.com/cheat-command-line-cheat-sheet-for-linux-users/
image: album/201409/05/103328rx8wbjmwmu6dl4zq.png
tags:
  - cheat
  - 命令
categories:
...
|   index | 日期                | 日期                                   | 评论                                                                                                                                                                                                                                                   |
|--------:|:--------------------|:---------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2014-09-05 11:03:00 | 微博评论                               | `俗称找男人`                                                                                                                                                                                                                                           |
|       1 | 2014-09-05 11:33:01 | 微博评论                               | `【资源】`                                                                                                                                                                                                                                             |
|       2 | 2014-09-05 11:33:01 | 微博评论                               | `这个 NB`                                                                                                                                                                                                                                              |
|       3 | 2014-09-05 11:33:01 | 微博评论                               | `工具是不错 就是我的ubuntu14貌似语法高亮不能用`                                                                                                                                                                                                        |
|       4 | 2014-09-05 11:33:01 | 微博评论                               | `安装失败。示File &quot;/usr/local/bin/cheat&quot;, line 36, in &lt;module&gt; from docopt import docopt`                                                                                                                                              |
|       5 | 2014-09-05 12:03:00 | 微博评论                               | `这个不错`                                                                                                                                                                                                                                             |
|       6 | 2014-09-05 13:03:00 | 微博评论                               | `Repost`                                                                                                                                                                                                                                               |
|       7 | 2014-09-05 13:23:00 |                                        | `试试pip install docopt`                                                                                                                                                                                                                               |
|       8 | 2014-09-05 13:33:01 | 微博评论                               | `这个可以有`                                                                                                                                                                                                                                           |
|       9 | 2014-09-05 15:45:20 | netb2c                                 | `很不错哦,`                                                                                                                                                                                                                                            |
|      10 | 2014-09-05 16:15:01 | netb2c                                 | `没有安装，安装 一下就OK了。 文章有写 pip install docopt`                                                                                                                                                                                              |
|      11 | 2014-09-05 21:25:24 | 微博评论                               | `@mywiz 试一试`                                                                                                                                                                                                                                        |
|      12 | 2014-09-06 00:03:00 | 微博评论                               | `这个可以的，适合我等脑子不够用的`                                                                                                                                                                                                                     |
|      13 | 2014-09-06 14:16:37 | 王子归来                               | `centos 6.5下高亮策略失败`                                                                                                                                                                                                                             |
|      14 | 2014-09-06 14:18:16 | 王子归来                               | `可以下载docopt的安装包https://pypi.python.org/simple/docopt/`                                                                                                                                                                                         |
|      15 | 2014-09-08 08:53:04 | netb2c                                 | `1.像我这样习惯vim而不会用nano的朋友可以用export EDITOR = /usr/bin/vi替代文中export EDITOR = /usr/bin/nano<br /> 2.文中cheat -xyz&nbsp;&nbsp;这个命令是不是有问题.&nbsp;&nbsp;我在不同的平台上测试都不行哦.需要加&nbsp;&nbsp;-e 参数才可以新建备忘录.` |
|      16 | 2014-09-08 08:53:40 | netb2c                                 | `高亮是可以实现的.`                                                                                                                                                                                                                                    |
|      17 | 2014-09-08 10:58:34 | 王子归来                               | `是我哪里设置错了吗？我怎么没有实现呢？`                                                                                                                                                                                                               |
|      18 | 2014-09-10 15:11:15 |                                        | `同测。cheat -e xyz`                                                                                                                                                                                                                                   |
|      19 | 2014-09-11 18:04:53 | JonathanLin                            | `我也一样 centos 6.5， 没有高亮`                                                                                                                                                                                                                       |
|      20 | 2014-09-11 18:32:54 | JonathanLin                            | `GitHub上说的是 export CHEATCOLORS=true （多了一个S），而不是export CHEATCOLOR=true。但是我设置了以后也没有高亮`                                                                                                                                       |
|      21 | 2014-09-21 08:05:26 | ZhenboLi                               | `现在安装已经很方便了，直接<br /> sudo pip install cheat<br /> 就可以`                                                                                                                                                                                 |
|      22 | 2014-11-25 13:25:11 | 来自 - 广东广州 的 Chrome/Windows 用户 | `安装到这一步就报错了pip install docopt pygments`                                                                                                                                                                                                      |
|      23 | 2015-02-02 15:11:51 | 来自 - 浙江 的 Chrome/Windows 用户     | `Arch用户请yaourt cheat-git...`                                                                                                                                                                                                                        |
