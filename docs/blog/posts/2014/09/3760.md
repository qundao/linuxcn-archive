...
|      15 | 2014-09-08 08:53:04 | netb2c                                 | 1.像我这样习惯vim而不会用nano的朋友可以用export EDITOR = /usr/bin/vi替代文中export EDITOR = /usr/bin/nano<br />                      |
|         |                     |                                        | 2.文中cheat -xyz&nbsp;&nbsp;这个命令是不是有问题.&nbsp;&nbsp;我在不同的平台上测试都不行哦.需要加&nbsp;&nbsp;-e 参数才可以新建备忘录.                                        |
...
|      21 | 2014-09-21 08:05:26 | ZhenboLi                               | 现在安装已经很方便了，直接<br />                                                                                                     |
