...
|       6 | 2014-09-04 12:57:00 |                                           | `非常感谢，Thinkpad T410按照方法已经解决挂起不能恢复的问题。<br /> 1、重装desktop，unity<br /> 2、卸载nvidia包<br /> 3、启动后重新安装专用版nvidia包。<br /> <br /> 一切OK！` |
...
|      11 | 2017-09-20 09:54:12 | 来自福建厦门的 Chrome 60.0-Windows 7 用户 | `必须赞一个啊，我也是试了好多种方法，最后是删了sudo apt-get remove --purge nvidia*，之前自己配置环境变量导致系统崩溃，<br /> 改回环境变量再删除 nvidia* 就好了`               |
