...
|       5 | 2014-06-26 15:37:13 | Zhang_Longqi                           | 对于译文最好加上原文链接http://www.linuxvoice.com/be-a-kernel-hacker/有时候英较好的的同学可以去查看原文以及弥补翻译的不足,<br /> |
|         |                     |                                        | 还有就是文章里曼涉及到的重要链接不要丢失了,这是其中项目的github链接https://github.com/vsinitsyn/reverse                                                        |
|       6 | 2014-07-03 11:32:47 | breakersun                             | 新装的ubuntu10.04, git上的源码编不通, 什么情况<br />                                                                             |
...
|       8 | 2014-07-03 13:24:30 | linux                                  | 文末的这种信息，在我们的CMS里面没有单独拎出来，所以很难每页都显示，我想想办法~<br />                                             |
