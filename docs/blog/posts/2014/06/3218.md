...
date_updated: 2014-06-18 13:44:00
slug: article-3218-1.html
url: https://linux.cn/article-3218-1.html
url_from: http://xmodulo.com/2014/05/use-lvm-linux.html
image: album/201406/18/134408sa12dauefffyszfg.jpg
tags:
  - lvm
  - 分区
  - 磁盘
...
|   index | 日期                | 日期                                       | 评论                                                                                                                                                                                   |
|--------:|:--------------------|:-------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2014-06-25 14:06:31 | tenght                                     | LVM是一个非常给力的工具啊~~                                                                                                                                                            |
|       1 | 2016-02-13 01:46:08 | 来自广东的 Firefox 41.0|Ubuntu 用户        | 非常感谢楼主的分享, 一直使用古老的分区方式(额,因为我是做开发的咯...), LZ 的文章让我完全理解了使用 LVM 的基础知识. 感觉 LZ 这篇文章是介绍 LVM 基础概念和命令使用最好的一篇文章了, 感谢! |
|       2 | 2016-06-16 12:50:04 | 来自江苏苏州的 Chrome 49.0|Windows 7 用户  | lvm1中vg的数量有限制，lvm2的话没有限制，是不是说lvm可以无限扩容啦？                                                                                                                    |
|       3 | 2017-05-23 17:57:14 | 来自湖南长沙的 Chrome 45.0|Windows 10 用户 | 谢谢楼主分享， 在实际情况下是不可以卸载的                                                                                                                                              |
|       4 | 2020-05-31 14:52:51 | 来自北京的 Firefox 76.0|Windows 10 用户    | 想知道上面用的什么终端 ? 能显示行号和彩色字体的 ？                                                                                                                                     |
|       5 | 2020-06-22 17:26:39 | 来自北京的 Chrome 83.0|Windows 10 用户     | 扩展的LV用挂载吗                                                                                                                                                                       |
|       6 | 2020-06-23 15:42:06 | 来自浙江宁波的 Chrome 83.0|Windows 10 用户 | .....                                                                                                                                                                                  |
|       7 | 2021-02-02 16:36:33 | 来自浙江的 Chrome 88.0|Windows 10 用户     | 感谢分享                                                                                                                                                                               |
|       8 | 2021-07-16 14:35:39 | 来自广东广州的 Chrome 78.0|GNU/Linux 用户  | 可以的，不过服务器要暂停一下，不要有大量读写，不然会显示设备忙就只能加 -l强制卸载                                                                                                      |
