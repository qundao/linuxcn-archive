...
date_updated: 2014-11-02 09:36:00
slug: article-4140-1.html
url: https://linux.cn/article-4140-1.html
url_from: http://xmodulo.com/2014/08/configure-network-printer-scanner-ubuntu-desktop.html
image: album/201411/01/225819cd1hgmbbmckbj3g7.jpg
tags:
  - cpus
  - 打印机
categories:
...
在[之前的文章中](https://linux.cn/article-4139-1.html), 我们讨论过如何在Linux服务器安装各种各样的打印机（当然也包括网络扫描仪）。今天我们将来处理另一端：如何通过桌面客户端来访问网络打印机/扫描仪。
...
|   index | 日期                | 日期     | 评论                      |
|--------:|:--------------------|:---------|:--------------------------|
|       0 | 2014-11-02 10:03:00 | 微博评论 | `Repost`                  |
|       1 | 2014-11-02 10:24:50 | disylee  | `转移个,因为好久没翻译廖` |
