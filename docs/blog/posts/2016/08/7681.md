...
date_updated: 2016-08-14 09:33:00
slug: article-7681-1.html
url: https://linux.cn/article-7681-1.html
url_from: http://www.tecmint.com/smem-linux-memory-usage-per-process-per-user/
image: album/201608/14/093234hpdr9hvdchhch9fh.jpg
tags:
  - smem
  - 内存
  - 监控
...
首先启用 [EPEL (Extra Packages for Enterprise Linux)](https://linux.cn/article-2324-1.html) 软件源，然后按照下列步骤操作：
...
|   index | 日期                | 日期                           | 评论       |
|--------:|:--------------------|:-------------------------------|:-----------|
|       0 | 2016-09-02 13:11:35 | 不简单 [Chrome 52.0|Windows 7] | 装上试试！ |
