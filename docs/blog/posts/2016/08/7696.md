...
date_updated: 2016-08-19 17:24:00
slug: article-7696-1.html
url: https://linux.cn/article-7696-1.html
url_from: http://www.tecmint.com/learn-python-programming-to-write-linux-shell-scripts/
image: album/201608/19/172455zlxmmxuz7nv73nj6.png
tags:
  - python
  - 脚本
categories:
...
在“[Linux 平台下 Python 脚本编程入门](https://linux.cn/article-7693-1.html)”系列之前的文章里，我们向你介绍了 Python 的简介，它的命令行 shell 和 IDLE（LCTT 译注：python 自带的一个 IDE）。我们也演示了如何进行算术运算、如何在变量中存储值、还有如何打印那些值到屏幕上。最后，我们通过一个练习示例讲解了面向对象编程中方法和属性概念。
...
|   index | 日期                | 日期                                           | 评论                                                                                                                                          |
|--------:|:--------------------|:-----------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2017-07-31 11:37:58 | 来自广东佛山的 Chrome 59.0-Windows 8.1 用户    | `感觉和C语言很像`                                                                                                                             |
|       1 | 2018-12-18 18:04:30 | 来自甘肃的 Chrome Mobile 56.0-Android 7.0 用户 | `大神帮做个作业<br /> (1)用Linux shell脚本实现<br /> (2)用两个循环<br /> *<br /> ***<br /> *****<br /> *******<br /> *****<br /> ***<br /> *` |
|       2 | 2018-12-18 18:04:32 | 来自甘肃的 Chrome Mobile 56.0-Android 7.0 用户 | `大神帮做个作业<br /> (1)用Linux shell脚本实现<br /> (2)用两个循环<br /> *<br /> ***<br /> *****<br /> *******<br /> *****<br /> ***<br /> *` |
|       3 | 2018-12-18 18:04:36 | 来自甘肃的 Chrome Mobile 56.0-Android 7.0 用户 | `大神帮做个作业<br /> (1)用Linux shell脚本实现<br /> (2)用两个循环<br /> *<br /> ***<br /> *****<br /> *******<br /> *****<br /> ***<br /> *` |
|       4 | 2018-12-18 18:04:37 | 来自甘肃的 Chrome Mobile 56.0-Android 7.0 用户 | `大神帮做个作业<br /> (1)用Linux shell脚本实现<br /> (2)用两个循环<br /> *<br /> ***<br /> *****<br /> *******<br /> *****<br /> ***<br /> *` |
