...
date_updated: 2016-07-21 10:21:00
slug: article-7600-1.html
url: https://linux.cn/article-7600-1.html
url_from: 
  http://www.tecmint.com/manage-and-create-lvm-parition-using-vgcreate-lvcreate-and-lvextend/
image: album/201607/20/232801y520roewoe2uquro.png
tags:
  - lfcs
  - lvm
categories:
...
由于 LFCS 考试中的一些改变已在 2016 年 2 月 2 日生效，我们添加了一些必要的专题到 [LFCS 系列](https://linux.cn/article-7161-1.html)。我们也非常推荐备考的同学，同时阅读 [LFCE 系列](http://www.tecmint.com/installing-network-services-and-configuring-services-at-system-boot/)。
...
本文介绍了 [逻辑卷管理](https://linux.cn/article-3965-1.html)，一个用于管理可扩展存储设备的多功能工具。与 RAID（曾在本系列讲解过的 [第六讲：组装分区为RAID设备——创建和管理系统备份](https://linux.cn/article-7229-1.html)）结合使用，你将同时体验到（LVM 带来的）可扩展性和（RAID 提供的）冗余。
...
|   index | 日期                | 日期                                         | 评论                                                                                            |
|--------:|:--------------------|:---------------------------------------------|:------------------------------------------------------------------------------------------------|
|       0 | 2016-07-21 12:18:51 | 来自陕西西安的 Chrome 51.0|GNU/Linux 用户    | LVM2分区空间是动态扩展的吗？？！！                                                              |
|       1 | 2016-07-22 16:34:07 | 来自江苏苏州的 Safari 9.1|Mac 10.11 用户     | 貌似不是                                                                                        |
|       2 | 2016-07-23 00:19:01 | 来自湖北武汉的 QQ Browser 9.4|Windows 7 用户 | 说真的lvm是套落后的东西了，很多现代的fs实现替代了lvm几乎所有功能，并且少了一层layer更高效稳定。 |
|       3 | 2018-12-14 12:19:22 | 来自日本的 Firefox 60.0|Mac 10.13 用户       | ZFS嗎？我記得Linux還沒有對ZFS提供native support                                                 |
