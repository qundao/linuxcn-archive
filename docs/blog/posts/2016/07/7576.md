...
date_updated: 2016-07-15 08:27:00
slug: article-7576-1.html
url: https://linux.cn/article-7576-1.html
url_from: https://fedoramagazine.org/monitor-linux-netdata/
image: album/201607/14/222943cr2e9qqbliqz2z0r.png
tags:
  - netdata
  - 监控
categories:
...
|   index | 日期                | 日期                                          | 评论                                                                                                                                                                                                                             |
|--------:|:--------------------|:----------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2016-07-15 10:16:47 | alpha [Firefox 47.0|Windows 7]                | 必须得尝试下了啊！！！高大上啊！！！                                                                                                                                                                                             |
|       1 | 2016-07-16 10:22:46 | tphz [Chrome 50.0|Windows 10]                 | 安装了，很好，界面优美，信息丰富。                                                                                                                                                                                               |
|       2 | 2016-07-19 11:48:17 | 来自浙江杭州的 QQ Browser 9.4|Windows 10 用户 | 只能单机                                                                                                                                                                                                                         |
|       3 | 2016-07-19 21:41:12 | linux [Chrome 50.0|Mac 10.11]                 | 怎么会只能单机——这是基于 Web 的，显然可以通过任何浏览器来远程访问。文章中只是为了演示，才用了&nbsp;&nbsp;localhost 而已。另外，所占用的端口也不是默认的80 ，如果你的80端口没用，可以修改用这个端口。有时候别的端口防火墙会挡住。 |
|       4 | 2016-07-20 18:04:34 | 来自浙江杭州的 QQ Browser 9.4|Windows 10 用户 | 可以集中收集？还不是一个程序一台机器                                                                                                                                                                                             |
|       5 | 2016-07-20 20:23:28 | linux [Chrome 50.0|Mac 10.11]                 | 只能监控本机。没有 agent。                                                                                                                                                                                                       |
|       6 | 2016-07-22 11:14:42 | 南宫迟殇 [Chrome 48.0|Windows 7]              | 为什么我在rhl7装了之后系统崩溃，现在连系统都打不开？                                                                                                                                                                             |
|       7 | 2016-07-23 10:04:36 | 来自浙江杭州的 Chrome 48.0|GNU/Linux 用户     | 我安装后没有图形界面啊 晕了 按照github教程安装的 依赖都装上了 这是什么意思？                                                                                                                                                     |
