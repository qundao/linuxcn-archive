...
date_updated: 2016-09-30 14:26:20
slug: article-7824-1.html
url: https://linux.cn/article-7824-1.html
url_from: https://www.howtoforge.com/tutorial/octave-audio-signal-processing-ubuntu/
image: album/201609/30/142614fv37zcv20r20svvs.jpg
tags:
  - octave
  - 音频
categories:
...
在[前一篇的指导教程](https://linux.cn/article-7755-1.html)中，我们看到了读、写以及重放音频文件的简单步骤，我们甚至看到如何从一个周期函数比如余弦函数合成一个音频文件。在这篇指导教程中，我们将会看到如何对信号进行叠加和倍乘（调整），并应用一些基本的数学函数看看它们对原始信号的影响。
...
|   index | 日期                | 日期                                      | 评论                             |
|--------:|:--------------------|:------------------------------------------|:---------------------------------|
|       0 | 2016-09-30 15:59:23 | 来自云南昆明的 Chrome 53.0-Windows 7 用户 | `不明觉厉~`                      |
|       1 | 2016-10-03 19:13:14 | youyoulemon [Chrome 53.0-Windows 10]      | `玄学<br /> <br /> 不懂。。。。` |
