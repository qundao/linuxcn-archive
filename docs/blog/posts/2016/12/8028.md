...
date_updated: 2016-12-11 12:37:17
slug: article-8028-1.html
url: https://linux.cn/article-8028-1.html
url_from: http://www.tecmint.com/enable-shell-debug-mode-linux/
image: album/201612/11/123710ekugnqneekklrbn6.jpg
tags:
  - 脚本
  - 调试
categories:
...
然而，当我们开始写非常长或上千行命令的高级脚本，例如改变系统设置的脚本，[在网络上执行关键备份](https://linux.cn/article-5694-1.html) 等等，我们会意识到仅仅看脚本输出是不足以在脚本中找到 Bug 的！
...
一个脚本与其它文件的区别是它的首行，它包含 `#!` （She-Bang - [释伴](https://linux.cn/article-3664-1.html)：定义文件类型）和路径名（解释器路径），通知系统该文件是一个命令集合，将被指定程序(解释器)解释。
