...
date_updated: 2016-12-30 16:37:00
slug: article-8077-1.html
url: https://linux.cn/article-8077-1.html
url_from: https://www.linux.com/learn/sysadmin/building-email-server-ubuntu-linux-part-2
image: album/201612/30/163706dtz1d4e4jg4g2i8j.jpg
tags:
  - dovecot
  - imap
  - postfix
...
在[第一部分](https://linux.cn/article-8071-1.html)中，我们安装并测试了 Postfix SMTP 服务器。Postfix 或任何 SMTP 服务器都不是一个完整的邮件服务器，因为它所做的只是在 SMTP 服务器之间移动邮件。我们需要 Dovecot 将邮件从 Postfix 服务器移动到用户的收件箱中。
...
|   index | 日期                | 日期                                    | 评论                 |
|--------:|:--------------------|:----------------------------------------|:---------------------|
|       0 | 2016-12-30 21:23:27 | 来自广东佛山的 Firefox 50.0-Ubuntu 用户 | `很有用！长见识了！` |
