...
|       3 | 2017-02-16 20:36:23 | RobberPhex [Firefox 51.0-Android 6.0]              | `可以参考 https://confluence.jetbrains.com/display/PYH/Installing+PyCharm+on+Linux+according+to+FHS?src=search<br /> <br /> 按照FHS的方式安装pycharm，装在家目录不太符合FHS` |
|       4 | 2017-05-27 16:16:53 | 来自四川成都的 Firefox 53.0-GNU/Linux 用户         | `arch上就简单多了……<br /> pacman -S pycharm<br /> 或者<br /> gnome软件中心（gnome-software）好像也有，点以下就安装`                                                          |
