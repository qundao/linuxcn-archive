...
date_updated: 2016-12-18 09:21:00
slug: article-8042-1.html
url: https://linux.cn/article-8042-1.html
url_from: http://www.tecmint.com/add-colors-to-command-output-terminal-linux/
image: album/201612/17/152819ixmji7o5it8dx46o.jpg
tags:
  - lolcat
categories:
  - 技术
...
[lolcat 命令](https://linux.cn/article-5798-1.html)可以满足上面的需求。它基本上通过与 [cat 命令](http://www.tecmint.com/13-basic-cat-command-examples-in-linux/)类似的方式将文件或标准输入定向到标准输出来运行，覆盖某个命令的默认屏幕输出颜色，并为其添加彩色。
...
* [安装 lolcat 来在 Linux 中显示彩色输出](https://linux.cn/article-5798-1.html)
...
|   index | 日期                | 日期                                                           | 评论                                                                        |
|--------:|:--------------------|:---------------------------------------------------------------|:----------------------------------------------------------------------------|
|       0 | 2016-12-18 12:21:46 | 来自湖北武汉华中科技大学的 Chrome Mobile 46.0-Android 6.0 用户 | `个人趣味`                                                                  |
|       1 | 2016-12-18 17:32:10 | 来自117.136.70.49的 Firefox 50.0-GNU/Linux 用户                | `screenfetch - lolcat`                                                      |
|       2 | 2016-12-19 13:22:48 | 来自山东青岛的 Chrome 55.0-GNU/Linux 用户                      | `echo &quot;----------------------------＼(・ω・)／&quot; - lolcat -ad 400` |
|       3 | 2016-12-19 13:24:33 | 来自山东青岛的 Chrome 55.0-GNU/Linux 用户                      | `M-x nyan-mode`                                                             |
|       4 | 2016-12-29 10:54:46 | Slience [Chrome 55.0-Windows 7]                                | `哟呵`                                                                      |
