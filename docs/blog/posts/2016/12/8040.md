...
|       4 | 2016-12-19 09:27:50 | buaabyl [Chrome 55.0-Windows 7]                        | `对于桌面版的ubuntu，可以试试如下的命令取消后台更新服务：<br /> systemctl stop apt-daily.service<br /> systemctl stop apt-daily.timer<br /> 不行再杀apt进程:)`                                                                                                                                                                  |
