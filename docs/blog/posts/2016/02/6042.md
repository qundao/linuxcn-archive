...
date_updated: 2016-02-05 08:15:00
slug: article-6042-1.html
url: https://linux.cn/article-6042-1.html
url_from: http://locez.com/Linux/install-program-on-ubuntu-fedora/
image: album/201508/16/222746e5vh38d7ey3leyps.jpg
tags:
  - 安装软件
  - 编译
categories:
...
新进入 Linux 世界的朋友们，也许你已经[下载好了 Linux 的安装 ISO](https://linux.cn/article-4130-1.html)，并且[安装好了你的 Linux](https://linux.cn/article-5893-1.html) ，那么接下来，你也许希望安装一些 Linux 上用的软件。开始你可能会使用图形界面的软件中心来安装，有时候也需要使用命令行来安装，或者甚至需要自己去编译一个二进制出来——这是多么神奇的一件事啊。
...
|   index | 日期                | 日期                                                   | 评论                                                                                                                                                                                                                                                                                                                                                                                                                               |
|--------:|:--------------------|:-------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2015-08-19 17:52:21 | dadudeng [Opera 10.5-Android 4.1]                      | `太好了，学习了`                                                                                                                                                                                                                                                                                                                                                                                                                   |
|       1 | 2015-09-07 13:50:05 | 大葱蘸酱就饼 [Chrome 44.0-Windows 8.1]                 | `学习了~`                                                                                                                                                                                                                                                                                                                                                                                                                          |
|       2 | 2015-12-19 22:08:44 | yang.yusi [Firefox 43.0-Ubuntu]                        | `很实用的东西，非常不错`                                                                                                                                                                                                                                                                                                                                                                                                           |
|       3 | 2015-12-27 19:14:37 | 来自上海的 Chrome 47.0-Windows 7 用户                  | `写的非常棒！谢谢！`                                                                                                                                                                                                                                                                                                                                                                                                               |
|       4 | 2016-01-18 20:05:51 | attack [QQ Browser 9.2-Windows 7]                      | `谢谢`                                                                                                                                                                                                                                                                                                                                                                                                                             |
|       5 | 2016-02-05 06:40:30 | ryt [Chrome 47.0-GNU/Linux]                            | `很适合新手`                                                                                                                                                                                                                                                                                                                                                                                                                       |
|       6 | 2016-02-05 11:23:19 | kashu [Chromium 47.0-Ubuntu]                           | `还是一些基础的技术教程类文章更受大家的欢迎……`                                                                                                                                                                                                                                                                                                                                                                                     |
|       7 | 2016-02-05 13:15:54 | 来自安徽合肥的 Internet Explorer 11.0-Windows 7 用户   | `fedora22以前的版本用的是yum，现在换dnf了`                                                                                                                                                                                                                                                                                                                                                                                         |
|       8 | 2016-02-08 17:47:31 | 浩浩君 [Chrome 45.0-Windows 7]                         | `假装老司机，过来瞧瞧！`                                                                                                                                                                                                                                                                                                                                                                                                           |
|       9 | 2016-02-21 14:58:38 | ak2008 [Chrome 48.0-GNU/Linux]                         | `很适合新手`                                                                                                                                                                                                                                                                                                                                                                                                                       |
|      10 | 2016-10-21 21:39:32 | 来自河南南阳的 Firefox 49.0-Ubuntu 用户                | `我就是看看我的id`                                                                                                                                                                                                                                                                                                                                                                                                                 |
|      11 | 2016-10-21 22:12:07 | linux [Chrome 54.0-Mac 10.11]                          | `你没 ID ……其实我知道你是想炫耀你的 Firefox 49.0&nbsp;&nbsp;: -d`                                                                                                                                                                                                                                                                                                                                                                  |
|      12 | 2016-11-13 21:21:11 | 来自广东广州的 Firefox 45.0-Ubuntu 用户                | `楼主，有地方不懂呢，能在之后教程解释下吗？ <br /> configure: error: --with-ssl=gnutls was given, but GNUTLS is not available.<br /> 错误提示说，给定的 SSL 是 gnutls 但是却不可用（因为没有安装），<br /> 因此我们安装并指定 openssl 为 wget 的 SSL 。<br /> 这个openssl跟之前那个错误是什么关系呢？还有后面那个libssl-dev<br /> <br /> 然后又出现<br /> $ sudo apt-get install openssl <br /> $ sudo apt-get install libssl-dev` |
|      13 | 2017-01-13 16:26:20 | 来自北京的 Chrome 55.0-Windows 10 用户                 | `are you&nbsp;&nbsp;NANYANG TOO`                                                                                                                                                                                                                                                                                                                                                                                                   |
|      14 | 2017-05-03 15:26:35 | 来自浙江杭州的 Chrome 48.0-Windows 7 用户              | `asdfdsds`                                                                                                                                                                                                                                                                                                                                                                                                                         |
|      15 | 2017-05-03 15:28:53 | 来自浙江杭州的 Chrome 57.0-Windows 7 用户              | `写的非常棒`                                                                                                                                                                                                                                                                                                                                                                                                                       |
|      16 | 2017-05-05 00:19:52 | 来自四川成都的 Chrome 58.0-GNU/Linux 用户              | `试试看`                                                                                                                                                                                                                                                                                                                                                                                                                           |
|      17 | 2017-05-21 20:50:35 | tenBlackTea [Chrome 58.0-Windows 7]                    | `写的很棒`                                                                                                                                                                                                                                                                                                                                                                                                                         |
|      18 | 2017-07-25 23:36:15 | 张熙熙 [Internet Explorer 11.0-Windows 10]             | `是ubuntu还是fedora，这个问题，一直在纠结，但从未被解决。`                                                                                                                                                                                                                                                                                                                                                                         |
|      19 | 2017-07-27 17:44:32 | 张熙熙 [Firefox 54.0-Ubuntu]                           | `值得一看，不错`                                                                                                                                                                                                                                                                                                                                                                                                                   |
|      20 | 2017-08-11 01:24:54 | 来自湖北武汉的 Chromium 59.0-Ubuntu 用户               | `不知道自己打id是什么`                                                                                                                                                                                                                                                                                                                                                                                                             |
|      21 | 2017-09-28 23:31:35 | 来自贵州贵阳的 Microsoft Edge 15.15063-Windows 10 用户 | `我的id`                                                                                                                                                                                                                                                                                                                                                                                                                           |
|      22 | 2019-08-12 16:52:45 | 来自湖北武汉的 Chrome 76.0-GNU/Linux 用户              | `我试了下,把我的安装的软件全部卸载了,害的我又重新装一边`                                                                                                                                                                                                                                                                                                                                                                           |
|      23 | 2019-08-12 16:52:47 | 来自湖北武汉的 Chrome 76.0-GNU/Linux 用户              | `我试了下,把我的安装的软件全部卸载了,害的我又重新装一边`                                                                                                                                                                                                                                                                                                                                                                           |
|      24 | 2019-08-12 16:52:50 | 来自湖北武汉的 Chrome 76.0-GNU/Linux 用户              | `我试了下,把我的安装的软件全部卸载了,害的我又重新装一边`                                                                                                                                                                                                                                                                                                                                                                           |
