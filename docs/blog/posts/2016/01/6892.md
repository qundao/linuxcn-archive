...
|       1 | 2016-01-19 08:51:40 | 来自河北保定的 Firefox 43.0|Windows Server 2003 用户 | 昨天根据此文指导实战。因WIN7升级WIN10导致原多系统GRUB1.99出错。<br />                                                                 |
...
|       5 | 2016-01-21 10:39:23 | alpha [Firefox 43.0|Windows 7]                       | grub&gt; set root=(hd0,5)<br />                                                                                                       |
...
|         |                     |                                                      | 如果我说得不对请lz指正！！                                                                                                                        |
|       6 | 2016-01-22 21:44:22 | 来自河北保定的 Iceweasel 38.5|GNU/Linux 用户         | sudo umount /mnt/{sys,proc,dev/pts,dev,}<br />                                                                                        |
|         |                     |                                                      | 一行umount，用起来比较方便                                                                                                                      |
