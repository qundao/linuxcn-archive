...
date_updated: 2016-01-18 08:32:00
slug: article-6892-1.html
url: https://linux.cn/article-6892-1.html
url_from: https://www.linuxvoice.com/grub-2-heal-your-bootloader/
image: album/201601/15/225043icis2q8s9wpspp8n.jpg
tags:
  - bootloader
  - grub 2
  - 启动
...
|   index | 日期                | 日期                                                 | 评论                                                                                                                                                                                                                                                                                                                                                                  |
|--------:|:--------------------|:-----------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2016-01-18 11:13:25 | 来自四川成都的 Chrome 47.0-GNU/Linux 用户            | `这个页面有问题，crhome 打开会导致高 CPU 占用率。`                                                                                                                                                                                                                                                                                                                    |
|       1 | 2016-01-19 08:51:40 | 来自河北保定的 Firefox 43.0-Windows Server 2003 用户 | `昨天根据此文指导实战。因WIN7升级WIN10导致原多系统GRUB1.99出错。<br /> 用的Debian 7 live 进行修复。遇到问题：<br /> 1、 sudo add-apt-repository ppa:yannubuntu/Boot Repair的命令出错，准确的说是 add-apt-repository不存在，我也白到不知道怎么添加。<br /> 2、grub2-install 无此命令。原系统自带的grub版本号是1.99，所以使用grub-install解决问题，包括grub-mkconfig。` |
|       2 | 2016-01-19 11:15:39 | linux [Chrome 47.0-Mac 10.11]                        | `已经修复，是一个没必要的效果导致的。`                                                                                                                                                                                                                                                                                                                                |
|       3 | 2016-01-19 11:19:49 | 来自天津的 Firefox 43.0-Ubuntu 用户                  | `去官网用deb包装，注意依赖。`                                                                                                                                                                                                                                                                                                                                         |
|       4 | 2016-01-21 10:31:26 | alpha [Firefox 43.0-Windows 7]                       | `有彻底的梳理了一遍啊！！感谢lz！！`                                                                                                                                                                                                                                                                                                                                  |
|       5 | 2016-01-21 10:39:23 | alpha [Firefox 43.0-Windows 7]                       | `grub&gt; set root=(hd0,5)<br /> &nbsp; &nbsp; grub&gt; linux /boot/vmlinuz-3.13.0-24-generic root=/dev/sda5<br /> &nbsp; &nbsp; grub&gt; initrd /boot/initrd.img-3.13.0-24-generic<br /> 文章中的这个配置有问题，hd设备是0开始的，而sda则是1开始，所有此处应该改为sda6。<br /> 如果我说得不对请lz指正！！`                                                           |
|       6 | 2016-01-22 21:44:22 | 来自河北保定的 Iceweasel 38.5-GNU/Linux 用户         | `sudo umount /mnt/{sys,proc,dev/pts,dev,}<br /> 一行umount，用起来比较方便`                                                                                                                                                                                                                                                                                           |
