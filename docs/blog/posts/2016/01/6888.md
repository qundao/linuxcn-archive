...
date_updated: 2016-01-14 10:08:00
slug: article-6888-1.html
url: https://linux.cn/article-6888-1.html
url_from: http://www.linuxvoice.com/linux-101-get-the-most-out-of-systemd/
image: album/201601/14/100144meleklgv6dpff17q.png
tags:
  - systemd
categories:
  - 技术
...
> 这是我所阅读过的最简明扼要的 Systemd 教程，快速而清晰地讲述了 Systemd 的主要内容。无论你讨厌它还是喜欢它 ，只有了解才有正确的认识。
...
|   index | 日期                | 日期                                       | 评论                                                                                                                     |
|--------:|:--------------------|:-------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------|
|       0 | 2016-01-14 19:57:49 | 来自四川成都的 Chrome 47.0-GNU/Linux 用户  | `ps ax - grep systemd，看到第一行，其中的数字 1 表示它的进程号是1<br /> <br /> ps --pid 1`                               |
|       1 | 2016-01-15 07:58:41 | 来自广西来宾的 Chrome 47.0-Windows XP 用户 | `Uselessd还活着？`                                                                                                       |
|       2 | 2016-01-15 18:35:16 | 文剑一飞 [Chrome 47.0-Windows 7]           | `还以为看题图就能看懂……`                                                                                                 |
|       3 | 2016-01-15 19:22:41 | qiansen [Chrome 47.0-GNU/Linux]            | `大势所趋！！！`                                                                                                         |
|       4 | 2016-01-17 10:24:53 | ninedoors [Chrome 45.0-Windows 10]         | `学习了~`                                                                                                                |
|       5 | 2016-01-18 09:39:16 | 来自广东广州的 Chrome 49.0-Windows 7 用户  | `一直命令行，用旧版centos。关我卵事`                                                                                     |
|       6 | 2016-01-18 16:50:29 | Print [Chrome 47.0-Windows 7]              | `这些功能的确很好，支持`                                                                                                 |
|       7 | 2016-01-19 12:58:56 | 来自美国的 Chrome 47.0-Fedora 用户         | `enable--使能?`                                                                                                          |
|       8 | 2016-01-19 14:37:22 | linux [Chrome 47.0-Mac 10.11]              | `是的，目前并未找到更合适的译法，您有什么建议么？`                                                                       |
|       9 | 2016-01-19 16:47:09 | flashbang [Chrome 47.0-GNU/Linux]          | `enable&nbsp;&nbsp;启用<br /> disable 禁用`                                                                              |
|      10 | 2016-01-19 21:20:32 | linux [Chrome 47.0-Mac 10.11]              | `哦，哈哈哈，我脑袋转筋了，原来这么简单的，为啥我就偏偏非“使能”。。。马上修改过来。`                                     |
|      11 | 2016-01-19 21:23:16 | linux [Chrome 47.0-Mac 10.11]              | `不过，真的有“使能”这么逼格的词在使用。。。`                                                                             |
|      12 | 2016-01-21 09:06:07 | alpha [Firefox 43.0-Windows 7]             | `老实说刚开始接触systemd还真是不适应啊！！！but 这个也是要学的！！`                                                      |
|      13 | 2016-01-24 14:26:40 | 来自广西梧州的 Safari 8.0-Mac 10.10 用户   | `systemd 感觉不太好用，一直习惯service [name] start还有chkconfig。不过这样统一了也挺方便的，Debian集成了Systemd，还好。` |
