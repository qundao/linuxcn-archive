...
date_updated: 2016-11-17 11:20:34
slug: article-7964-1.html
url: https://linux.cn/article-7964-1.html
url_from: http://www.tecmint.com/linux-compress-decompress-bz2-files-using-bzip2
image: album/201611/17/112020lsdqw22lbwtfgvq2.png
tags:
  - bzip2
  - 压缩
categories:
...
对文件进行压缩，可以通过使用较少的字节对文件中的数据进行编码来显著地减小文件的大小，并且在跨网络的[文件的备份和传送](https://linux.cn/article-4503-1.html)时很有用。 另一方面，解压文件意味着将文件中的数据恢复到初始状态。
...
重要的是，你可能想在 Linux 中查看一些重要的 [tar 命令示例](https://linux.cn/article-7802-1.html)，以便学习使用 tar 命令来[创建压缩归档文件](http://www.tecmint.com/compress-files-and-finding-files-in-linux/)。
...
|   index | 日期                | 日期                                            | 评论                                                                                                                                                                |
|--------:|:--------------------|:------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2016-11-17 13:03:21 | 来自四川成都的 Chrome 54.0-Windows 10 用户      | `不知道这种文章有什么价值所在？`                                                                                                                                    |
|       1 | 2016-11-17 13:58:19 | 来自广东深圳的 Chrome 54.0-GNU/Linux 用户       | `tar就好了,&nbsp; &nbsp;高那么多麻烦的东西干嘛!`                                                                                                                    |
|       2 | 2016-11-17 18:08:13 | 来自117.152.72.68的 Chrome 53.0-Windows 10 用户 | `水文，tar/p7zip大法好`                                                                                                                                             |
|       3 | 2016-11-17 18:22:50 | Wf_talk [Firefox 49.0-GNU/Linux]                | `最基础的也是最重要的!`                                                                                                                                             |
|       4 | 2016-11-28 16:34:05 | PingYang [Firefox 50.0-Ubuntu]                  | `tar -j 也是调用的 bzip2，多了解点没坏处`                                                                                                                           |
|       5 | 2022-03-16 19:17:58 | 来自广东江门的 Firefox 98.0-GNU/Linux 用户      | `对于你这类大神来说没啥用，但是对于刚使用gun／linux系统的用户来说帮助很大。<br /> 请多些理解多些关爱小白用户。<br /> 有的人不要懂得些皮毛就自以为是(请勿对号入坐）` |
|       6 | 2022-03-17 09:18:44 | linux [Chrome 99.0-Mac 10.15]                   | `没事，我们这里从小白到大神，都是我们的读者。我们选题广泛，永远不会高高在上不发面对初学者的内容。`                                                                  |
