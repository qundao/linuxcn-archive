...
date_updated: 2016-11-16 11:11:00
slug: article-7960-1.html
url: https://linux.cn/article-7960-1.html
url_from: http://www.tecmint.com/nmap-network-security-scanner-in-kali-linux/
image: album/201611/16/111112g4gqrupqgqglzdsz.png
tags:
  - nmap
  - 扫描
  - 网络安全
...
* [第一部分-为初学者准备的 Kali Linux 安装指南](https://linux.cn/article-7986-1.html)
...
1. [Kali Linux](https://linux.cn/article-7986-1.html) (nmap 可以用于其他操作系统，并且功能也和这个指南里面讲的类似)。
...
使用 nmap 的第一步是登录 Kali Linux，如果需要，就启动一个图形会话（本系列的第一篇文章安装了 [Kali Linux 的 Enlightenment 桌面环境](https://linux.cn/article-7986-1.html)）。
...
|   index | 日期                | 日期                                           | 评论                                          |
|--------:|:--------------------|:-----------------------------------------------|:----------------------------------------------|
|       0 | 2016-11-16 13:18:55 | hsyan2008 [Chrome 54.0-GNU/Linux]              | `挺好的，有zmap的吗？`                        |
|       1 | 2016-11-16 14:59:02 | linux [Chrome 54.0-Mac 10.11]                  | `有的。 https://linux.cn/article-5860-1.html` |
|       2 | 2016-11-16 19:44:37 | 来自江苏南京的 Vivaldi 1.4-GNU/Linux 用户      | `不错，收藏了`                                |
|       3 | 2016-11-18 11:41:12 | 来自北京的 Sogou Explorer 2-Windows 10 用户    | `挺好，分享了`                                |
|       4 | 2016-11-22 11:36:14 | 来自广东广州的 Chromium 53.0-Ubuntu 16.10 用户 | `good test weiba`                             |
|       5 | 2016-11-24 11:15:26 | 上官铁锤 [Chrome 54.0-Windows 10]              | `学习一下`                                    |
