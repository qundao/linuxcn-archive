...
|       1 | 2016-10-12 17:01:44 | 来自四川成都的 Chrome 53.0|GNU/Linux 用户            | 如果希望向远程主机追加内容，到启用了(chattr +a)的日志文件，这是我的变通解决方法。<br />                             |
|         |                     |                                                      | <br />                                                                                                              |
|         |                     |                                                      | declare exec='\su - copyist --command'<br />                                                                        |
|         |                     |                                                      | declare args=&quot;$'\ssh -fnt ${REMOTE_USER}@${REMOTE_HOST} \'echo \'${INFO}\' &gt;&gt; ${LOG_FILE}\''&quot;<br /> |
|         |                     |                                                      | <br />                                                                                                              |
|         |                     |                                                      | eval $exec $args &amp;&gt; /nul                                                                                     |
