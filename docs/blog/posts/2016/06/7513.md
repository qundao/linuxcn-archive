...
date_updated: 2016-06-28 15:54:00
slug: article-7513-1.html
url: https://linux.cn/article-7513-1.html
url_from: https://www.unixmen.com/add-cron-jobs-linux-unix/
image: album/201606/28/155407teajtncbtgt4ptk4.png
tags:
  - cron
  - crontab
  - 定时任务
...
|   index | 日期                | 日期                                              | 评论                                                                                                                                                                                                                                                                    |
|--------:|:--------------------|:--------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2016-06-28 17:16:00 | 来自陕西西安的 Chrome 51.0-GNU/Linux 用户         | `好贴一定要收藏一个`                                                                                                                                                                                                                                                    |
|       1 | 2016-06-28 20:34:47 | 来自117.100.149.184的 Chrome 50.0-Windows 10 用户 | `讲讲systemd里的timer？`                                                                                                                                                                                                                                                |
|       2 | 2016-06-29 08:02:28 | 来自四川成都的 Chrome 51.0-GNU/Linux 用户         | `不得不說 Windows 7, 8,x, 10 的任務計劃功能更強，除了能夠執行定時任務，還可以在空閒時執行，系統開機或關機時執行，可以在用戶登錄或註銷時執行，可以在系統鎖定或解除時執行，可以在特定事件發生時執行，還可以設置若干啓動附件條件，以至於其完整設置需要用 XML 文件來定義。` |
|       3 | 2016-06-29 08:40:28 | ryt [Chrome 51.0-GNU/Linux]                       | `文章中有一处输入错误:<br /> 第4个字段：月份 (0-12 [12 代表 December])<br /> 应该修改为:<br /> 第4个字段：月份 (1-12 [12 代表 December])`                                                                                                                               |
|       4 | 2016-06-29 12:51:13 | linux [Chrome 50.0-Mac 10.11]                     | `所以，systemd 连 timer 也接管了。`                                                                                                                                                                                                                                     |
|       5 | 2016-06-29 12:53:34 | linux [Chrome 50.0-Mac 10.11]                     | `喏： https://linux.cn/article-3996-1.html <br /> 想必因为你是没注册，所以没法搜索吧。`                                                                                                                                                                                 |
|       6 | 2016-07-04 09:57:00 | linux [Chrome 50.0-Mac 10.11]                     | `谢谢~`                                                                                                                                                                                                                                                                 |
