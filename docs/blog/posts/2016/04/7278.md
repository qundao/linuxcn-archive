...
date_updated: 2016-04-27 11:42:52
slug: article-7278-1.html
url: https://linux.cn/article-7278-1.html
url_from: ''
image: album/201604/27/114253g3eycivmiyix5ako.png
tags:
  - node.js
  - tails
categories:
...
最近发展很快的 ubuntuBSD 项目在有了自己的[官方主页](http://www.ubuntubsd.org/)之后，又有了自己的论坛：[https://forums.ubuntubsd.org](https://forums.ubuntubsd.org/)，关心它的朋友可以去看看。ubuntuBSD 项目是一个[将 ubuntu 的桌面嫁接于 FreeBSD 内核上的项目](https://linux.cn/article-7176-1.html)，目前正在[寻求成为 Ubuntu 的官方分支](https://linux.cn/article-7207-1.html)。
...
|   index | 日期                | 日期                                   | 评论                           |
|--------:|:--------------------|:---------------------------------------|:-------------------------------|
|       0 | 2016-04-27 12:25:16 | 二次元萌控森 [Firefox 45.0-Windows 10] | `这年头版本不起飞都不好意思混` |
