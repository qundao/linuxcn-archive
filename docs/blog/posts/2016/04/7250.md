...
|   index | 日期                | 日期                                      | 评论                                                                                                                                                                                             |
|--------:|:--------------------|:------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2016-04-21 09:45:52 | 来自四川成都的 Chrome 50.0|GNU/Linux 用户 | 这个属于 Linux 发行版做的不好的地方，完全可以提供命令支持。<br />                                                                   |
|         |                     |                                           | 下面是我最初参照网上资料写的脚本。<br />                                                                                                             |
|         |                     |                                           | <br />                                                                                                             |
|         |                     |                                           | #!/bin/bash<br />                                                                                                                   |
...
|         |                     |                                           | done                                                                                                                                |
|       1 | 2016-04-21 09:49:10 | 来自四川成都的 Chrome 50.0|GNU/Linux 用户 | 刚才粘贴时有点小问题。最初遇见这个问题时，觉得很不可思议，Windows (VM Guest)添加一块硬盘是不需要重启的，而 Linux 却需要重启！<br /> |
