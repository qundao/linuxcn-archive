...
date_updated: 2016-05-20 10:01:00
slug: article-7365-1.html
url: https://linux.cn/article-7365-1.html
url_from: http://www.tecmint.com/linux-boot-process-and-manage-services/
image: album/201605/19/220703znvejpnejn93vp67.png
tags:
  - lfcs
  - systemd
  - sysvinit
...
|   index | 日期                | 日期                                             | 评论                                                                                                                                                                                                                                     |
|--------:|:--------------------|:-------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2016-07-29 17:58:33 | 来自上海的 Internet Explorer 11.0-Windows 7 用户 | `Configuring a service to start automatically on a specific runlevel and prevent it from starting on all others<br /> <br /> 配置一个服务在一个指定运行等级下自动运行，同时阻止它在其他运行等级下启动<br /> <br /> 我觉得这样更容易明白` |
