...
date_updated: 2020-03-27 10:21:34
slug: article-12041-1.html
...
image: album/202003/27/102025p00901plnn0dllyn.jpg
tags:
  - chage
  - passwd
  - 密码
...
密码时效可能是一个重要的选择，只要它不鼓励用户使用过于简单的密码或以不安全的方式写下来即可。有关控制密码字符（例如，大小写字母、数字等的组合）的更多信息，请参考这篇关于[密码复杂度](https://linux.cn/article-11709-1.html)的文章。
