...
date_updated: 2020-07-26 23:45:28
slug: article-12456-1.html
url: https://linux.cn/article-12456-1.html
url_from: https://itsfoss.com/best-ubuntu-apps/
image: album/202007/26/233613zwuw9lul6x4cqmq6.jpeg
tags:
  - ubuntu
  - 应用
categories:
...
过去，我已经多次写过关于 [安装 Ubuntu 之后该做什么](https://linux.cn/article-12183-1.html)。每次我都建议在 Ubuntu 上安装某些关键的应用程序。
...
[Spotify](https://www.spotify.com//) 是流媒体音乐之王。好消息是它具有官方 Linux 版本。[Ubuntu 上的 Spotify 应用](https://linux.cn/article-9415-1.html) 与媒体键和声音菜单以及桌面通知中心整合良好。请注意，Spotify 服务可能在你的国家有，也可能没有。
...
自由开源的 [VLC](https://www.videolan.org/index.html) 摘得视频播放器桂冠。它几乎支持全部的视频编码。它还允许你将音量增至最高的 200%。它也支持从最后一个已知位置继续播放。有很多 [VLC 使用技巧](https://linux.cn/article-11776-1.html) 供你参考以尽兴使用。
...
[Linux 上的视频编辑器](https://linux.cn/article-10185-1.html) 并不匮乏，毋庸赘述。看看 Ubuntu 中一些功能丰富但相对简单的视频编辑器。
...
Ubuntu 预装了 [LibreOffice](https://www.libreoffice.org/download/download/)，它无疑是 [最佳的开源办公软件](https://linux.cn/article-9379-1.html)。它是个组件完整的办公软件，包括文档编辑器、电子表格工具、演示软件、数学工具和作图工具。你甚至可以用它编辑部分 PDF 文件。
...
这是本清单少有的基于命令行的 Ubuntu 应用之一。如果你想从 YouTube、DailyMotion 或其他视频网站下载视频，youtube-dl 是个绝好的选择。它提供了大量 [视频下载高级选项](https://linux.cn/article-9244-1.html)。
...
[Atom](https://atom.io/) 是一款由 GitHub 推出的 [自由开源的代码编辑器](https://linux.cn/article-7468-1.html)。早在它推出第一个稳定版之前，它就因其用户界面、功能和海量插件而成为程序员的至宠。
...
如果你是个书虫，并收集电子书，你应该使用 [Calibre](https://calibre-ebook.com/)。它是一个电子书管理器，拥有 [创建电子书](https://linux.cn/article-7977-1.html)、转换电子书格式和管理电子书库的所有必要组件。
...
[EncryptPad](https://linux.cn/article-9377-1.html) 是一个开源文本编辑器，它允许你用密码锁定你的文件。你可以选择加密的类型。这个工具也有一个命令行版本。
...
[Linux 上的游戏](https://linux.cn/article-7316-1.html) 体验比几年前改进很多。你可以在 Linux 上畅玩大量游戏，而不用回到 Windows 了。
...
Timeshift 是一个帮助你 [对系统进行快照](https://linux.cn/article-11619-1.html) 的工具。这可以让你在系统配置混乱的情况下，在发生不幸的事时将系统恢复到以前的状态。不过要注意的是，它并不是你个人数据备份的最佳工具。对此，你可以使用U buntu 默认的 Deja Dup（也叫做“备份”）。

##### TestDisk [中级用户]

这是本清单里另一个命令行工具。[TestDisk](https://www.cgsecurity.org/wiki/TestDisk) 可以让你 [恢复 Linux 上的数据](https://linux.cn/article-7974-1.html)。如果你不小心删除了文件，使用 TestDisk 还有机会找回来。
