...
date_updated: 2020-07-08 12:33:47
slug: article-12393-1.html
url: https://linux.cn/article-12393-1.html
url_from: https://opensource.com/article/20/7/install-java-mac
image: album/202007/08/123211djuaz9io7l9dlpd7.jpg
tags:
  - java
  - mac
categories:
...
Java 开发的未来将从更多人安装和使用 Java 开始。因此，我将介绍如何在 macOS 上安装并开始使用 Java 开发环境。（如果你运行的是 Linux，请查看 Seth Kenlon 的文章《[如何在 Linux 上安装 Java](https://linux.cn/article-11614-1.html)》）

#### 通过 Brew 仓库安装 OpenJDK

Homebrew 是 macOS 事实上的标准软件包管理器。如果你还没有安装的话，Matthew Broberg 的文章《[Homebrew 简介](https://linux.cn/article-12338-1.html)》将带你完成这些步骤。
