...
date_updated: 2020-01-29 14:10:00
slug: article-11830-1.html
...
image: album/202001/29/141343ldps4muy4kp64k4l.jpg
tags:
  - ssh
  - 密码
categories:
...
|   index | 日期                | 日期                                      | 评论                                                                                                                                                                                                                                                                                                                      |
|--------:|:--------------------|:------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2022-03-08 10:29:09 | 来自四川自贡的 Chrome 85.0-Mac 10.16 用户 | `RSA 算法现在默认的密钥尺寸为 3072，有点大。推荐使用 Ed25519 算法。<br /> <br /> ssh-keygen -t ed25519<br /> <br /> Ed25519 在 2014 年 01 月引入 OpenSSH 6.5，能够提供比 ECDSA 及 DSA 更佳安全性及良好性能的椭圆曲线签名体系。其主要长处在于速度、时间恒定运行时（从而能够对抗侧信道攻击）以及无需晦暗不明的硬编码常数。` |
