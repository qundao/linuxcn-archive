...
date_updated: 2020-11-03 00:06:00
slug: article-12782-1.html
url: https://linux.cn/article-12782-1.html
url_from: https://ziutek.github.io/2018/05/03/go_on_very_small_hardware3.html
image: album/202011/03/000249cjqpwsrvuuqmr9wn.png
tags:
  - go
categories:
  - 软件开发
...
在本系列的 [第一](https://linux.cn/article-11383-1.html) 和 [第二](https://linux.cn/article-12747-1.html) 部分中讨论的大多数示例都是以某种方式闪烁的 LED。起初它可能很有趣，但是一段时间后变得有些无聊。让我们做些更有趣的事情……
...
在 [第一部分](https://linux.cn/article-11383-1.html) 的开头，我曾问过：“Go 能深入到多低层，而还能做一些有用的事情？”。 我们的 MCU 实际上是一种低端设备（8 比特的人可能会不同意我的看法），但到目前为止，我们还没有做任何有用的事情。
