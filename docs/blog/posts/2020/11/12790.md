...
date_updated: 2020-11-04 19:11:00
slug: article-12790-1.html
url: https://linux.cn/article-12790-1.html
url_from: ''
image: album/202011/04/190932kgror11gnrg0c6pg.jpg
tags:
  - 关机
  - 命令行生存指南
categories:
...
|   index | 日期                | 日期                                                | 评论                                                                                                                                                                                                                                                 |
|--------:|:--------------------|:----------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2020-11-04 21:46:41 | 来自山东泰安的 Chrome 86.0-GNU/Linux 用户           | `哈哈哈这个太谐了`                                                                                                                                                                                                                                   |
|       1 | 2020-11-05 10:15:09 | 来自四川达州的 Chrome Mobile iOS 86.0-iOS 14.1 用户 | `感觉没啥用，又不是不可以卸载。其实用下列命令也能达到这个效果<br /> <br /> systemctl poweroff —force —force<br /> <br /> 上述命令，会在执行完成针对文件系统的 sync 后，强制关机。既不会向进程发 TERM 信号，使其能保存数据，也不会等待服务结束运行。` |
