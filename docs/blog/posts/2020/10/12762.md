...
date_updated: 2020-10-27 21:50:00
slug: article-12762-1.html
url: https://linux.cn/article-12762-1.html
url_from: 
  https://www.zdnet.com/article/linux-5-10-finally-ditches-decades-old-tool-that-caused-security-bugs/
image: album/202010/27/215001zpsdddd3gs72s227.jpg
tags:
  - linux
  - 内核
categories:
...
然而，2010 年，“`[常见漏洞和暴露](Common Vulnerabilities and Exposures)`”（CVE）详细披露了 `set_fs()` 带来的安全问题。通过绕过某些访问限制，证实该函数能够“覆盖任意内核内存位置”和“获得特权” —— 在某些情况下，这可以让用户空间覆盖内核数据。
