...
date_updated: 2020-02-26 21:45:34
slug: article-11935-1.html
url: https://linux.cn/article-11935-1.html
url_from: https://opensource.com/article/19/7/structure-multi-file-c-part-1
image: album/202002/26/214517o5p7q45l2a8jkx4k.jpg
tags:
  - 编程
categories:
  - 软件开发
...
在这篇文章里，我会编写一个小型 C 程序，命名一些东西，同时处理一些复杂性。该程序的结构大致基于我在 《[如何写一个好的 C 语言 main 函数](https://linux.cn/article-10949-1.html)》 文中讨论的。但是，这次做一些不同的事。准备好你喜欢的饮料、编辑器和编译器，放一些音乐，让我们一起编写一个有趣的 C 语言程序。
