...
date_updated: 2020-02-23 21:57:30
slug: article-11923-1.html
url: https://linux.cn/article-11923-1.html
url_from: https://opensource.com/article/20/2/how-install-vim-plugins
image: album/202002/23/215719kwhqzwwj1ezoen6o.jpg
tags:
  - vim
  - 插件
categories:
...
|   index | 日期                | 日期                                              | 评论                                                                                                                                     |
|--------:|:--------------------|:--------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2020-07-25 19:49:11 | 来自陕西咸阳的 Chrome 84.0-Windows 10 用户        | `那当然要吹爆 NERDtree`                                                                                                                  |
|       1 | 2022-10-25 21:14:33 | 来自120.227.189.188的 Chrome 98.0-Windows 10 用户 | `解压版的gvim目录下有对应的pack目录！直接可以在这新建vendor\start和vendor\opt文件夹！直接将解压后的插件选择性地放到其中一个文件夹即可！` |
|       2 | 2022-10-25 21:14:36 | 来自120.227.189.188的 Chrome 98.0-Windows 10 用户 | `解压版的gvim目录下有对应的pack目录！直接可以在这新建vendor\start和vendor\opt文件夹！直接将解压后的插件选择性地放到其中一个文件夹即可！` |
