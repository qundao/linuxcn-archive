...
date_updated: 2020-05-28 06:37:30
slug: article-12258-1.html
url: https://linux.cn/article-12258-1.html
url_from: https://itsfoss.com/install-kde-arch-linux/
image: album/202005/28/063618cwogppwllx4kxgow.png
tags:
  - arch
  - kde
categories:
...
我相信你是按照[这份很棒的指南安装来 Arch Linux](https://linux.cn/article-9170-1.html) 的，这篇指南最后提到了 [GNOME 桌面](https://www.gnome.org/)的安装步骤。
...
你可能会想探索一下[基本的 pacman 命令](https://itsfoss.com/pacman-command/)，了解一下 [Arch 用户资源库](https://linux.cn/article-12107-1.html)，了解一下 [AUR 助手](https://linux.cn/article-12019-1.html)。
...
|   index | 日期                | 日期                                      | 评论                                   |
|--------:|:--------------------|:------------------------------------------|:---------------------------------------|
|       0 | 2020-05-28 16:14:15 | 来自云南临沧的 Chrome 81.0-GNU/Linux 用户 | `kde plasma性能比gnome3好了不知道多少` |
