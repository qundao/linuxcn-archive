...
date_updated: 2020-05-13 21:57:00
slug: article-12217-1.html
url: https://linux.cn/article-12217-1.html
url_from: https://opensource.com/article/20/4/securing-linux-email
image: album/202005/13/215637khaogmririavnrlk.jpg
tags:
  - ssl
  - tls
  - 邮件
...
为了保护电子邮件数据和认证，这些服务都增加了一个安全功能，使它们可以利用 SSL/TLS 证书对数据流和通讯进行加密封装。SSL/TLS 是如何加密数据的细节不在本文讨论范围，有兴趣的话可以阅读 [Bryant Son 关于互联网安全的文章](https://linux.cn/article-11699-1.html)了解更多细节。概括的说，SSL/TLS 加密是一种基于公钥和私钥的算法。
