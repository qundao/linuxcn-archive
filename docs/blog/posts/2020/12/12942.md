...
date_updated: 2020-12-22 13:33:27
slug: article-12942-1.html
url: https://linux.cn/article-12942-1.html
url_from: https://opensource.com/article/20/12/jedit
image: album/202012/22/133305j08dxrqx2fmp6s12.jpg
tags:
  - java
  - jedit
categories:
...
如果你没有安装 Java，请学习如何在 [Linux](https://linux.cn/article-11614-1.html)、[Mac 或 Windows](http://adoptopenjdk.org) 上安装 Java。
...
但是，想象一下，从 [简单的 Vim](https://opensource.com/article/20/12/vi-text-editor) 到 [复杂的 Emacs](https://linux.cn/article-12923-1.html)的各种文本编辑器中，你会发现 jEdit 与 Emacs 类似。虽然编辑组件和任何典型桌面编辑应用一样，但 jEdit 的附加功能包括插件、可以在编辑会话中实时录制的宏、特定于某些编辑模式的功能、缓冲区选项等。这是一个积极鼓励你把它变成你自己的编辑器。
