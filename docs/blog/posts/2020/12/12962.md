...
date_updated: 2020-12-28 01:04:43
slug: article-12962-1.html
url: https://linux.cn/article-12962-1.html
url_from: https://opensource.com/article/20/12/learn-bash
image: album/202012/28/010432yq3vgsqtiol9zzi6.jpg
tags:
  - bash
  - 游戏
categories:
...
|   index | 日期                | 日期                                            | 评论                                                                   |
|--------:|:--------------------|:------------------------------------------------|:-----------------------------------------------------------------------|
|       0 | 2020-12-28 08:24:05 | 来自浙江杭州的 Firefox 78.0-Windows 10 用户     | `请教一下 ， 为什么要使用 0$guess 这样的形式？ 直接用 $guess 不行么？` |
|       1 | 2020-12-29 11:15:31 | 来自150.242.169.84的 Chrome 81.0-Windows 7 用户 | `可能是为了预防用户输入空值`                                           |
