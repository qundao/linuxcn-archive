...
date_updated: 2024-01-31 10:34:02
slug: article-16598-1.html
url: https://linux.cn/article-16598-1.html
url_from: https://news.itsfoss.com/mx-linux-23-2-release/
image: album/202401/31/103333byvuvmo6vzusn2pm.jpg
tags:
  - mx linux
categories:
  - 新闻
...
|   index | 日期                | 日期                                                     | 评论                                                                     |
|--------:|:--------------------|:---------------------------------------------------------|:-------------------------------------------------------------------------|
|       0 | 2024-01-31 14:06:49 | 来自39.144.218.210的 Chrome Mobile 108.0|Android 13 用户 | 这个系统到底为个什么会在distrowatch常年第一                              |
|       1 | 2024-01-31 15:59:40 | 来自111.48.159.210的 Chrome 121.0|Windows 10 用户        | 因为distrowatch的统计方式本来很野鸡                                      |
|       2 | 2024-01-31 19:25:22 | 来自北京的 Firefox 122.0|GNU/Linux 用户                  | 我也很奇怪，但是下载尝试后发现做的比ubuntu好。但是没法与我的ArchLinux比  |
|       3 | 2024-02-01 11:10:35 | 来自山西的 Chrome 120.0|Windows 10 用户                  | 有粉丝在不停的刷排名，所以我用linux mint !                               |
|       4 | 2024-02-01 14:22:58 | 来自四川成都的 Chrome 121.0|GNU/Linux 用户               | 通过 dpkg-query -l 可以看到, 其实还是有 systemd 包的, 只是没有作为 init. |
|       5 | 2024-02-01 14:22:59 | 来自四川成都的 Chrome 121.0|GNU/Linux 用户               | 通过 dpkg-query -l 可以看到, 其实还是有 systemd 包的, 只是没有作为 init. |
