...
date_updated: 2024-01-05 18:44:34
slug: article-16537-1.html
url: https://linux.cn/article-16537-1.html
url_from: ''
image: album/202401/05/184310n5isy053lj9gs88i.jpg
tags:
  - ai
  - copilot
  - ubuntu
...
|   index | 日期                | 日期                                                   | 评论                                                                                                                                            |
|--------:|:--------------------|:-------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------|
|       0 | 2024-01-05 20:27:16 | 来自广东广州的 Chrome Mobile 119.0-Android 10 用户     | `我需要一台键盘没有Windows键的电脑，最好无法物理安装Windows。不过目前只有Apple M系列的Mac满足这个条件，连树莓派和其他ARM开发板等设备都不满足。` |
|       1 | 2024-01-05 22:57:22 | 来自江苏无锡的 Firefox 120.0-Ubuntu 用户               | `淘宝二选一都被罚了。。。<br /> <br /> 对于普通用户而言，能够左右横跳是最好的选择。。。`                                                        |
|       2 | 2024-01-06 07:17:25 | 来自广东广州的 Chrome Mobile 119.0-Android 10 用户     | `ARM版本的Chromebook看来目前还没有办法安装Windows，也满足这些要求，x86的可以装。`                                                               |
|       3 | 2024-01-06 17:39:54 | 来自111.55.10.92的 Chrome Mobile 120.0-Android 10 用户 | `老款ThinkPad，比如T40/41、R40/41。虽然还可以物理安装Windows，但它们真的没有Windows键，可以整Linux玩。`                                         |
|       4 | 2024-01-06 17:46:49 | 来自111.55.10.92的 Chrome Mobile 120.0-Android 10 用户 | `还有LoongArch的电脑，龙芯的国产架构，可玩性潜力很高，完全无法物理安装Windows。现在已经可以买到整机和主板了。`                                  |
|       5 | 2024-01-06 18:29:30 | 来自广东广州的 Chrome Mobile 119.0-Android 10 用户     | `我主要看ARM和RISC-V架构，其次是PowerPC，龙芯架构也可以考虑，性能别太差就行（比如打开网页都卡的肯定不行）。`                                    |
